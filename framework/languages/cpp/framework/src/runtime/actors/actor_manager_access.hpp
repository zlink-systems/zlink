...
{
  public:
    using create_fn_t = std::function<task_t<actor_create_result_t> (bool,
                                                                     actor_id_t,
                                                                     std::string,
    ...
    using find_fn_t = std::function<task_t<std::optional<actor_ref_t>> (actor_id_t)>;
    using find_spot_fn_t = std::function<task_t<std::optional<spot_ref_t>> (actor_id_t)>;
