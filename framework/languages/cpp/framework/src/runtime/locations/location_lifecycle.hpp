...
class location_lifecycle_t
{
  public:
                                      ...
                                      bool takeover = false)
    {
        ...
        return _state->lane
          .run ([&] {
              ...
              return actor_claim_result_t{location_write_status_t::stored, std::move (actor),
                                          generation, now};
          })
          .get ();
    }
    ...
    location_write_result_t update_actor_location (actor_location_t actor)
    {
        ...
        return _state->lane
          .run ([&] {
              ...
              found->second.store_generation = found->second.actor.actor_ref->object_generation ();
    ...
    {
        return _location_runtime != nullptr ? _location_runtime->current_owner_token ()
                                            : std::nullopt;
    }
    ...
    spot_claim_result_t claim_spot (spot_location_t spot)
    {
        ...
        return _state->lane
          .run ([&] {
              ...
              return spot_claim_result_t{location_write_status_t::stored, std::move (spot), now};
          })
          .get ();
    }
    ...
    location_write_result_t release_actor (actor_location_key_t key)
    {
        ...
        return _state->lane
          .run ([&] {
              ...
              return location_write_result_t{location_write_status_t::stored,
