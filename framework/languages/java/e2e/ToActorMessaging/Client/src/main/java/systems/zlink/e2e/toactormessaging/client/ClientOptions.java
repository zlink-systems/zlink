...
public record ClientOptions(String actorHttpEndpoint,String actorBHttpEndpoint,String callerHttpEndpoint,String sessionAHttpEndpoint,
    ...
    public ClientOptions { required(actorHttpEndpoint,"actorHttpEndpoint"); required(callerHttpEndpoint,"callerHttpEndpoint");
        required(actorBHttpEndpoint,"actorBHttpEndpoint");
    ...
    public static ClientOptions load(String path){Properties p=new Properties();try(Reader r=Files.newBufferedReader(Path.of(path))){p.load(r);}
        ...
        return new ClientOptions(req(p,"actorHttpEndpoint"),req(p,"actorBHttpEndpoint"),req(p,"callerHttpEndpoint"),req(p,"sessionAHttpEndpoint"),
