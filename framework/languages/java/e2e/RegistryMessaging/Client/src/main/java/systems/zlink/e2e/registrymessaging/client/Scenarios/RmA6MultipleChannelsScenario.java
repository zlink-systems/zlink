...
public final class RmA6MultipleChannelsScenario {
    ...
    public static void run(
        ...
        String profileMarker = "a6-api-" + UUID.randomUUID();
        String workflowMarker = "a6-workflow-" + UUID.randomUUID();
        ...
        ScenarioAssert.that(Arrays.stream(providerEvidence)
        ...
        ScenarioAssert.that(Arrays.stream(allProviderEvidence)
