...
public final class SubpackageSessionPacketHandler
        implements ZLinkTypedSessionPacketHandler<
                ZLinkSessionContext, SubpackageSessionPacketHandler.SubpackageSessionPacket> {
    private final AtomicInteger count;
    private final CompletableFuture<Void> handled;

    public SubpackageSessionPacketHandler(AtomicInteger count, CompletableFuture<Void> handled) {
        this.count = count;
