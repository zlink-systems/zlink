...
public final class ZLinkRouteMeshRuntimeOptionsService implements ZLinkRouteMeshRuntimeOptions {
    ...
    ZLinkRouteMeshRuntimeOptionsService(Supplier<ZLinkRouteMeshRuntimeOptions> delegate) {
