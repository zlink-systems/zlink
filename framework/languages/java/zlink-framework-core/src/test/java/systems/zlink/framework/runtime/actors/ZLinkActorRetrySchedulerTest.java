...
final class ZLinkActorRetrySchedulerTest {
    ...
    void waitUntilRelayOrContinueCompletesOnTimeout() {
        ZLinkActorRetryScheduler.waitUntilRelayOrContinue(Duration.ZERO, () -> false)
                .toCompletableFuture()
                .join();
    }
    ...
    void bindRetryExhaustionSurfacesDeadlineExceededWithLastAttemptAsCause() {
        IllegalStateException lastAttempt = new IllegalStateException("relay not connected");
    ...
    void boundSessionRouteNeverReadySurfacesUnavailable() throws Exception {
        ...
        Method awaitRouteReady =
                ZLinkBoundSessionRuntime.class.getDeclaredMethod(
                        "awaitRouteReady", ZLinkBackendActorRef.class, Duration.class);
