...
final class ZLinkRelayMetadataPolicyTest {
    ...
    void filtersEachRelayDirectionWithAnImmutableSnapshot() {
        ...
        ZLinkBoundSessionSendOptions actorToSession =
                policy.actorToSession(
    ...
    void emptyPolicyDropsApplicationMetadataInBothDirections() {
        ZLinkStreamHeader inbound =
                new ZLinkStreamHeader("ActorSend", Map.of("private", "p"), Optional.empty());
        ...
        assertEquals(
                ...
                ZLinkRelayMetadataPolicy.EMPTY
                        .actorToSession(
                                ZLinkBoundSessionSendOptions.create(
                                                "ActorEvent", ZLinkStreamCodec.JSON)
                                        .withMetadata("private", "p"))
                        .metadata());
    }
}
