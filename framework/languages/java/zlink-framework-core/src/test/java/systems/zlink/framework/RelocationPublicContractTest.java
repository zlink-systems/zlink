    ...
    void exposesSeparatedRelocationStoreRegistration() throws Exception {
        ...
        assertEquals(
                ...
                ZLinkRelocationStore.class
                        .getMethod(
                                "put",
                                systems.zlink.framework.locationprovider.ZLinkBlobReference.class,
                                byte[].class,
                                Duration.class,
        ...
        for (String removedType :
            ...
            assertThrows(ClassNotFoundException.class, () -> Class.forName(removedType));
        }
    }

    @Test
    void exposesRelocationAdaptersAndInstanceSpotLifecycle() throws Exception {
        assertEquals(
                CompletionStage.class,
                ZLinkActorRelocationAdapter.class
                        .getMethod("capture", ZLinkActor.class, ZLinkRelocationCancellation.class)
                        .getReturnType());
        assertEquals(
                CompletionStage.class,
        ...
        assertEquals(
                ...
                new ZLinkSpotRelocationReadyCompletion(ZLinkSpotRelocationReadyOutcome.RELOCATED)
                        .outcome());
        assertEquals(
                void.class, ZLinkSpotRelocationReadyCall.class.getMethod("defer").getReturnType());
        assertThrows(
                ClassNotFoundException.class,
                () -> Class.forName("systems.zlink.framework.actors.ZLinkRelocationPolicy"));
        assertThrows(
                ClassNotFoundException.class,
                () ->
                        Class.forName(
