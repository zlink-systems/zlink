...
final class ZLinkRouteSpotRequestMetricsTest {
    @Test
    void modernRouteMeshProvidesSourceMeshForPublicSpotRequest() throws Exception {
        ...
        try (ZLinkRequestMetricProbe metrics = ZLinkRequestMetricProbe.install();
            ...
            assertEquals(1L, metrics.durationCount("modern-mesh", "spot", "failed"));
            ...
            assertEquals(0L, metrics.inflight("modern-mesh", "instance_spot"));
            assertEquals(1L, metrics.durationCount("modern-mesh", "instance_spot", "failed"));
            assertEquals(0L, metrics.inflight("unknown-mesh", "instance_spot"));
            assertEquals(0L, metrics.durationCount("unknown-mesh", "instance_spot", "failed"));
        }
    }
