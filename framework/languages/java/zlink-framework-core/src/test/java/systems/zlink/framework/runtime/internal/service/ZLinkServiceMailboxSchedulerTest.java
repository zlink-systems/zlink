...
final class ZLinkServiceMailboxSchedulerTest {
    ...
    void preservesLevelReadyAfterPartialDrainWithoutAnOwnerBudget() {
        ...
        assertEquals(
                ZLinkServiceMailboxScheduler.Admission.ACCEPTED,
                scheduler.admit(
                        owner,
                        ZLinkServiceMailboxScheduler.Domain.APPLICATION,
        ...
        assertEquals(owner, scheduler.pollReady(ZLinkServiceMailboxScheduler.Domain.APPLICATION));
        assertEquals(
                1,
                scheduler.drain(
                        owner,
    ...
    void sealRejectsNewAdmissionWithoutDroppingQueuedWork() {
        ...
        ZLinkServiceMailboxScheduler.Work work = new ZLinkServiceMailboxScheduler.Work(2, () -> {});
        ...
        scheduler.seal();
        assertEquals(
                ZLinkServiceMailboxScheduler.Admission.SEALED,
                scheduler.admit(owner, ZLinkServiceMailboxScheduler.Domain.INFRASTRUCTURE, work));
