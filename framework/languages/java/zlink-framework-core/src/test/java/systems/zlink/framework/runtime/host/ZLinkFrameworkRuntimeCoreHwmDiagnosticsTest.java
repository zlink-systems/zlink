...
final class ZLinkFrameworkRuntimeCoreHwmDiagnosticsTest {
    @Test
    void activeContextProjectsAndResetsBindingSnapshotUntilTeardown() throws Exception {
        ...
        try {
            ...
            assertEquals(budgetBytes, before.coreHwm().configuredBudgetBytes().orElseThrow());
            ...
            var inactive = assertThrows(IllegalStateException.class, runtime::resetCapacityMetrics);
            assertEquals(
