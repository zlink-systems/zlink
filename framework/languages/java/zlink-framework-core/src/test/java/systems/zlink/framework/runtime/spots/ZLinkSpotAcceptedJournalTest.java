...
final class ZLinkSpotAcceptedJournalTest {
    ...
    void acceptedRouteRecordPreservesRelayIdentityMetadataAndParts() {
        ...
        ZLinkSpotAcceptedJournal.Record record =
                ZLinkSpotAcceptedJournal.decode(ZLinkSpotAcceptedJournal.encode(received));
        ...
        assertArrayEquals("packet".getBytes(StandardCharsets.UTF_8), record.parts().get(0));
            ...
            ZLinkSpotAcceptedJournal.Record record =
                    ZLinkSpotAcceptedJournal.decode(
                            ZLinkAcceptedJournalTestRecords.spotMultipart(
                                    "source-spot", "target-spot", 0, List.of(first, second)));
