...
final class ZLinkAuthorityContractTest {
    ...
    void exactAuthorityStoreMethodsArePublic() throws Exception {
        assertEquals(
                ...
                ZLinkLocationRepository.class
                        .getMethod("read", String.class, ZLinkStoreCancellation.class)
                        .getReturnType());
        assertEquals(
                CompletionStage.class,
                ZLinkLocationRepository.class
        ...
        assertEquals(
                CompletionStage.class,
                ZLinkLocationRepository.class
                        .getMethod("getMeshNodeChangeStamp", String.class)
                        .getReturnType());
    }
    ...
    void registeredLocationCapabilityExposesTheSameAuthorityProvider() {
        ...
        ZLinkRegisteredLocationStores stores = ZLinkRegisteredLocationStores.fromUnified(authority);
    ...
    private static final class ContractAuthorityStore extends ZLinkLocationStoreTestAdapter {
        @Override
