...
public interface ZLinkRouteClient {
    ...
    ZLinkSendCall sendToNode(String meshName, RoutingId target, Object message);

    ZLinkSpotSendCall sendToSpot(String spotId, Object message);

    /** Requests {@code target} in the named RouteMesh. */
    ZLinkRequestCall requestToNode(String meshName, RoutingId target, Object message);

    ZLinkSpotRequestCall requestToSpot(String spotId, Object message);
}
