...
public record ZLinkMessageFlowEvent(
    ...
    public ZLinkMessageFlowEvent {
        ...
        if (eventId == ZLinkTraceEventId.DISPATCH_ERROR
            ...
            throw new IllegalArgumentException("dispatch-error events require reason and action");
        }
    ...
    public ZLinkMessageFlowEvent(
        ...
        this(
                ...
                messageSize,
                null,
                reason == null ? defaultReason(phase) : reason,
                action,
                errorType,
                errorMessage,
                null,
    ...
    private ZLinkMessageFlowEvent copy(
            ZLinkMessageFlowResult result, String id, ZLinkFlowOrigin origin) {
        return new ZLinkMessageFlowEvent(
                eventId,
                phase,
                result,
    ...
    private static ZLinkChannelRouteKind defaultRouteKind(ZLinkDispatchErrorSurface surface) {
