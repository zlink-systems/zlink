...
record ZLinkBoundSessionSendOptions(
    ...
    static ZLinkBoundSessionSendOptions create(String defaultPacketName, ZLinkStreamCodec codec) {
        return new ZLinkBoundSessionSendOptions(
                defaultPacketName, Map.of(), Optional.empty(), codec);
    }
    ...
    static ZLinkBoundSessionSendOptions createForPayload(
        ...
        return create(
                defaultPacketName,
                ZLinkPayloadEncoding.streamCodec(serializer, payload, fallbackCodec));
    }
    ...
    ZLinkBoundSessionSendOptions withPacketName(String packetName) {
        ...
        return new ZLinkBoundSessionSendOptions(
                defaultPacketName, metadata, Optional.of(packetName), codec);
    }
    ...
    ZLinkBoundSessionSendOptions withMetadata(String key, String value) {
        ...
        next.put(key, value);
        return new ZLinkBoundSessionSendOptions(
                defaultPacketName, Map.copyOf(next), packetName, codec);
    }
