...
public interface ZLinkSession {
    ...
    /**
     * Invoked after a bound Actor is replaced while this physical Session remains connected.
     * Existing Session implementations are not required to opt in; the default is an
