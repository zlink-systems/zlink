...
/**
 * {@code safeToShutdown} is the source-published observation of spec 30 §11: every relocation unit
 * this source started has reached its Message Follow route removal point (S4) and its cutover
 * retransmission window has ended. It is a source-local observation, never a completion ACK from a
 * target.
 */
public record ZLinkFrameworkRuntimeStatus(
    ...
    public ZLinkFrameworkRuntimeStatus {
        ...
        relocationResult = relocationResult == null ? Optional.empty() : relocationResult;
        terminationResult = terminationResult == null ? Optional.empty() : terminationResult;
