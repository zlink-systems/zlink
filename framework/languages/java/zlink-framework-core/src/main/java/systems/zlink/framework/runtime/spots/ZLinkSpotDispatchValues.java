...
/**
 * Parsed inbound SPOT route packet. {@code header} is the decoded shared cross-language envelope
 * header when the message arrived as an envelope, or {@code null} for legacy internal raw-parts
 * packets.
 */
record ParsedPacket(
        String packetName,
