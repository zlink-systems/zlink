...
public final class ZLinkMeshNodeRuntime implements AutoCloseable {
    ...
    static ZLinkMeshNodeRuntime start(
        ...
        return start(registration, adapter, context, deferServiceReadyPublication, receiver, null);
    }
    ...
    static ZLinkMeshNodeRuntime start(
        ...
        try {
            ...
            long routerSendHighWaterMark = registration.configureRouterSocket().sendHighWaterMark();
