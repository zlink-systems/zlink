...
/**
 * Internal terminal result carried from the User Spot runtime to the service transport. This type
 * is not part of the public application contract.
 */
public final class ZLinkUserSpotOperationException extends RuntimeException {
    private final int terminalResult;
    private final int failureCode;

    public ZLinkUserSpotOperationException(int terminalResult, int failureCode, String message) {
        super(message);
