...
record ZLinkSpotSendHandlerContext(String packet, String content, Map<String, String> metadata)
...
record ZLinkSpotRequestHandlerContext(String packet, String content, Map<String, String> metadata)
        implements ZLinkMessageContext {
