...
final class ZLinkAnnotationHandlerScanner {
    ...
    private static void addChannelHandlers(
        ...
        if (send != null) {
            ...
            Class<?> messageType =
                    requireChannelHandlerShape(candidate, method, ZLinkMessageContext.class);
            handlers.add(
        ...
        if (publish != null) {
            requireJavaCompletionStageReturn(candidate, method);
            Class<?> messageType =
                    requireChannelHandlerShape(candidate, method, ZLinkPublishMessageContext.class);
            handlers.add(
                    new ZLinkScannedHandler(
                            ZLinkScannedHandlerSurface.CHANNEL,
    ...
    private static void addSpotHandlers(
        ...
        if (spotRequest != null) {
            requireJavaCompletionStageReturn(candidate, method);
            SpotMethodShape shape =
                    requireSpotMethodShape(
                            candidate,
                            method,
        ...
        if (spotSubscription != null) {
            ...
            SpotMethodShape shape =
                    requireSpotMethodShape(
                            ...
                            "SPOT subscription handler method must have spot and event"
                                    + " parameters: ");
            handlers.add(
                    new ZLinkScannedHandler(
                            ZLinkScannedHandlerSurface.SPOT,
                            ...
                            ZLinkHandlerScanValidation.requireTopic(
                                    candidate, spotSubscription.topic()),
                            "",
                            null,
                            groups));
        }
    ...
    private static void addSpotActorHandlers(
        ...
        if (actorSend != null) {
            ...
            ActorMessageShape shape =
                    requireActorPacketHandlerShape(candidate, method, ZLinkMessageContext.class);
            handlers.add(
                    new ZLinkScannedHandler(
                            ZLinkScannedHandlerSurface.SPOT,
    ...
    private static SpotMethodShape requireSpotMethodShape(
            Class<?> handlerType, Method method, Class<?> contextType, String failurePrefix) {
