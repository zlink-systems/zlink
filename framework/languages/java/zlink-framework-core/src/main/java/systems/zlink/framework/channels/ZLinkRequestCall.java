...
public interface ZLinkRequestCall {
    ...
    /**
     * For {@code requestToChannel}, channel validation (including metadata support) and the default
     * timeout are resolved when {@code submit} is called.
     */
     ...
     *
     * @throws systems.zlink.framework.errors.ZLinkFrameworkException with {@code INVALID_OPERATION}
     *     before submission if called from a runtime execution context
     */
