...
final class ZLinkChannelHandlerCatalog {
    ...
    Map<String, ChannelRequestHandlerRegistration> requestHandlers(ChannelRegistration channel) {
    ...
    Map<String, ChannelRouteSendHandlerRegistration> routeSendHandlers(
        ...
        for (ZLinkScannedHandler handler :
                matching(channel, ZLinkScannedHandlerSurface.ROUTE, ZLinkScannedHandlerKind.SEND)) {
            handlers.put(
                    handler.packetName(),
