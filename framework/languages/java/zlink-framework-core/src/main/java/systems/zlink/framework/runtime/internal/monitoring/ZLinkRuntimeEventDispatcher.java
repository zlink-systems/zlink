...
public final class ZLinkRuntimeEventDispatcher {
    ...
    public void publishHostStatus(
        ...
        if (failure != null) {
            String message =
                    String.valueOf(failure.getMessage()).replace("\r", "\\r").replace("\n", "\\n");
            ...
            String causeMessage =
                    String.valueOf(cause.getMessage()).replace("\r", "\\r").replace("\n", "\\n");
            ...
            event.log(
                    "ZLink runtime termination outcome={} reason={} stage={} exception_type={}"
                            + " exception_message={} cause_type={} cause_message={}",
                    terminal.outcome(),
                    terminal.reason(),
                    stage,
