...
final class PublicCodecTestRegistry implements ZLinkCodecRegistryBuilder, ZLinkCodecRegistrar {
    ...
    public void addSerializer(
        ...
        serializers.add(new RegisteredSerializer(serializer, canSerialize));
    }
    ...
    private ZLinkMessageSerializer serializerFor(Class<?> type, ZLinkMessageSerializer fallback) {
