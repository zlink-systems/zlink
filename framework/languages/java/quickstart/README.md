...
<!-- zlink-lang: java -->
# ZLink Java quickstart

This is `quickstart/` in `zlink-java-examples`, containing only Java subprojects.
<!-- zlink-lang: end -->
<!-- zlink-lang: kotlin -->
...
<!-- zlink-lang: java -->
Clone [`zlink-java-examples`](https://github.com/zlink-systems/zlink-java-examples).
<!-- zlink-lang: end -->
<!-- zlink-lang: kotlin -->
...
<!-- zlink-lang: java -->
| A Client returns a path-variable error | Keep `-parameters` in its compiler options |
<!-- zlink-lang: end -->
<!-- zlink-lang: kotlin -->
...
|---|---|
<!-- zlink-lang: java -->
| `java/Shared` | Java record contracts |
| `java/Server` | Register the `greeting` handler and listen on port 7101 |
| `java/Client` | Connect and expose `GET /hello/{name}` on port 5080 |
<!-- zlink-lang: end -->
<!-- zlink-lang: kotlin -->
...
<!-- zlink-lang: java -->
- The Java record contract shapes in `Shared`.
<!-- zlink-lang: end -->
<!-- zlink-lang: kotlin -->
