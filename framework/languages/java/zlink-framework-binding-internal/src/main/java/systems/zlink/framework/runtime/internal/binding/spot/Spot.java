...
public interface Spot extends AutoCloseable {
    ...
    OperationId requestToChannel(
            String channel, List<Message> parts, SendFlags flags, Duration timeout);
    ...
    void publish(
            String channel, String topic, byte[] metadata, List<Message> parts, SendFlags flags);
