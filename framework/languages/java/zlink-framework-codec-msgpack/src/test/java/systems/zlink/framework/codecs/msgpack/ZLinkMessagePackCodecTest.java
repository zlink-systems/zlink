...
final class ZLinkMessagePackCodecTest {
    ...
    void messagePackExtensionKeepsTypedPayloadRoundTrip() {
        ...
        ProfileReply decoded =
                serializer.deserialize(
                        serializer.serialize(new ProfileReply("msgpack:42")), ProfileReply.class);
    ...
    void typedMessagePackExtensionCanCoexistWithJsonFallbackAndProtobuf() {
        ...
        StringValue protobuf =
                serializer.deserialize(
                        serializer.serialize(StringValue.of("protobuf:42")), StringValue.class);
        assertEquals(StringValue.of("protobuf:42"), protobuf);

        PackedProfileReply msgpack =
                serializer.deserialize(
    ...
    private static final class PublicCodecRegistry
        ...
        Map<String, ZLinkMessageSerializer> serializers() {
            Map<String, ZLinkMessageSerializer> result = new LinkedHashMap<>();
            serializers.forEach(
                    (contentType, registered) -> result.put(contentType, registered.serializer()));
