...
final class DefaultZLinkStreamWaitCall implements ZLinkStreamWaitCall {
    ...
    @Override
    public ZLinkStreamWaitCall where(
            Predicate<ZLinkStreamMessage<ZLinkStreamEncodedPayload>> predicate) {
        Objects.requireNonNull(predicate, "predicate");
        return new DefaultZLinkStreamWaitCall(
                connector, name, timeout, codec, this.predicate.and(predicate));
    }
    ...
    @Override
    public <TPayload> CompletionStage<ZLinkStreamMessage<TPayload>> submit(
