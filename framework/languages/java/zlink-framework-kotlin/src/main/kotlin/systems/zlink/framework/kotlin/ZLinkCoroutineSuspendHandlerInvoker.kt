...
internal class ZLinkCoroutineSuspendHandlerInvoker : ZLinkSuspendInvocationAdapter {
    ...
    @JvmOverloads
    constructor(scope: CoroutineScope, dispatcher: CoroutineDispatcher = Dispatchers.Default) {
        this.dispatcher = dispatcher
        this.scope = scope
    }
    ...
    override fun invoke(
        ...
        return (scope.future(invocationContext) { invokeSuspend(handler, method, logicalArguments) }
