 ...
 * certificate) are configured. Connection pooling stays native. Separated from {@link
 * HttpClientRuntime} so client construction is independent of request orchestration.
 */
