...
public final class ZLinkRedisLocationStore implements ZLinkLocationStore, AutoCloseable {
    ...
    public ZLinkRedisLocationStore(ZLinkRedisLocationOptions options) {
        ...
        this.connection = ZLinkRedisLocationConnection.forBytes(validated, keys.schemaKey());
