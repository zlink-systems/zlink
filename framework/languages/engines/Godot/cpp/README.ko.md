...
이 저장소는 Godot project만 포함한다. [C++ framework v0.26.0 release](https://github.com/zlink-systems/zlink/releases/tag/framework-cpp%2Fv0.26.0)의
...
base=https://github.com/zlink-systems/zlink/releases/download/framework-cpp/v0.26.0
for asset in zlink-framework-cpp-0.26.0-linux-x64.tar.gz zlink-framework-cpp-0.26.0.tar.gz; do
...
$base = 'https://github.com/zlink-systems/zlink/releases/download/framework-cpp/v0.26.0'
foreach ($asset in @('zlink-framework-cpp-0.26.0-windows-x64.tar.gz', 'zlink-framework-cpp-0.26.0.tar.gz')) {
...
cmake -S . -B build -DCMAKE_BUILD_TYPE=Release \
  -DCMAKE_PREFIX_PATH="$PWD/.zlink/zlink-framework-cpp-0.26.0-linux-x64" \
  -DGODOT_CPP_ROOT="$PWD/.zlink/godot-cpp" \
  -DZLINK_FRAMEWORK_CPP_SOURCE_ROOT="$PWD/.zlink/zlink-framework-cpp-0.26.0"
...
```powershell
cmake -S . -B build `
  "-DCMAKE_PREFIX_PATH=$PWD/.zlink/zlink-framework-cpp-0.26.0-windows-x64" `
  "-DGODOT_CPP_ROOT=$PWD/.zlink/godot-cpp" `
  "-DZLINK_FRAMEWORK_CPP_SOURCE_ROOT=$PWD/.zlink/zlink-framework-cpp-0.26.0"
