...
export const ZLINK_CHANNEL_RUNTIME_OPTIONS = Symbol.for(
  '@zlink-systems/framework:channel-runtime-options'
);
export const ZLINK_CLIENT_SERVER_RUNTIME = Symbol.for(
  '@zlink-systems/framework:client-server-runtime'
);
export const ZLINK_ROUTE_MESH_RUNTIME_OPTIONS = Symbol.for(
  '@zlink-systems/framework:route-mesh-runtime-options'
);
...
export const ZLINK_BOUND_SESSION_FACTORY = Symbol.for(
  '@zlink-systems/framework:bound-session-factory'
);
export const ZLINK_MESSAGE_METADATA_POLICY = Symbol.for(
  '@zlink-systems/framework:message-metadata-policy'
);
...
export const ZLINK_SPOT_PUBLISHER_CLIENT = Symbol.for(
  '@zlink-systems/framework:spot-publisher-client'
);
...
export const ZLINK_LOCATION_RUNTIME_QUERY = Symbol.for(
  '@zlink-systems/framework:location-runtime-query'
);
