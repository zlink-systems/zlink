...
export function matchesPeerLocation(
  ...
  return (
    (filter.autoConnectType === undefined || row.autoConnectType === filter.autoConnectType) &&
...
export function matchesActorLocation(
  ...
  return (
    (filter.actorType === undefined || row.actorType === filter.actorType) &&
    (filter.nodeRid === undefined || routingIdsEqual(row.ownerNodeRid, filter.nodeRid)) &&
...
export function matchesRouteLocation(
  ...
  return (
    (filter.routeKind === undefined || row.routeKind === filter.routeKind) &&
