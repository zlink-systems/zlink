// IS-E2E-14: Store outage 시나리오를 검증한다.
import { requestInstance, waitForInstanceEvidence, type InstanceScenarioContext } from '../Support/scenario-http';

export const scenarioId = 'IS-E2E-14' as const;

export async function runISE2E14(context: InstanceScenarioContext): Promise<void> {
  const spotId = 'is-e2e-14-spot';
  const operationId = 'is-e2e-14-' + Date.now();
