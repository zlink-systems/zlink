// IS-E2E-07: Normal Relocate 시나리오를 검증한다.
import { requestInstance, waitForInstanceEvidence, type InstanceScenarioContext } from '../Support/scenario-http';

export const scenarioId = 'IS-E2E-07' as const;

export async function runISE2E07(context: InstanceScenarioContext): Promise<void> {
  const spotId = 'is-e2e-07-spot';
  const operationId = 'is-e2e-07-' + Date.now();
