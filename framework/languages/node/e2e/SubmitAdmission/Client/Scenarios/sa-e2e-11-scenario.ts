// SA-E2E-11: SpotId send의 admission과 logical identity를 유지한다 시나리오를 검증한다.
import {
  emit,
  ensure,
  submit,
...
export const scenarioId = 'SA-E2E-11' as const;

export async function runSAE2E11(context: SubmitScenarioContext): Promise<void> {
  const operationId = 'sa11-spot';
  ...
  ensure(evidence.entered === 1, `SA-E2E-11: handler count mismatch`);
