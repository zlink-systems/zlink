...
namespace Systems.Zlink.Stream.Connector.Contracts
{
    public sealed class ZlinkStreamMetadata
    {
        ...
        public static ZlinkStreamMetadata Empty { get; } = new ZlinkStreamMetadata(new Dictionary<string, string>());
        ...
        public ZlinkStreamMetadata WithMany(IEnumerable<KeyValuePair<string, string>> values)
        {
            ...
            foreach (var pair in values)
            {
                ...
                if (pair.Value is null) throw new ArgumentNullException(nameof(values));
