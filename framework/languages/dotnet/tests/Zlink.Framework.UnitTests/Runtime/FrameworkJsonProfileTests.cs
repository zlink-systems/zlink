...
public sealed class FrameworkJsonProfileTests
{
    ...
    {
        var actor = new ActorRef("actor-1", 7, "mesh", RoutingId.From("node"));
        var spot = new SpotRef("spot-1", 9, "mesh", RoutingId.From("node"));
    ...
    [InlineData(
        "{\"actorId\":\"actor-1\",\"objectGeneration\":\"07\",\"meshName\":\"mesh\",\"nodeRid\":\"6e6f6465\"}"
    )]
    [InlineData(
        "{\"actorId\":\"actor-1\",\"objectGeneration\":\"7\",\"meshName\":\"mesh\",\"nodeRid\":\"6e6f6465\",\"extra\":true}"
    )]
    [InlineData(
        "{\"actorId\":\"actor-1\",\"objectGeneration\":\"7\",\"meshName\":\"mesh\",\"nodeRid\":\"6e6f6465\",\"actorId\":\"other\"}"
    )]
    ...
    [Theory]
    [InlineData(
        "{\"actorId\":\"\",\"objectGeneration\":\"1\",\"meshName\":\"mesh\",\"nodeRid\":\"6e6f6465\"}"
    )]
    [InlineData(
        "{\"actorId\":\"\\u0000\",\"objectGeneration\":\"1\",\"meshName\":\"mesh\",\"nodeRid\":\"6e6f6465\"}"
    )]
    [InlineData(
        "{\"actorId\":\"actor-1\",\"objectGeneration\":\"9223372036854775808\",\"meshName\":\"mesh\",\"nodeRid\":\"6e6f6465\"}"
    )]
    [InlineData(
        "{\"actorId\":\"actor-1\",\"objectGeneration\":\"1\",\"meshName\":\"\",\"nodeRid\":\"6e6f6465\"}"
    )]
    [InlineData(
        "{\"actorId\":\"actor-1\",\"objectGeneration\":\"1\",\"meshName\":\"mesh\",\"nodeRid\":\"\"}"
    )]
    ...
    [Theory]
    [InlineData(
        "{\"spotId\":\"\",\"objectGeneration\":\"1\",\"meshName\":\"mesh\",\"nodeRid\":\"6e6f6465\"}"
    )]
    [InlineData(
        "{\"spotId\":\"\\u0000\",\"objectGeneration\":\"1\",\"meshName\":\"mesh\",\"nodeRid\":\"6e6f6465\"}"
    )]
    [InlineData(
        "{\"spotId\":\"spot-1\",\"objectGeneration\":\"0\",\"meshName\":\"mesh\",\"nodeRid\":\"6e6f6465\"}"
    )]
    [InlineData(
        "{\"spotId\":\"spot-1\",\"objectGeneration\":\"9223372036854775808\",\"meshName\":\"mesh\",\"nodeRid\":\"6e6f6465\"}"
    )]
    [InlineData(
        "{\"spotId\":\"spot-1\",\"objectGeneration\":\"1\",\"meshName\":\"\",\"nodeRid\":\"6e6f6465\"}"
    )]
    [InlineData(
        "{\"spotId\":\"spot-1\",\"objectGeneration\":\"1\",\"meshName\":\"mesh\",\"nodeRid\":\"\"}"
    )]
    ...
    public void Shared_Golden_Fixture_Is_Enforced_By_The_Application_Decode_Path()
    {
        ...
        foreach (var vector in fixture.RootElement.GetProperty("valid").EnumerateArray())
        {
            ...
            var decoded = Assert.IsType<ProfileMessage>(
    ...
    {
        var encoded = ZLinkFrameworkJsonPayloadCodec.Serialize(
            new ProfileMessage
            {
                Signed64 = -1,
                Unsigned64 = 2,
    ...
    {
        Assert.ThrowsAny<JsonException>(() =>
            ZLinkFrameworkJsonPayloadCodec.Deserialize<ProfileMessage>(Encoding.UTF8.GetBytes(json))
        );
    }
    ...
    {
        Assert.ThrowsAny<JsonException>(() =>
            ZLinkFrameworkJsonPayloadCodec.Serialize(new UnsupportedMessage { Id = Guid.Empty })
        );
    }
