...
public static class ZLinkErrorResponse
{
    ...
    private static readonly JsonSerializerOptions BodyFormat =
        new() { Encoder = JavaScriptEncoder.UnsafeRelaxedJsonEscaping };

    // The same table the framework's own HTTP host uses.
    private static HttpStatusCode StatusFor(ZLinkFrameworkErrorKind kind) => kind switch
    {
    ...
    private static string NameFor(ZLinkFrameworkErrorKind kind) => kind switch
    {
