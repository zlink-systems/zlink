...
internal static class ZLinkSpotActorHandlerDescriptorFactory
{
    ...
    )
    {
        ...
        foreach (
            var descriptor in ZLinkSpotActorAttributedDescriptorFactory.CreatePacketDescriptors(
                surface,
                expectedSpotType,
                handlerType,
                expectedActorType,
    ...
    )
    {
        ...
        matches.AddRange(
            ZLinkSpotActorInterfaceDescriptorFactory.CreateInferredDescriptors(
                surface,
                expectedSpotType,
                handlerType,
                packetName
        ...
        matches.AddRange(
            ZLinkSpotActorAttributedDescriptorFactory.CreateInferredDescriptors(
                surface,
                expectedSpotType,
                handlerType,
                packetName
