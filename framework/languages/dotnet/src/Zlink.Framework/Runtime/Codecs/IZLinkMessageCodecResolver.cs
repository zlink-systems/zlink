...
{
    bool TryGetSerializer(string contentType, out IZLinkMessageSerializer serializer);

    bool TryResolveStreamContentType(ZlinkStreamCodec codec, out string contentType);
