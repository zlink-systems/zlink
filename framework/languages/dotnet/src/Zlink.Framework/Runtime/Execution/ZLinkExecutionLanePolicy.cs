...
{
    internal static ZLinkExecutionLanePolicy Default { get; } =
        new(lifecycleBurstLimit: 8, ownerTimeBudget: TimeSpan.FromMilliseconds(10));

    internal ZLinkExecutionLanePolicy(int lifecycleBurstLimit, TimeSpan ownerTimeBudget)
    {
