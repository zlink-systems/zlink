...
internal static partial class ZLinkServiceWireCodec
{
    ...
    internal static byte[] EncodeSessionRelocationSeal(SessionRelocationSealRecord record)
    {
    ...
    internal static byte[] EncodeSessionRelocationSealed(SessionRelocationSealedRecord record)
    {
        ValidateSessionRelocationCommon(record.RelocationId, record.Coordinator);
        ValidateSessionActorRouteFence(record.Actor);
        ValidateSessionOwnerFence(record.Session);
    ...
    internal static byte[] EncodeSessionRelocationRoute(SessionRelocationRouteRecord record)
    {
        ValidateSessionRelocationCommon(record.RelocationId, record.Coordinator);
    ...
    private static void ValidateSessionActorRouteFence(SessionActorRouteFenceRecord actor)
    {
    ...
    {
        if (
            session.SessionOwnerNodeRid.IsEmpty
    ...
    private static ServiceWirePilotCodec.Fence ToGenerated(SessionActorRouteFenceRecord value) =>
        new(
            value.Actor.ActorId,
    ...
    private static ServiceWirePilotCodec.SessionRouteUpdate ToGenerated(
        SessionRelocationRouteUpdateRecord value
    ) =>
        value.Action switch
        {
            SessionRelocationRouteAction.Commit => new ServiceWirePilotCodec.SessionRouteCommit(
    ...
    private static SessionRelocationRouteUpdateRecord FromGenerated(
        ServiceWirePilotCodec.SessionRouteUpdate value
    ) =>
        value switch
        {
