...
internal static partial class ZLinkServiceWireCodec
{
    ...
    internal static byte[] EncodeRelocationPrepare(RelocationPrepareRecord record)
    {
        ...
        if (
            record.SourceNodeRid.IsEmpty
            || record.SourceNodeGeneration == 0
            ...
            throw new ArgumentOutOfRangeException(nameof(record));
        return ServiceWirePilotCodec.EncodeRelocationPrepare40(
            new(
    ...
    internal static byte[] EncodeRelocationReady(RelocationReadyRecord record)
    {
        ...
        if (record.SenderRole != 2)
            throw new ArgumentOutOfRangeException(nameof(record));
        _ = ToGenerated(record.Object);
        return ServiceWirePilotCodec.EncodeRelocationReady30(
            new(
                ToGenerated(record.RelocationId),
                record.TargetAttemptGeneration,
                ToGenerated(record.Coordinator),
    ...
    internal static byte[] EncodeRelocationFailed(RelocationFailedRecord record)
    {
        ...
        try
        {
            return ServiceWirePilotCodec.EncodeRelocationFailed53(
                new(
                    ToGenerated(record.RelocationId),
                    record.TargetAttemptGeneration,
                    ToGenerated(record.Coordinator),
    ...
    internal static byte[] EncodeRelocationData(RelocationDataRecord record)
    {
        ...
        if (
            ...
            throw new ArgumentOutOfRangeException(nameof(record));
        return ServiceWirePilotCodec.EncodeRelocationData31(
            new(
                ToGenerated(record.RelocationId),
                record.TargetAttemptGeneration,
                ToGenerated(record.Coordinator),
    ...
    internal static byte[] EncodeRelocationCutover(RelocationCutoverRecord record)
    {
        ...
        if (record.BoundaryRecordCount > long.MaxValue)
            throw new ArgumentOutOfRangeException(nameof(record));
        return ServiceWirePilotCodec.EncodeRelocationCutover34(
            new(
                ToGenerated(record.RelocationId),
                record.TargetAttemptGeneration,
                ToGenerated(record.Coordinator),
    ...
    internal static byte[] EncodeRelocationState(RelocationStateRecord record)
    {
        ...
        if (record.ChunkData.Length > RelocationChunkBytesBound)
            throw new ArgumentOutOfRangeException(nameof(record));
        return ServiceWirePilotCodec.EncodeRelocationState52(
            new(
                ToGenerated(record.RelocationId),
                record.TargetAttemptGeneration,
                ToGenerated(record.Coordinator),
    ...
    internal static bool TryDecodeRelocationPrepare(
        ReadOnlySpan<byte> bytes,
        out RelocationPrepareRecord record,
    ...
    internal static bool TryDecodeRelocationReady(
        ReadOnlySpan<byte> bytes,
        out RelocationReadyRecord record,
        out DecodeError error
    )
    {
        record = null!;
    ...
    internal static bool TryDecodeRelocationFailed(
        ReadOnlySpan<byte> bytes,
        out RelocationFailedRecord record,
        out DecodeError error
    )
    {
        record = null!;
    ...
    internal static bool TryDecodeRelocationData(
        ReadOnlySpan<byte> bytes,
        out RelocationDataRecord record,
        out DecodeError error
    )
    {
        record = null!;
    ...
    internal static bool TryDecodeRelocationCutover(
        ReadOnlySpan<byte> bytes,
        out RelocationCutoverRecord record,
        out DecodeError error
    )
    {
        record = null!;
    ...
    internal static bool TryDecodeRelocationState(
        ReadOnlySpan<byte> bytes,
        out RelocationStateRecord record,
        out DecodeError error
    )
    {
        record = null!;
    ...
    private static void WriteRelocationObject(WireWriter writer, RelocationObjectRecord value)
    {
        if (
            value.Kind is < 1 or > 3
    ...
    private static bool TryRelocationObject(ref WireReader reader, out RelocationObjectRecord value)
    {
        value = null!;
        if (
        ...
        {
            if (
                !body.TryText8(out stable)
                || !body.TryText8(out id)
                || string.IsNullOrEmpty(stable)
                || string.IsNullOrEmpty(id)
                || !body.TryU64(out generation)
                || generation == 0
            )
                return false;
        }
    ...
    private static void WriteFrozenRelocationControl(
        WireWriter writer,
    ...
    internal static FrozenRecord EncodeFrozenRelocationControl(FrozenRelocationControlRecord record)
    {
    ...
    )
    {
        ...
        return TryFrozenRelocationControl(ref reader, out record) && reader.Remaining == 0;
    }

    private static bool TryFrozenRelocationControl(
    ...
    )
    {
        ...
        record = new FrozenRelocationControlRecord(
            new RequestSourceFence(sourceOwner, sourceLease, sourceRid, sourceGeneration),
    ...
    private static void ValidateRelocationCommon(
        RelocationWireId id,
        ulong attempt,
        RelocationCoordinatorFence coordinator
    )
