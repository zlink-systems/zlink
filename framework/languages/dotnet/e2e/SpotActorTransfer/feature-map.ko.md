...
| ST-G2 | 미구현 | Actor 10,000개 inventory chunk, User Spot aggregate relocation capacity vector와 typed capacity aggregate all-or-none E2E가 없다. |
