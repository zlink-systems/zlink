...
assert.deepEqual(relocation.contractSources, [
  ...
  {
    path: 'framework/doc/framework/common/spec/server/05-location-relocation/05-host-relocation-flow.ko.md',
    sections: ['7', '8', '14']
  },
  {
    path: 'framework/doc/framework/common/spec/server/04-session/02-session-actor-binding.ko.md',
    sections: ['5', '6', '7']
  },
  {
