...
[Document List](../../../README.en.md) | [Previous: Runtime Execution](../../common/spec/server/01-execution/02-handler-turn-and-execution-gate.en.md) | [Next: Backend Dependency Policy](backend-dependency-policy.en.md)
<!-- framework-adapter-nav:end -->

[Spec Index](../../common/README.en.md)

[.NET Bundle](../README.en.md) | [Runtime Lifecycle](../../common/spec/server/README.en.md) | [Runtime Execution](../../common/spec/server/01-execution/02-handler-turn-and-execution-gate.en.md) | [Backend Policy](backend-dependency-policy.en.md) | [Common E2E](../../common/e2e/README.en.md)
...
| Does TicTacToe configure both endpoint connections and handlers manually? | Explicit registration through public builders and handler registries, plus `TicTacToeRegressionTests` | Source/regression and build passed | Linux sample process after this change and the Windows PowerShell runner |
...
[Layering Boundaries And Identifiers](../../common/spec/server/00-foundation/08-layering.en.md).
...
| Common Concept | `.NET` |
| Meter Name (Constant) | `ZLinkMeters.Framework` = `"zlink.framework"`, matching the [common metrics contract](../../common/spec/server/06-observability/02-runtime-metrics.en.md) byte-exact |
...
| Terminal Result | the enum numbers and allowed combinations of `ZLinkFrameworkRelocationResult` and `ZLinkFrameworkTerminationResult` match the [graceful drain contract](../../common/spec/server/05-location-relocation/05-host-relocation-flow.en.md) |
