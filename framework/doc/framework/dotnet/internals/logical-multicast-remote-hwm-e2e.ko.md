...
[Spot messaging §4](../../common/spec/server/03-spot-actor/02-spot-messaging.ko.md)와
[Core/Framework API §2.1](../../common/spec/server/00-foundation/06-framework-api.ko.md),
[Runtime monitoring §2.2](../../common/spec/server/06-observability/01-runtime-monitoring.ko.md)이다.
