...
!!! info "이 장을 읽고 나면"
    ...
    이 장의 코드는 [예제 저장소의 tutorial](https://github.com/zlink-systems/zlink-dotnet-examples/blob/main/tutorial/README.ko.md)과 [`TicTacToe`](https://github.com/zlink-systems/zlink-dotnet-examples/blob/main/samples/TicTacToe/README.ko.md)·[`ZoneWorld`](https://github.com/zlink-systems/zlink-dotnet-examples/blob/main/samples/ZoneWorld/README.ko.md) 샘플 README에서 가져왔으며, 각 README의 「내려받기와 설치」·「빌드」·「실행」 절을 따르면 연결과 대상 선택을 재현할 수 있다.
