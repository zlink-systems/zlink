...
다른 언어로 보기 — [C++](../../../cpp/guide/server/51-tictactoe.ko.md) · **C#/.NET** · [Java](../../../java/guide/server/51-tictactoe.ko.md) · [Kotlin](../../../kotlin/guide/server/51-tictactoe.ko.md) · [Node/TypeScript](../../../node/guide/server/51-tictactoe.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
