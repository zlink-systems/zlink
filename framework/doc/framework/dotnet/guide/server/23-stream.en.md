...
View in another language — [C++](../../../cpp/guide/server/23-stream.en.md) · **C#/.NET** · [Java](../../../java/guide/server/23-stream.en.md) · [Kotlin](../../../kotlin/guide/server/23-stream.en.md) · [Node/TypeScript](../../../node/guide/server/23-stream.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->

This chapter quotes code from the tutorial's [`Server` and `StreamClient` directories and its Run section](https://github.com/zlink-systems/zlink-dotnet-examples/blob/main/tutorial/README.md#run); bootstrapping and building that tree reproduces the results below.
