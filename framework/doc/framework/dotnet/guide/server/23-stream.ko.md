...
다른 언어로 보기 — [C++](../../../cpp/guide/server/23-stream.ko.md) · **C#/.NET** · [Java](../../../java/guide/server/23-stream.ko.md) · [Kotlin](../../../kotlin/guide/server/23-stream.ko.md) · [Node/TypeScript](../../../node/guide/server/23-stream.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
