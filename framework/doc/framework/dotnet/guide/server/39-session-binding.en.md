...
View in another language — **C#/.NET** · [C++](../../../cpp/guide/server/39-session-binding.en.md) · [Java](../../../java/guide/server/39-session-binding.en.md) · [Kotlin](../../../kotlin/guide/server/39-session-binding.en.md) · [Node/TypeScript](../../../node/guide/server/39-session-binding.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
