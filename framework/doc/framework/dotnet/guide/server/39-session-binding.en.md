---
title: "How Session Binding Works · C#/.NET"
---
...
View in another language — [C++](../../../cpp/guide/server/39-session-binding.en.md) · **C#/.NET** · [Java](../../../java/guide/server/39-session-binding.en.md) · [Kotlin](../../../kotlin/guide/server/39-session-binding.en.md) · [Node/TypeScript](../../../node/guide/server/39-session-binding.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
