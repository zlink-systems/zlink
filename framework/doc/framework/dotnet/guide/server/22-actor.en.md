...
View in another language — **C#/.NET** · [C++](../../../cpp/guide/server/22-actor.en.md) · [Java](../../../java/guide/server/22-actor.en.md) · [Kotlin](../../../kotlin/guide/server/22-actor.en.md) · [Node/TypeScript](../../../node/guide/server/22-actor.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
