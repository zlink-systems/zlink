...
View in another language — [C++](../../../cpp/guide/server/22-actor.en.md) · **C#/.NET** · [Java](../../../java/guide/server/22-actor.en.md) · [Kotlin](../../../kotlin/guide/server/22-actor.en.md) · [Node/TypeScript](../../../node/guide/server/22-actor.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
