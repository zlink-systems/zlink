---
title: "ShoppingMall 따라 읽기 · C#/.NET"
---
...
다른 언어로 보기 — [C++](../../../cpp/guide/server/54-shoppingmall.ko.md) · **C#/.NET** · [Java](../../../java/guide/server/54-shoppingmall.ko.md) · [Kotlin](../../../kotlin/guide/server/54-shoppingmall.ko.md) · [Node/TypeScript](../../../node/guide/server/54-shoppingmall.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
!!! info "이 장을 읽고 나면"
    ...
    확정으로 진행되고 실패하면 보상되기까지 코드를 따라갈 수 있다. 이 장의 코드는 [언어별 예제 저장소의 ShoppingMall 샘플](https://github.com/zlink-systems/zlink-dotnet-examples/tree/main/samples/ShoppingMall)에서 가져온다.
