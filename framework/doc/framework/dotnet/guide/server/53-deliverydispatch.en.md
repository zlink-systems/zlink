...
!!! info "What you get from this chapter"
    ...
    the status pushed to the customer. The code in this chapter comes from the [DeliveryDispatch sample in the per-language example repositories](https://github.com/zlink-systems/zlink-dotnet-examples/tree/main/samples/DeliveryDispatch).
