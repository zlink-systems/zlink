...
[가이드 홈](README.ko.md) | [이전: .NET Quickstart — 설치부터 첫 요청까지](../../quickstart.ko.md) | [다음: Channel 메시징](20-channel-messaging.ko.md)
<!-- framework-adapter-nav:end -->

<!-- language-switch:start -->
다른 언어로 보기 — [C++](../../../cpp/guide/server/03-concepts.ko.md) · **C#/.NET** · [Java](../../../java/guide/server/03-concepts.ko.md) · [Kotlin](../../../kotlin/guide/server/03-concepts.ko.md) · [Node/TypeScript](../../../node/guide/server/03-concepts.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
쓰든 같다([33-backpressure §3](33-backpressure.ko.md#4-api에-드러나는-backpressure)).
