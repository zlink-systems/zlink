...
View in another language — [C++](../../../cpp/guide/server/12-operations.en.md) · **C#/.NET** · [Java](../../../java/guide/server/12-operations.en.md) · [Kotlin](../../../kotlin/guide/server/12-operations.en.md) · [Node/TypeScript](../../../node/guide/server/12-operations.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
