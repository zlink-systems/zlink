---
title: "Reading Along: ZoneWorld · C#/.NET"
---
...
View in another language — [C++](../../../cpp/guide/server/56-zoneworld.en.md) · **C#/.NET** · [Java](../../../java/guide/server/56-zoneworld.en.md) · [Kotlin](../../../kotlin/guide/server/56-zoneworld.en.md) · [Node/TypeScript](../../../node/guide/server/56-zoneworld.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
!!! info "What you get from this chapter"
    ...
    stands in `framework/languages/dotnet/samples/ZoneWorld`.
