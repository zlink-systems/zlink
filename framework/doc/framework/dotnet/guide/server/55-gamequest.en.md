---
title: "Reading Along: GameQuest · C#/.NET"
---
...
View in another language — [C++](../../../cpp/guide/server/55-gamequest.en.md) · **C#/.NET** · [Java](../../../java/guide/server/55-gamequest.en.md) · [Kotlin](../../../kotlin/guide/server/55-gamequest.en.md) · [Node/TypeScript](../../../node/guide/server/55-gamequest.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
!!! info "What you get from this chapter"
    ...
    pushes, and through the reconciliation of lost progress. The code in this chapter comes from the [GameQuest sample in the per-language example repositories](https://github.com/zlink-systems/zlink-dotnet-examples/tree/main/samples/GameQuest).
