...
View in another language — **C#/.NET** · [C++](../../../cpp/guide/server/34-activation-lifetime.en.md) · [Java](../../../java/guide/server/34-activation-lifetime.en.md) · [Kotlin](../../../kotlin/guide/server/34-activation-lifetime.en.md) · [Node/TypeScript](../../../node/guide/server/34-activation-lifetime.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
