---
title: "Reading Along: Bingo · C#/.NET"
---
...
View in another language — [C++](../../../cpp/guide/server/50-bingo.en.md) · **C#/.NET** · [Java](../../../java/guide/server/50-bingo.en.md) · [Kotlin](../../../kotlin/guide/server/50-bingo.en.md) · [Node/TypeScript](../../../node/guide/server/50-bingo.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
!!! info "What you get from this chapter"
    ...
    chapter comes from the [Bingo sample in the per-language example repositories](https://github.com/zlink-systems/zlink-dotnet-examples/tree/main/samples/Bingo).
