---
title: "Reading Along: ShoppingMall · C#/.NET"
---
...
View in another language — [C++](../../../cpp/guide/server/54-shoppingmall.en.md) · **C#/.NET** · [Java](../../../java/guide/server/54-shoppingmall.en.md) · [Kotlin](../../../kotlin/guide/server/54-shoppingmall.en.md) · [Node/TypeScript](../../../node/guide/server/54-shoppingmall.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
!!! info "What you get from this chapter"
    ...
    and through compensation when a step fails. The code in this chapter comes from the [ShoppingMall sample in the per-language example repositories](https://github.com/zlink-systems/zlink-dotnet-examples/tree/main/samples/ShoppingMall).
