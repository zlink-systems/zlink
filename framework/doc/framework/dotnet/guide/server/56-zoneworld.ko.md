...
다른 언어로 보기 — [C++](../../../cpp/guide/server/56-zoneworld.ko.md) · **C#/.NET** · [Java](../../../java/guide/server/56-zoneworld.ko.md) · [Kotlin](../../../kotlin/guide/server/56-zoneworld.ko.md) · [Node/TypeScript](../../../node/guide/server/56-zoneworld.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
!!! info "이 장을 읽고 나면"
    ...
    코드는 `framework/languages/dotnet/samples/ZoneWorld`에서 그대로 실행된다.
