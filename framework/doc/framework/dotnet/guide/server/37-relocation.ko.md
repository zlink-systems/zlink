---
title: "Relocation · C#/.NET"
---

<!-- generated:start -->
<!-- 이 파일은 `common/guide/server/37-relocation.ko.md`에서 생성한다. 직접 고치지 않는다.
...
[가이드 홈](README.ko.md) | [이전: Timer와 worker](36-timer-worker.ko.md) | [다음: Channel 동작 원리](30-channel-patterns.ko.md)
<!-- framework-adapter-nav:end -->

<!-- language-switch:start -->
다른 언어로 보기 — [C++](../../../cpp/guide/server/37-relocation.ko.md) · **C#/.NET** · [Java](../../../java/guide/server/37-relocation.ko.md) · [Kotlin](../../../kotlin/guide/server/37-relocation.ko.md) · [Node/TypeScript](../../../node/guide/server/37-relocation.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
