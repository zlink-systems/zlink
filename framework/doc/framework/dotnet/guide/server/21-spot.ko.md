...
다른 언어로 보기 — [C++](../../../cpp/guide/server/21-spot.ko.md) · **C#/.NET** · [Java](../../../java/guide/server/21-spot.ko.md) · [Kotlin](../../../kotlin/guide/server/21-spot.ko.md) · [Node/TypeScript](../../../node/guide/server/21-spot.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
!!! info "이 장을 읽고 나면"
    ...
    이 장의 코드는 [언어별 예제 저장소](https://github.com/zlink-systems/zlink-dotnet-examples)의 tutorial에서 가져왔다.
