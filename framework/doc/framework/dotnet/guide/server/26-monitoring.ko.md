...
!!! info "이 장을 읽고 나면"
    ...
    끝났는지 남길 수 있다.
    이 장의 코드는 [예제 저장소의 tutorial README](https://github.com/zlink-systems/zlink-dotnet-examples/blob/main/tutorial/README.ko.md)에서 가져온 언어별 관측 표면의 최소 호출이며, README의 「내려받기와 설치」·「빌드」·「실행」 절을 따르면 process의 상태와 기록을 읽을 수 있다.
