...
tutorial의 Server와 Client를 [README의 「실행」 절](https://github.com/zlink-systems/zlink-dotnet-examples/blob/main/tutorial/README.ko.md#실행)대로 bootstrap하고 build해 실행하면, 이 장의 관측 호출로 그 process들의 상태와 기록을 읽을 수 있다.
