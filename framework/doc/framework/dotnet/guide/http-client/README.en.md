...
The user guide to `Zlink.HttpClient`. It lets handlers inside the server framework and tools outside the mesh
...
- Server guide: [C#/.NET Server Guide](../server/README.en.md)
- Stream Connector guide: [C#/.NET Stream Connector](../stream-connector/README.en.md)
