---
title: "Redirect, Retry, and Cookies · C#/.NET"
---
...
View in another language — [C++](../../../cpp/guide/http-client/09-redirect-retry-cookie.en.md) · **C#/.NET** · [Java](../../../java/guide/http-client/09-redirect-retry-cookie.en.md) · [Kotlin](../../../kotlin/guide/http-client/09-redirect-retry-cookie.en.md) · [Node/TypeScript](../../../node/guide/http-client/09-redirect-retry-cookie.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
```csharp
--8<-- "framework/languages/dotnet/tutorial/HttpClient/Program.cs:http-redirect"
```
