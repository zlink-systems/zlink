...
View in another language — [C++](../../../cpp/guide/http-client/03-making-requests.en.md) · **C#/.NET** · [Java](../../../java/guide/http-client/03-making-requests.en.md) · [Kotlin](../../../kotlin/guide/http-client/03-making-requests.en.md) · [Node/TypeScript](../../../node/guide/http-client/03-making-requests.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
