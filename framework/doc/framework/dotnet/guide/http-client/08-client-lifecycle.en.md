---
title: "Client and Request Lifecycle · C#/.NET"
---
...
View in another language — [C++](../../../cpp/guide/http-client/08-client-lifecycle.en.md) · **C#/.NET** · [Java](../../../java/guide/http-client/08-client-lifecycle.en.md) · [Kotlin](../../../kotlin/guide/http-client/08-client-lifecycle.en.md) · [Node/TypeScript](../../../node/guide/http-client/08-client-lifecycle.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
