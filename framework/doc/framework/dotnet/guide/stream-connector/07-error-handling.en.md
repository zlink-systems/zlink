...
[Contents](README.en.md) | [Previous: Connection Lifecycle](06-lifecycle.en.md) | [Next: Unity (Native Build)](08-unity.en.md)
<!-- framework-adapter-nav:end -->

<!-- language-switch:start -->
View in another language — [C++](../../../cpp/guide/stream-connector/07-error-handling.en.md) · **C#/.NET** · [Java](../../../java/guide/stream-connector/07-error-handling.en.md) · [Kotlin](../../../kotlin/guide/stream-connector/07-error-handling.en.md) · [Node/TypeScript](../../../node/guide/stream-connector/07-error-handling.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
