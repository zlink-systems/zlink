...
[Common Framework Policy](../../../common/spec/server/01-execution/README.en.md). Even in Unity, the
...
now. **The pending queue has no upper limit and drops no callback: every callback waits for the next
`Dispatch.Async()`.**
