...
다른 언어로 보기 — [C++](../../../cpp/guide/stream-connector/04-sending.ko.md) · **C#/.NET** · [Java](../../../java/guide/stream-connector/04-sending.ko.md) · [Kotlin](../../../kotlin/guide/stream-connector/04-sending.ko.md) · [Node/TypeScript](../../../node/guide/stream-connector/04-sending.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
