---
title: "Installation and the First Connection · C#/.NET"
---
...
View in another language — [C++](../../../cpp/guide/stream-connector/02-getting-started.en.md) · **C#/.NET** · [Java](../../../java/guide/stream-connector/02-getting-started.en.md) · [Kotlin](../../../kotlin/guide/stream-connector/02-getting-started.en.md) · [Node/TypeScript](../../../node/guide/stream-connector/02-getting-started.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
!!! info "After reading this chapter"
    ...
    `framework/languages/dotnet/tutorial/StreamClient`.
...
The command below runs the tutorial (`framework/languages/dotnet/tutorial`) StreamClient with its Server started as described in the README's "Run" section; StreamClient connects to the Server's stream endpoint.
