---
title: "Connection Lifecycle · C#/.NET"
---
...
View in another language — [C++](../../../cpp/guide/stream-connector/06-lifecycle.en.md) · **C#/.NET** · [Java](../../../java/guide/stream-connector/06-lifecycle.en.md) · [Kotlin](../../../kotlin/guide/stream-connector/06-lifecycle.en.md) · [Node/TypeScript](../../../node/guide/stream-connector/06-lifecycle.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
