...
[목차](README.ko.md) | [이전: Godot C#](09-godot-csharp.ko.md)
<!-- framework-adapter-nav:end -->

<!-- language-switch:start -->
다른 언어로 보기 — [C++](../../../cpp/guide/stream-connector/12-engine-integration.ko.md) · **C#/.NET** · [Java](../../../java/guide/stream-connector/12-engine-integration.ko.md) · [Kotlin](../../../kotlin/guide/stream-connector/12-engine-integration.ko.md) · [Node/TypeScript](../../../node/guide/stream-connector/12-engine-integration.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
