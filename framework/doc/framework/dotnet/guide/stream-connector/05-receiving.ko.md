...
다른 언어로 보기 — [C++](../../../cpp/guide/stream-connector/05-receiving.ko.md) · **C#/.NET** · [Java](../../../java/guide/stream-connector/05-receiving.ko.md) · [Kotlin](../../../kotlin/guide/stream-connector/05-receiving.ko.md) · [Node/TypeScript](../../../node/guide/stream-connector/05-receiving.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
`On<T>(handler)` 또는 이름을 받는 overload를 사용한다.
...
`WaitFor<T>()`와 `WaitFor<T>(name)`을 사용한다.
