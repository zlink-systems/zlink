...
View in another language — [C++](../../../cpp/guide/stream-connector/03-connector-options.en.md) · **C#/.NET** · [Java](../../../java/guide/stream-connector/03-connector-options.en.md) · [Kotlin](../../../kotlin/guide/stream-connector/03-connector-options.en.md) · [Node/TypeScript](../../../node/guide/stream-connector/03-connector-options.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
