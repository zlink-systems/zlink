...
[공통 스펙](../common/README.ko.md) | [비동기 실행](../common/spec/server/01-execution/README.ko.md) | [Exact interface](../common/spec/server/languages/dotnet/interfaces/README.ko.md) | [Stream Connector](../common/spec/stream-connector/languages/dotnet/03-stream-connector.ko.md) | [Unity 가이드](guide/stream-connector/08-unity.ko.md) | [공통 내부 구조](../common/spec/server/README.ko.md) | [Regression Matrix](internals/regression-test-matrix.ko.md) | [Backend Policy](internals/backend-dependency-policy.ko.md) | [Runtime Integration](internals/runtime-integration-and-ownership.ko.md)
...
현재 기준으로 반드시 지원해야 하는 runtime RID[^rid] 는 다음 네 가지다.
...
위 네 플랫폼을 모두 통과하는 것을 기본 조건으로 본다.
