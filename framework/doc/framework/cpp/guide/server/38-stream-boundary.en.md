...
View in another language — [C#/.NET](../../../dotnet/guide/server/38-stream-boundary.en.md) · **C++** · [Java](../../../java/guide/server/38-stream-boundary.en.md) · [Kotlin](../../../kotlin/guide/server/38-stream-boundary.en.md) · [Node/TypeScript](../../../node/guide/server/38-stream-boundary.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
