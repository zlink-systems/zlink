...
View in another language — [C#/.NET](../../../dotnet/guide/server/21-spot.en.md) · **C++** · [Java](../../../java/guide/server/21-spot.en.md) · [Kotlin](../../../kotlin/guide/server/21-spot.en.md) · [Node/TypeScript](../../../node/guide/server/21-spot.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
