...
다른 언어로 보기 — [C#/.NET](../../../dotnet/guide/server/31-handler-dispatch.ko.md) · **C++** · [Java](../../../java/guide/server/31-handler-dispatch.ko.md) · [Kotlin](../../../kotlin/guide/server/31-handler-dispatch.ko.md) · [Node/TypeScript](../../../node/guide/server/31-handler-dispatch.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
