...
[Guide Home](../../../index.en.md) | [Previous: 19. Configuration](41-configuration.en.md) | [Next: 4. Backpressure](33-backpressure.en.md)
...
The handler is the same common model as the handler in the [Quickstart](../../quickstart.en.md). DTO
...
request and delegating it to a channel is in [Channel messaging](20-channel-messaging.en.md#3-routemesh).
...
- The health endpoint: [Monitoring](26-monitoring.en.md)
