...
[가이드 홈](../../../index.ko.md) | [이전: 19. Configuration](41-configuration.ko.md) | [다음: 4. Backpressure](33-backpressure.ko.md)
...
핸들러는 [퀵스타트](../../quickstart.ko.md)의 handler와 같은 공통 모델이다. HTTP 경로의
DTO 직렬화는 기본으로 JSON이며 DTO의 `to_json`/`from_json` ADL 함수를 사용한다.
...
전형적인 패턴은 [Channel 메시징](20-channel-messaging.ko.md#3-routemesh)에 있다.
...
- health endpoint: [모니터링](26-monitoring.ko.md)
