...
[가이드 홈](README.ko.md) | [이전: 옵션과 기본값](16-options.ko.md) | [다음: Bingo 따라 읽기](50-bingo.ko.md)
<!-- framework-adapter-nav:end -->

<!-- language-switch:start -->
다른 언어로 보기 — **C++** · [C#/.NET](../../../dotnet/guide/server/14-samples.ko.md) · [Java](../../../java/guide/server/14-samples.ko.md) · [Kotlin](../../../kotlin/guide/server/14-samples.ko.md) · [Node/TypeScript](../../../node/guide/server/14-samples.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
| --- | --- | --- |
| 실시간 대전 게임 서버 | [TicTacToe](#3-tictactoe--실시간-대전-게임-서버-구축) | 자동 연결과 자동 등록을 걷어낸 가장 작은 구성 |
...
- server와 runner는 지원되는 언어에 제공되며 업무 동작과 검증 기준을 공유한다. .NET과 Node.js의
...
# 설치하고 샘플을 build/ 에 구성한다 (저장소 안이라면 framework/languages/cpp/samples/ 에서).
...
샘플은 하나씩 실행한다. 모든 샘플을 확인하려면 각각 호출한다. 브라우저 UI를 포함한
