...
[가이드 홈](../../../index.ko.md) | [이전: 18. DI 컨테이너](40-di-container.ko.md) | [다음: 20. HTTP Hosting](42-http-hosting.ko.md)
...
**나중에 로드한 소스가 같은 키를 덮어사용한다.** 관례적인 순서는
...
- DI 등록: [18. DI 컨테이너](40-di-container.ko.md)
