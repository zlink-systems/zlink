...
`configure_locations()`는 lease, route cache와 message-follow window를 설정한다.
...
[Relocation Flow](../../../common/spec/server/05-location-relocation/04-relocation-flow.ko.md)를 참고한다.
