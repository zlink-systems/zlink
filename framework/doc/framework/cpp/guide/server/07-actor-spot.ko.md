...
([spot-actor 스펙 §10.5](../../../common/spec/server/03-spot-actor/05-spot-actor-membership.ko.md)). 이동 중 reply를 기다리는
...
- Actor·Spot 주소 해석 규칙: [Object routing](../../../common/spec/server/03-spot-actor/08-routing.ko.md)
