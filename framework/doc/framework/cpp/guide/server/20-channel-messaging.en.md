...
View in another language — [C#/.NET](../../../dotnet/guide/server/20-channel-messaging.en.md) · **C++** · [Java](../../../java/guide/server/20-channel-messaging.en.md) · [Kotlin](../../../kotlin/guide/server/20-channel-messaging.en.md) · [Node/TypeScript](../../../node/guide/server/20-channel-messaging.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
