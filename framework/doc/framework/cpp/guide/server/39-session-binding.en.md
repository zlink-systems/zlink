...
View in another language — [C#/.NET](../../../dotnet/guide/server/39-session-binding.en.md) · **C++** · [Java](../../../java/guide/server/39-session-binding.en.md) · [Kotlin](../../../kotlin/guide/server/39-session-binding.en.md) · [Node/TypeScript](../../../node/guide/server/39-session-binding.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
