...
다른 언어로 보기 — [C#/.NET](../../../dotnet/guide/server/22-actor.ko.md) · **C++** · [Java](../../../java/guide/server/22-actor.ko.md) · [Kotlin](../../../kotlin/guide/server/22-actor.ko.md) · [Node/TypeScript](../../../node/guide/server/22-actor.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
