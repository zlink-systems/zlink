...
!!! info "이 장을 읽고 나면"
    ...
    있다.
    이 장의 코드는 [예제 저장소의 Bingo 샘플 README](https://github.com/zlink-systems/zlink-cpp-examples/blob/main/samples/Bingo/README.ko.md)에서 가져왔으며, README의 「내려받기와 설치」·「빌드」·「실행」 절을 따르면 실행 모델 예제를 재현할 수 있다.
