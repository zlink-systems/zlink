---
title: "Reading Along: DeliveryDispatch · C++"
---
...
View in another language — **C++** · [C#/.NET](../../../dotnet/guide/server/53-deliverydispatch.en.md) · [Java](../../../java/guide/server/53-deliverydispatch.en.md) · [Kotlin](../../../kotlin/guide/server/53-deliverydispatch.en.md) · [Node/TypeScript](../../../node/guide/server/53-deliverydispatch.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
