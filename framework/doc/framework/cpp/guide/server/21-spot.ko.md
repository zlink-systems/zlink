...
다른 언어로 보기 — [C#/.NET](../../../dotnet/guide/server/21-spot.ko.md) · **C++** · [Java](../../../java/guide/server/21-spot.ko.md) · [Kotlin](../../../kotlin/guide/server/21-spot.ko.md) · [Node/TypeScript](../../../node/guide/server/21-spot.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
