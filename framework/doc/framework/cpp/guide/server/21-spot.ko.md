...
!!! info "이 장을 읽고 나면"
    ...
    이 장의 코드는 [언어별 예제 저장소](https://github.com/zlink-systems/zlink-cpp-examples)의 tutorial에서 가져왔다.
...
node 집합의 이름이고, `in_mesh`는 route mesh에 참여한 node 가운데 Spot을 배치할 node를 고른다. route mesh를 등록하는 방법은
