...
!!! info "What you get from this chapter"
    ...
    The code is the minimal call on each language's observation surface from the [tutorial README in the examples repository](https://github.com/zlink-systems/zlink-cpp-examples/blob/main/tutorial/README.md); follow its Download, Build, and Run sections to read the processes' state and records.
