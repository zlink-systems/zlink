...
다른 언어로 보기 — [C#/.NET](../../../dotnet/guide/server/33-backpressure.ko.md) · **C++** · [Java](../../../java/guide/server/33-backpressure.ko.md) · [Kotlin](../../../kotlin/guide/server/33-backpressure.ko.md) · [Node/TypeScript](../../../node/guide/server/33-backpressure.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
