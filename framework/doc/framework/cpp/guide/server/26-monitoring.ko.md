...
다른 언어로 보기 — [C#/.NET](../../../dotnet/guide/server/26-monitoring.ko.md) · **C++** · [Java](../../../java/guide/server/26-monitoring.ko.md) · [Kotlin](../../../kotlin/guide/server/26-monitoring.ko.md) · [Node/TypeScript](../../../node/guide/server/26-monitoring.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
