...
다른 언어로 보기 — **C++** · [C#/.NET](../../../dotnet/guide/server/51-tictactoe.ko.md) · [Java](../../../java/guide/server/51-tictactoe.ko.md) · [Kotlin](../../../kotlin/guide/server/51-tictactoe.ko.md) · [Node/TypeScript](../../../node/guide/server/51-tictactoe.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
!!! info "이 장을 읽고 나면"
    ...
    정리되는 곳까지 코드를 따라갈 수 있다. 이 장의 코드는 [언어별 예제 저장소의 TicTacToe 샘플](https://github.com/zlink-systems/zlink-cpp-examples/tree/main/samples/TicTacToe)에서 가져온다.
