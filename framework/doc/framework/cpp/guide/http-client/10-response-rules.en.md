...
View in another language — **C++** · [C#/.NET](../../../dotnet/guide/http-client/10-response-rules.en.md) · [Java](../../../java/guide/http-client/10-response-rules.en.md) · [Kotlin](../../../kotlin/guide/http-client/10-response-rules.en.md) · [Node/TypeScript](../../../node/guide/http-client/10-response-rules.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
