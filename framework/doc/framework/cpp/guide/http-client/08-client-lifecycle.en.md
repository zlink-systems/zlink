---
title: "Client and Request Lifecycle · C++"
---
...
View in another language — **C++** · [C#/.NET](../../../dotnet/guide/http-client/08-client-lifecycle.en.md) · [Java](../../../java/guide/http-client/08-client-lifecycle.en.md) · [Kotlin](../../../kotlin/guide/http-client/08-client-lifecycle.en.md) · [Node/TypeScript](../../../node/guide/http-client/08-client-lifecycle.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
| raw response | `async_raw()` | `async_raw()` | `submitRaw()` | `awaitRaw()` | `submitRaw()` |
