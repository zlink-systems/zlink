...
다른 언어로 보기 — **C++** · [C#/.NET](../../../dotnet/guide/http-client/08-client-lifecycle.ko.md) · [Java](../../../java/guide/http-client/08-client-lifecycle.ko.md) · [Kotlin](../../../kotlin/guide/http-client/08-client-lifecycle.ko.md) · [Node/TypeScript](../../../node/guide/http-client/08-client-lifecycle.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
| raw 응답 | `async_raw()` | `async_raw()` | `submitRaw()` | `awaitRaw()` | `submitRaw()` |
