---
title: "Redirect, Retry, and Cookies · C++"
---
...
View in another language — **C++** · [C#/.NET](../../../dotnet/guide/http-client/09-redirect-retry-cookie.en.md) · [Java](../../../java/guide/http-client/09-redirect-retry-cookie.en.md) · [Kotlin](../../../kotlin/guide/http-client/09-redirect-retry-cookie.en.md) · [Node/TypeScript](../../../node/guide/http-client/09-redirect-retry-cookie.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
```cpp
--8<-- "framework/languages/cpp/tutorial/HttpClient/main.cpp:http-redirect"
```
