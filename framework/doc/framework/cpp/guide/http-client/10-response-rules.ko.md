...
다른 언어로 보기 — **C++** · [C#/.NET](../../../dotnet/guide/http-client/10-response-rules.ko.md) · [Java](../../../java/guide/http-client/10-response-rules.ko.md) · [Kotlin](../../../kotlin/guide/http-client/10-response-rules.ko.md) · [Node/TypeScript](../../../node/guide/http-client/10-response-rules.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
