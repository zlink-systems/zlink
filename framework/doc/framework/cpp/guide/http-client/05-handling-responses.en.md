...
View in another language — **C++** · [C#/.NET](../../../dotnet/guide/http-client/05-handling-responses.en.md) · [Java](../../../java/guide/http-client/05-handling-responses.en.md) · [Kotlin](../../../kotlin/guide/http-client/05-handling-responses.en.md) · [Node/TypeScript](../../../node/guide/http-client/05-handling-responses.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
