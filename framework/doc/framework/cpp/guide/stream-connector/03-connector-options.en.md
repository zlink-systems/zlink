...
View in another language — **C++** · [C#/.NET](../../../dotnet/guide/stream-connector/03-connector-options.en.md) · [Java](../../../java/guide/stream-connector/03-connector-options.en.md) · [Kotlin](../../../kotlin/guide/stream-connector/03-connector-options.en.md) · [Node/TypeScript](../../../node/guide/stream-connector/03-connector-options.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
