...
다른 언어로 보기 — **C++** · [C#/.NET](../../../dotnet/guide/stream-connector/01-overview.ko.md) · [Java](../../../java/guide/stream-connector/01-overview.ko.md) · [Kotlin](../../../kotlin/guide/stream-connector/01-overview.ko.md) · [Node/TypeScript](../../../node/guide/stream-connector/01-overview.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
