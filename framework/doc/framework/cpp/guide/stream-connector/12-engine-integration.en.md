---
title: "Game Engine Integration · C++"
---
...
[Contents](README.en.md) | [Previous: Performance Testing](11-performance.en.md)
<!-- framework-adapter-nav:end -->

<!-- language-switch:start -->
View in another language — **C++** · [C#/.NET](../../../dotnet/guide/stream-connector/12-engine-integration.en.md) · [Java](../../../java/guide/stream-connector/12-engine-integration.en.md) · [Kotlin](../../../kotlin/guide/stream-connector/12-engine-integration.en.md) · [Node/TypeScript](../../../node/guide/stream-connector/12-engine-integration.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
