...
다른 언어로 보기 — [C++](../../../cpp/guide/stream-connector/07-error-handling.ko.md) · [C#/.NET](../../../dotnet/guide/stream-connector/07-error-handling.ko.md) · [Java](../../../java/guide/stream-connector/07-error-handling.ko.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/stream-connector/07-error-handling.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
```kotlin
val errors = connector.onErrorReceived { error ->
