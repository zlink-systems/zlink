...
!!! info "After reading this chapter"
    ...
    `framework/languages/java/tutorial/kotlin/StreamClient`.
...
The command below runs the tutorial (`framework/languages/java/tutorial/kotlin`) StreamClient with its Server started as described in the README's "Run" section; StreamClient connects to the Server's stream endpoint.
