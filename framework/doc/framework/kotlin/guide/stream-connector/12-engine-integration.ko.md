...
다른 언어로 보기 — [C++](../../../cpp/guide/stream-connector/12-engine-integration.ko.md) · [C#/.NET](../../../dotnet/guide/stream-connector/12-engine-integration.ko.md) · [Java](../../../java/guide/stream-connector/12-engine-integration.ko.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/stream-connector/12-engine-integration.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
