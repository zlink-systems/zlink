---
title: "Connection Lifecycle · Kotlin"
---
...
View in another language — [C++](../../../cpp/guide/stream-connector/06-lifecycle.en.md) · [C#/.NET](../../../dotnet/guide/stream-connector/06-lifecycle.en.md) · [Java](../../../java/guide/stream-connector/06-lifecycle.en.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/stream-connector/06-lifecycle.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
