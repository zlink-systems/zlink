---
title: "Game Engine Integration · Kotlin"
---
...
View in another language — [C++](../../../cpp/guide/stream-connector/12-engine-integration.en.md) · [C#/.NET](../../../dotnet/guide/stream-connector/12-engine-integration.en.md) · [Java](../../../java/guide/stream-connector/12-engine-integration.en.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/stream-connector/12-engine-integration.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
