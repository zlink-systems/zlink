...
다른 언어로 보기 — [C++](../../../cpp/guide/stream-connector/06-lifecycle.ko.md) · [C#/.NET](../../../dotnet/guide/stream-connector/06-lifecycle.ko.md) · [Java](../../../java/guide/stream-connector/06-lifecycle.ko.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/stream-connector/06-lifecycle.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
```kotlin
// coroutine wrapper에는 이 읽기 표면이 없으므로 Java connector에서 읽는다.
