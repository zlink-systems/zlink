---
title: "Connector Options · Kotlin"
---
...
View in another language — [C++](../../../cpp/guide/stream-connector/03-connector-options.en.md) · [C#/.NET](../../../dotnet/guide/stream-connector/03-connector-options.en.md) · [Java](../../../java/guide/stream-connector/03-connector-options.en.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/stream-connector/03-connector-options.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
