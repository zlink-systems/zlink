...
View in another language — [C++](../../../cpp/guide/stream-connector/07-error-handling.en.md) · [C#/.NET](../../../dotnet/guide/stream-connector/07-error-handling.en.md) · [Java](../../../java/guide/stream-connector/07-error-handling.en.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/stream-connector/07-error-handling.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
