...
[가이드 홈](README.ko.md) | [이전: Stream Connector 개요](01-overview.ko.md) | [다음: Connector 옵션](03-connector-options.ko.md)
<!-- framework-adapter-nav:end -->

<!-- language-switch:start -->
다른 언어로 보기 — [C++](../../../cpp/guide/stream-connector/02-getting-started.ko.md) · [C#/.NET](../../../dotnet/guide/stream-connector/02-getting-started.ko.md) · [Java](../../../java/guide/stream-connector/02-getting-started.ko.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/stream-connector/02-getting-started.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
