...
View in another language — [C#/.NET](../../../dotnet/guide/server/23-stream.en.md) · [C++](../../../cpp/guide/server/23-stream.en.md) · [Java](../../../java/guide/server/23-stream.en.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/server/23-stream.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
