...
View in another language — [C#/.NET](../../../dotnet/guide/server/21-spot.en.md) · [C++](../../../cpp/guide/server/21-spot.en.md) · [Java](../../../java/guide/server/21-spot.en.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/server/21-spot.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
