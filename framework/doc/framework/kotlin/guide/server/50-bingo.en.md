---
title: "Reading Along: Bingo · Kotlin"
---
...
View in another language — [C++](../../../cpp/guide/server/50-bingo.en.md) · [C#/.NET](../../../dotnet/guide/server/50-bingo.en.md) · [Java](../../../java/guide/server/50-bingo.en.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/server/50-bingo.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
!!! info "What you get from this chapter"
    ...
    this chapter runs as it stands in `framework/languages/java/samples/kotlin/Bingo`.
