...
!!! info "이 장을 읽고 나면"
    ...
    확정으로 진행되고 실패하면 보상되기까지 코드를 따라갈 수 있다. 이 장의 코드는 [언어별 예제 저장소의 ShoppingMall 샘플](https://github.com/zlink-systems/zlink-kotlin-examples/tree/main/samples/ShoppingMall)에서 가져온다.
