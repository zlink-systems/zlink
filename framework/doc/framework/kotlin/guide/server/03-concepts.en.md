...
[Guide Home](README.en.md) | [Previous: Kotlin Quickstart — from Install to a First Request](../../quickstart.en.md) | [Next: Channel Messaging](20-channel-messaging.en.md)
...
This chapter quotes code from the tutorial's [`Server` and `Client` directories and its Run section](https://github.com/zlink-systems/zlink-kotlin-examples/blob/main/tutorial/README.md#run); bootstrapping and building that tree reproduces the results explained in later chapters.
