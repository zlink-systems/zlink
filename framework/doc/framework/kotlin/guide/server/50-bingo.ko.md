...
다른 언어로 보기 — [C++](../../../cpp/guide/server/50-bingo.ko.md) · [C#/.NET](../../../dotnet/guide/server/50-bingo.ko.md) · [Java](../../../java/guide/server/50-bingo.ko.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/server/50-bingo.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
!!! info "이 장을 읽고 나면"
    ...
    코드를 지나는지 따라갈 수 있다. 이 장의 코드는 `framework/languages/java/samples/kotlin/Bingo`에서
    그대로 실행된다.
