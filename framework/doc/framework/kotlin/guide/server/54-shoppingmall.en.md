---
title: "Reading Along: ShoppingMall · Kotlin"
---
...
View in another language — [C++](../../../cpp/guide/server/54-shoppingmall.en.md) · [C#/.NET](../../../dotnet/guide/server/54-shoppingmall.en.md) · [Java](../../../java/guide/server/54-shoppingmall.en.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/server/54-shoppingmall.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
