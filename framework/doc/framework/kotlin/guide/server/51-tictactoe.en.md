---
title: "Reading Along: TicTacToe · Kotlin"
---
...
View in another language — [C++](../../../cpp/guide/server/51-tictactoe.en.md) · [C#/.NET](../../../dotnet/guide/server/51-tictactoe.en.md) · [Java](../../../java/guide/server/51-tictactoe.en.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/server/51-tictactoe.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
!!! info "What you get from this chapter"
    ...
    in this chapter runs as it stands in `framework/languages/java/samples/kotlin/TicTacToe`.
