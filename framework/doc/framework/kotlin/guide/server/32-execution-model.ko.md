...
다른 언어로 보기 — [C++](../../../cpp/guide/server/32-execution-model.ko.md) · [C#/.NET](../../../dotnet/guide/server/32-execution-model.ko.md) · [Java](../../../java/guide/server/32-execution-model.ko.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/server/32-execution-model.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
