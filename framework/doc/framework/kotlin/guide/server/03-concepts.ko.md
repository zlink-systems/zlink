...
[가이드 홈](README.ko.md) | [이전: Kotlin Quickstart — 설치부터 첫 요청까지](../../quickstart.ko.md) | [다음: Channel 메시징](20-channel-messaging.ko.md)
<!-- framework-adapter-nav:end -->

<!-- language-switch:start -->
다른 언어로 보기 — [C++](../../../cpp/guide/server/03-concepts.ko.md) · [C#/.NET](../../../dotnet/guide/server/03-concepts.ko.md) · [Java](../../../java/guide/server/03-concepts.ko.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/server/03-concepts.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
