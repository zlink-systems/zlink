---
title: "Channel Messaging · Kotlin"
---
...
View in another language — [C++](../../../cpp/guide/server/20-channel-messaging.en.md) · [C#/.NET](../../../dotnet/guide/server/20-channel-messaging.en.md) · [Java](../../../java/guide/server/20-channel-messaging.en.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/server/20-channel-messaging.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->

This chapter quotes code from the tutorial's [`shared`, `Server`, and `Client` directories and its Run section](https://github.com/zlink-systems/zlink-kotlin-examples/blob/main/tutorial/README.md#run); bootstrapping and building that tree reproduces the results below.
