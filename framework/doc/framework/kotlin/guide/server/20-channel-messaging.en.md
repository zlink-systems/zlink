...
This chapter quotes code from the tutorial's [`shared`, `Server`, and `Client` directories and its Run section](https://github.com/zlink-systems/zlink-java-examples/blob/main/tutorial/README.md#run); bootstrapping and building that tree reproduces the results below.
