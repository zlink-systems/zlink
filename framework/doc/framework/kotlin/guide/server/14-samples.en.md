...
View in another language — [C++](../../../cpp/guide/server/14-samples.en.md) · [C#/.NET](../../../dotnet/guide/server/14-samples.en.md) · [Java](../../../java/guide/server/14-samples.en.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/server/14-samples.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
