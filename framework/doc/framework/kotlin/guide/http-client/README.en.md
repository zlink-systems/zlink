...
The user guide to `zlink-http-client-kotlin`. It lets handlers inside the server framework and tools outside the mesh
...
| 12 | [Coroutine Integration](12-coroutines.en.md) | Execution model specific to this language — how schedulers/dispatchers meet the terminators |
...
- Stream Connector guide: [Kotlin Stream Connector](../stream-connector/README.en.md)
