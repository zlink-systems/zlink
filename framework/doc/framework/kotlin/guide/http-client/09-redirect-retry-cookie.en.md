---
title: "Redirect, Retry, and Cookies · Kotlin"
---
...
View in another language — [C++](../../../cpp/guide/http-client/09-redirect-retry-cookie.en.md) · [C#/.NET](../../../dotnet/guide/http-client/09-redirect-retry-cookie.en.md) · [Java](../../../java/guide/http-client/09-redirect-retry-cookie.en.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/http-client/09-redirect-retry-cookie.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
