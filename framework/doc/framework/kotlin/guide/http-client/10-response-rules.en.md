...
View in another language — [C++](../../../cpp/guide/http-client/10-response-rules.en.md) · [C#/.NET](../../../dotnet/guide/http-client/10-response-rules.en.md) · [Java](../../../java/guide/http-client/10-response-rules.en.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/http-client/10-response-rules.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
