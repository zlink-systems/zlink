...
[Contents](README.en.md) | [Previous: Response Rules](10-response-rules.en.md) | [Next: Kotlin Coroutine Integration](12-coroutines.en.md)
<!-- framework-adapter-nav:end -->

<!-- language-switch:start -->
View in another language — [C++](../../../cpp/guide/http-client/11-error-handling.en.md) · [C#/.NET](../../../dotnet/guide/http-client/11-error-handling.en.md) · [Java](../../../java/guide/http-client/11-error-handling.en.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/http-client/11-error-handling.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
