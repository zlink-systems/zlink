...
View in another language — [C++](../../../cpp/guide/http-client/03-making-requests.en.md) · [C#/.NET](../../../dotnet/guide/http-client/03-making-requests.en.md) · [Java](../../../java/guide/http-client/03-making-requests.en.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/http-client/03-making-requests.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
