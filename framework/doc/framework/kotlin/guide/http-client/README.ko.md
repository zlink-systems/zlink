...
`zlink-http-client-kotlin`의 사용자 가이드다. 서버 framework 안의 handler와 mesh 밖의 도구가 외부 HTTP API를 zlink
...
| 12 | [코루틴 통합](12-coroutines.ko.md) | 이 언어만의 실행 모델 — scheduler·dispatcher와 종결자의 결합 |
...
- Stream Connector 가이드: [Kotlin Stream Connector](../stream-connector/README.ko.md)
