---
title: "Authentication, TLS, and Proxy · Kotlin"
---
...
View in another language — [C++](../../../cpp/guide/http-client/06-auth-tls-proxy.en.md) · [C#/.NET](../../../dotnet/guide/http-client/06-auth-tls-proxy.en.md) · [Java](../../../java/guide/http-client/06-auth-tls-proxy.en.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/http-client/06-auth-tls-proxy.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
