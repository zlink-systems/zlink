---
title: "Client and Request Lifecycle · Kotlin"
---
...
View in another language — [C++](../../../cpp/guide/http-client/08-client-lifecycle.en.md) · [C#/.NET](../../../dotnet/guide/http-client/08-client-lifecycle.en.md) · [Java](../../../java/guide/http-client/08-client-lifecycle.en.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/http-client/08-client-lifecycle.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
