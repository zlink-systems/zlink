...
다른 언어로 보기 — [C++](../../../cpp/guide/stream-connector/03-connector-options.ko.md) · [C#/.NET](../../../dotnet/guide/stream-connector/03-connector-options.ko.md) · **Java** · [Kotlin](../../../kotlin/guide/stream-connector/03-connector-options.ko.md) · [Node/TypeScript](../../../node/guide/stream-connector/03-connector-options.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
