...
다른 언어로 보기 — [C++](../../../cpp/guide/stream-connector/05-receiving.ko.md) · [C#/.NET](../../../dotnet/guide/stream-connector/05-receiving.ko.md) · **Java** · [Kotlin](../../../kotlin/guide/stream-connector/05-receiving.ko.md) · [Node/TypeScript](../../../node/guide/stream-connector/05-receiving.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
