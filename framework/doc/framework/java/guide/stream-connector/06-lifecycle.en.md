---
title: "Connection Lifecycle · Java"
---
...
View in another language — [C++](../../../cpp/guide/stream-connector/06-lifecycle.en.md) · [C#/.NET](../../../dotnet/guide/stream-connector/06-lifecycle.en.md) · **Java** · [Kotlin](../../../kotlin/guide/stream-connector/06-lifecycle.en.md) · [Node/TypeScript](../../../node/guide/stream-connector/06-lifecycle.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
