---
title: "Installation and the First Connection · Java"
---
...
View in another language — [C++](../../../cpp/guide/stream-connector/02-getting-started.en.md) · [C#/.NET](../../../dotnet/guide/stream-connector/02-getting-started.en.md) · **Java** · [Kotlin](../../../kotlin/guide/stream-connector/02-getting-started.en.md) · [Node/TypeScript](../../../node/guide/stream-connector/02-getting-started.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
!!! info "After reading this chapter"
    ...
    `framework/languages/java/tutorial/java/StreamClient`.
