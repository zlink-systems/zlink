...
The guide to the Java STREAM client connector. It targets server applications
and test tools.
...
- Public contract: [Java public contract](../../../common/spec/stream-connector/languages/java/03-stream-connector.en.md)
