---
title: "Game Engine Integration · Java"
---
...
View in another language — [C++](../../../cpp/guide/stream-connector/12-engine-integration.en.md) · [C#/.NET](../../../dotnet/guide/stream-connector/12-engine-integration.en.md) · **Java** · [Kotlin](../../../kotlin/guide/stream-connector/12-engine-integration.en.md) · [Node/TypeScript](../../../node/guide/stream-connector/12-engine-integration.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
