...
View in another language — [C++](../../../cpp/guide/stream-connector/05-receiving.en.md) · [C#/.NET](../../../dotnet/guide/stream-connector/05-receiving.en.md) · **Java** · [Kotlin](../../../kotlin/guide/stream-connector/05-receiving.en.md) · [Node/TypeScript](../../../node/guide/stream-connector/05-receiving.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
