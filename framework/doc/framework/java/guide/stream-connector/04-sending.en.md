...
View in another language — [C++](../../../cpp/guide/stream-connector/04-sending.en.md) · [C#/.NET](../../../dotnet/guide/stream-connector/04-sending.en.md) · **Java** · [Kotlin](../../../kotlin/guide/stream-connector/04-sending.en.md) · [Node/TypeScript](../../../node/guide/stream-connector/04-sending.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
