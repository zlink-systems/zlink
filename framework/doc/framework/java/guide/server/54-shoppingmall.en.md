---
title: "Reading Along: ShoppingMall · Java"
---
...
View in another language — [C++](../../../cpp/guide/server/54-shoppingmall.en.md) · [C#/.NET](../../../dotnet/guide/server/54-shoppingmall.en.md) · **Java** · [Kotlin](../../../kotlin/guide/server/54-shoppingmall.en.md) · [Node/TypeScript](../../../node/guide/server/54-shoppingmall.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
