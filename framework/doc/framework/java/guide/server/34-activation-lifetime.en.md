---
title: "Activation and Lifetime · Java"
---
...
View in another language — [C++](../../../cpp/guide/server/34-activation-lifetime.en.md) · [C#/.NET](../../../dotnet/guide/server/34-activation-lifetime.en.md) · **Java** · [Kotlin](../../../kotlin/guide/server/34-activation-lifetime.en.md) · [Node/TypeScript](../../../node/guide/server/34-activation-lifetime.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
