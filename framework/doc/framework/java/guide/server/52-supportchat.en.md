---
title: "Reading Along: SupportChat · Java"
---
...
View in another language — [C++](../../../cpp/guide/server/52-supportchat.en.md) · [C#/.NET](../../../dotnet/guide/server/52-supportchat.en.md) · **Java** · [Kotlin](../../../kotlin/guide/server/52-supportchat.en.md) · [Node/TypeScript](../../../node/guide/server/52-supportchat.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
