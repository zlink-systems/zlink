---
title: "Reading Along: GameQuest · Java"
---
...
View in another language — [C++](../../../cpp/guide/server/55-gamequest.en.md) · [C#/.NET](../../../dotnet/guide/server/55-gamequest.en.md) · **Java** · [Kotlin](../../../kotlin/guide/server/55-gamequest.en.md) · [Node/TypeScript](../../../node/guide/server/55-gamequest.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
