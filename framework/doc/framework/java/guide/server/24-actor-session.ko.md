...
다른 언어로 보기 — [C++](../../../cpp/guide/server/24-actor-session.ko.md) · [C#/.NET](../../../dotnet/guide/server/24-actor-session.ko.md) · **Java** · [Kotlin](../../../kotlin/guide/server/24-actor-session.ko.md) · [Node/TypeScript](../../../node/guide/server/24-actor-session.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
