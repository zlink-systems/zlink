...
다른 언어로 보기 — [C++](../../../cpp/guide/server/30-channel-patterns.ko.md) · [C#/.NET](../../../dotnet/guide/server/30-channel-patterns.ko.md) · **Java** · [Kotlin](../../../kotlin/guide/server/30-channel-patterns.ko.md) · [Node/TypeScript](../../../node/guide/server/30-channel-patterns.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
