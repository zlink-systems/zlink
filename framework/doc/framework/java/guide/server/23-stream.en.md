...
View in another language — [C++](../../../cpp/guide/server/23-stream.en.md) · [C#/.NET](../../../dotnet/guide/server/23-stream.en.md) · **Java** · [Kotlin](../../../kotlin/guide/server/23-stream.en.md) · [Node/TypeScript](../../../node/guide/server/23-stream.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
