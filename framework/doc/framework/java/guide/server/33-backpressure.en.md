---
title: "Backpressure — When Arrival Outpaces Processing · Java"
---
...
resume permit count down. Tune these boundaries with `setApplicationJobQueuePauseThresholdPercent`
(`1..100`) and `setApplicationJobQueueResumeThresholdPercent` (`0..99`); resume must be below
pause.
