...
View in another language — [C#/.NET](../../../dotnet/guide/server/24-actor-session.en.md) · [C++](../../../cpp/guide/server/24-actor-session.en.md) · **Java** · [Kotlin](../../../kotlin/guide/server/24-actor-session.en.md) · [Node/TypeScript](../../../node/guide/server/24-actor-session.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
