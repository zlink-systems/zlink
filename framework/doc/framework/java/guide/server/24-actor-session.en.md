...
View in another language — [C++](../../../cpp/guide/server/24-actor-session.en.md) · [C#/.NET](../../../dotnet/guide/server/24-actor-session.en.md) · **Java** · [Kotlin](../../../kotlin/guide/server/24-actor-session.en.md) · [Node/TypeScript](../../../node/guide/server/24-actor-session.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
