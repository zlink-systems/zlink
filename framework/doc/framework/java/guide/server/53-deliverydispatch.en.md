---
title: "Reading Along: DeliveryDispatch · Java"
---
...
View in another language — [C++](../../../cpp/guide/server/53-deliverydispatch.en.md) · [C#/.NET](../../../dotnet/guide/server/53-deliverydispatch.en.md) · **Java** · [Kotlin](../../../kotlin/guide/server/53-deliverydispatch.en.md) · [Node/TypeScript](../../../node/guide/server/53-deliverydispatch.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
