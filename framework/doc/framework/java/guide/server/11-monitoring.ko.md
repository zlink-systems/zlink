...
[Runtime metric과 집계 규칙](../../../common/spec/server/06-observability/02-runtime-metrics.ko.md)이 소유한다.
...
- 계기 이름 규약: [Runtime metric과 집계 규칙](../../../common/spec/server/06-observability/02-runtime-metrics.ko.md)
