...
다른 언어로 보기 — [C++](../../../cpp/guide/server/55-gamequest.ko.md) · [C#/.NET](../../../dotnet/guide/server/55-gamequest.ko.md) · **Java** · [Kotlin](../../../kotlin/guide/server/55-gamequest.ko.md) · [Node/TypeScript](../../../node/guide/server/55-gamequest.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
!!! info "이 장을 읽고 나면"
    ...
    완료가 push되기까지, 그리고 유실된 진행을 보정하기까지 코드를 따라갈 수 있다. 이 장의 코드는 [언어별 예제 저장소의 GameQuest 샘플](https://github.com/zlink-systems/zlink-java-examples/tree/main/samples/GameQuest)에서 가져온다.
