...
다른 언어로 보기 — [C++](../../../cpp/guide/server/50-bingo.ko.md) · [C#/.NET](../../../dotnet/guide/server/50-bingo.ko.md) · **Java** · [Kotlin](../../../kotlin/guide/server/50-bingo.ko.md) · [Node/TypeScript](../../../node/guide/server/50-bingo.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
