...
다른 언어로 보기 — [C++](../../../cpp/guide/server/16-options.ko.md) · [C#/.NET](../../../dotnet/guide/server/16-options.ko.md) · **Java** · [Kotlin](../../../kotlin/guide/server/16-options.ko.md) · [Node/TypeScript](../../../node/guide/server/16-options.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
| `setApplicationJobQueuePauseThresholdPercent` | 유입을 멈추는 사용률 | 80 |
| `setApplicationJobQueueResumeThresholdPercent` | 유입을 다시 여는 사용률 | 60 |
