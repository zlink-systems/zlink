---
title: "Reading Along: Bingo · Java"
---
...
View in another language — [C++](../../../cpp/guide/server/50-bingo.en.md) · [C#/.NET](../../../dotnet/guide/server/50-bingo.en.md) · **Java** · [Kotlin](../../../kotlin/guide/server/50-bingo.en.md) · [Node/TypeScript](../../../node/guide/server/50-bingo.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
