---
title: "Backpressure — 처리보다 도착이 빠를 때 · Java"
---
...
다른 언어로 보기 — [C++](../../../cpp/guide/server/33-backpressure.ko.md) · [C#/.NET](../../../dotnet/guide/server/33-backpressure.ko.md) · **Java** · [Kotlin](../../../kotlin/guide/server/33-backpressure.ko.md) · [Node/TypeScript](../../../node/guide/server/33-backpressure.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
| 설정 | `coreHwmMemoryLimitBytes` · `coreHwmBudgetBytes` · `CoreHwmProfile` | `ApplicationJobQueueProfile` · `maxQueuedApplicationJobs` · `setApplicationJobQueuePauseThresholdPercent` · `setApplicationJobQueueResumeThresholdPercent` |
