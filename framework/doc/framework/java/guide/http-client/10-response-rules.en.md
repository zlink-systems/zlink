...
View in another language — [C++](../../../cpp/guide/http-client/10-response-rules.en.md) · [C#/.NET](../../../dotnet/guide/http-client/10-response-rules.en.md) · **Java** · [Kotlin](../../../kotlin/guide/http-client/10-response-rules.en.md) · [Node/TypeScript](../../../node/guide/http-client/10-response-rules.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
