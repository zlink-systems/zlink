...
다른 언어로 보기 — [C++](../../../cpp/guide/http-client/03-making-requests.ko.md) · [C#/.NET](../../../dotnet/guide/http-client/03-making-requests.ko.md) · **Java** · [Kotlin](../../../kotlin/guide/http-client/03-making-requests.ko.md) · [Node/TypeScript](../../../node/guide/http-client/03-making-requests.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
