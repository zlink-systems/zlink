...
View in another language — [C++](../../../cpp/guide/http-client/04-request-body.en.md) · [C#/.NET](../../../dotnet/guide/http-client/04-request-body.en.md) · **Java** · [Kotlin](../../../kotlin/guide/http-client/04-request-body.en.md) · [Node/TypeScript](../../../node/guide/http-client/04-request-body.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
