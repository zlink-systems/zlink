---
title: "Authentication, TLS, and Proxy · Java"
---
...
View in another language — [C++](../../../cpp/guide/http-client/06-auth-tls-proxy.en.md) · [C#/.NET](../../../dotnet/guide/http-client/06-auth-tls-proxy.en.md) · **Java** · [Kotlin](../../../kotlin/guide/http-client/06-auth-tls-proxy.en.md) · [Node/TypeScript](../../../node/guide/http-client/06-auth-tls-proxy.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
