...
다른 언어로 보기 — [C++](../../../cpp/guide/http-client/02-getting-started.ko.md) · [C#/.NET](../../../dotnet/guide/http-client/02-getting-started.ko.md) · **Java** · [Kotlin](../../../kotlin/guide/http-client/02-getting-started.ko.md) · [Node/TypeScript](../../../node/guide/http-client/02-getting-started.ko.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
...
아래 출력은 tutorial(`framework/languages/java/tutorial/java`)의 Server와 Client를 그 README의 「실행」 절대로 띄운 상태에서 HttpClient를 실행한 결과이며, 주소는 Client의 HTTP 표면이다.
