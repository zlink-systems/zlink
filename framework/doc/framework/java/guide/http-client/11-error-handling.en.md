...
View in another language — [C++](../../../cpp/guide/http-client/11-error-handling.en.md) · [C#/.NET](../../../dotnet/guide/http-client/11-error-handling.en.md) · **Java** · [Kotlin](../../../kotlin/guide/http-client/11-error-handling.en.md) · [Node/TypeScript](../../../node/guide/http-client/11-error-handling.en.md)
{ .zlink-langswitch }
<!-- language-switch:end -->
