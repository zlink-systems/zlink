...
> public contract lives in the [central Java spec](../common/spec/server/languages/java/README.en.md).
...
> **Kotlin users** should see the [Kotlin-specific guide](../kotlin/README.en.md).
...
> `suspend`/`Flow` contracts are fixed separately in the [Kotlin spec](../common/spec/server/languages/kotlin/README.en.md).
...
| Document | Scope |
|------|------|
| [Spec table of contents](../common/spec/server/languages/java/README.en.md) | The list of Java/Kotlin public-contract documents |
