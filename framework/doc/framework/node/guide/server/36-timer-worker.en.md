...
View in another language — [C#/.NET](../../../dotnet/guide/server/36-timer-worker.en.md) · [C++](../../../cpp/guide/server/36-timer-worker.en.md) · [Java](../../../java/guide/server/36-timer-worker.en.md) · [Kotlin](../../../kotlin/guide/server/36-timer-worker.en.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
