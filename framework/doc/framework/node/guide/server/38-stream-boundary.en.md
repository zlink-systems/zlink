...
View in another language — [C#/.NET](../../../dotnet/guide/server/38-stream-boundary.en.md) · [C++](../../../cpp/guide/server/38-stream-boundary.en.md) · [Java](../../../java/guide/server/38-stream-boundary.en.md) · [Kotlin](../../../kotlin/guide/server/38-stream-boundary.en.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
