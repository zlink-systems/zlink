---
title: "Backpressure — When Arrival Outpaces Processing · Node/TypeScript"
---
...
View in another language — [C++](../../../cpp/guide/server/33-backpressure.en.md) · [C#/.NET](../../../dotnet/guide/server/33-backpressure.en.md) · [Java](../../../java/guide/server/33-backpressure.en.md) · [Kotlin](../../../kotlin/guide/server/33-backpressure.en.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->

This chapter quotes no tutorial code; it explains the limits and outcomes observable when load reaches tutorial `Server` and `Client` processes that have been bootstrapped and built using the [README Run section](https://github.com/zlink-systems/zlink-node-examples/blob/main/tutorial/README.md#run).
