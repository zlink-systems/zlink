...
> [Spot And Actor Membership](../../../common/spec/server/03-spot-actor/05-spot-actor-membership.en.md) own the behavior,
> and the
...
([spot-actor spec §10.5](../../../common/spec/server/03-spot-actor/05-spot-actor-membership.en.md)). The number of requests
...
- The Actor/Spot address resolution rule: [Object routing](../../../common/spec/server/03-spot-actor/08-routing.en.md)
