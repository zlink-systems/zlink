---
title: "Options and Defaults · Node/TypeScript"
---
...
View in another language — [C++](../../../cpp/guide/server/16-options.en.md) · [C#/.NET](../../../dotnet/guide/server/16-options.en.md) · [Java](../../../java/guide/server/16-options.en.md) · [Kotlin](../../../kotlin/guide/server/16-options.en.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
