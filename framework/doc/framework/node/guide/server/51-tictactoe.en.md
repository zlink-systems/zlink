---
title: "Reading Along: TicTacToe · Node/TypeScript"
---
...
View in another language — [C++](../../../cpp/guide/server/51-tictactoe.en.md) · [C#/.NET](../../../dotnet/guide/server/51-tictactoe.en.md) · [Java](../../../java/guide/server/51-tictactoe.en.md) · [Kotlin](../../../kotlin/guide/server/51-tictactoe.en.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
