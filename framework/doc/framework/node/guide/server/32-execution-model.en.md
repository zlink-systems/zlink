...
!!! info "What you get from this chapter"
    ...
    that boundary.
    The code comes from the [Bingo sample README in the examples repository](https://github.com/zlink-systems/zlink-node-examples/blob/main/samples/Bingo/README.md); follow its Download, Build, and Run sections to reproduce the execution-model example.
