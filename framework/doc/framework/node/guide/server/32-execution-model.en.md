...
The code in this chapter comes from the [`Bingo` sample README](https://github.com/zlink-systems/zlink-node-examples/blob/main/samples/Bingo/README.md). Download the [examples repository](https://github.com/zlink-systems/zlink-node-examples/blob/main/samples/Bingo/README.md) and follow its README's Download, Build and Run sections to reproduce the results below.
