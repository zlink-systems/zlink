---
title: "Reading Along: Bingo · Node/TypeScript"
---
...
View in another language — [C++](../../../cpp/guide/server/50-bingo.en.md) · [C#/.NET](../../../dotnet/guide/server/50-bingo.en.md) · [Java](../../../java/guide/server/50-bingo.en.md) · [Kotlin](../../../kotlin/guide/server/50-bingo.en.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
...
!!! info "What you get from this chapter"
    ...
    chapter comes from the [Bingo sample in the per-language example repositories](https://github.com/zlink-systems/zlink-node-examples/tree/main/samples/Bingo).
