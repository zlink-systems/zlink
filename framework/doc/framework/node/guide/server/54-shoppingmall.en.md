---
title: "Reading Along: ShoppingMall · Node/TypeScript"
---
...
View in another language — [C++](../../../cpp/guide/server/54-shoppingmall.en.md) · [C#/.NET](../../../dotnet/guide/server/54-shoppingmall.en.md) · [Java](../../../java/guide/server/54-shoppingmall.en.md) · [Kotlin](../../../kotlin/guide/server/54-shoppingmall.en.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
...
!!! info "What you get from this chapter"
    ...
    and through compensation when a step fails. The code in this chapter comes from the [ShoppingMall sample in the per-language example repositories](https://github.com/zlink-systems/zlink-node-examples/tree/main/samples/ShoppingMall).
