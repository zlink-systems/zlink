---
title: "ZoneWorld 따라 읽기 · Node/TypeScript"
---
...
다른 언어로 보기 — [C++](../../../cpp/guide/server/56-zoneworld.ko.md) · [C#/.NET](../../../dotnet/guide/server/56-zoneworld.ko.md) · [Java](../../../java/guide/server/56-zoneworld.ko.md) · [Kotlin](../../../kotlin/guide/server/56-zoneworld.ko.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
