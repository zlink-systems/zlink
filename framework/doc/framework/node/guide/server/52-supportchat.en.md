---
title: "Reading Along: SupportChat · Node/TypeScript"
---
...
View in another language — [C++](../../../cpp/guide/server/52-supportchat.en.md) · [C#/.NET](../../../dotnet/guide/server/52-supportchat.en.md) · [Java](../../../java/guide/server/52-supportchat.en.md) · [Kotlin](../../../kotlin/guide/server/52-supportchat.en.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
...
!!! info "What you get from this chapter"
    ...
    the code of each server it passes. The code in this chapter comes from the [SupportChat sample in the per-language example repositories](https://github.com/zlink-systems/zlink-node-examples/tree/main/samples/SupportChat).
...
```typescript
--8<-- "framework/languages/node/samples/SupportChat.Ts/Server/Session/Sessions/supportchat-session.ts:doc-sc-metadata-relay"
```
