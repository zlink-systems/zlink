...
다른 언어로 보기 — [C++](../../../cpp/guide/server/12-operations.ko.md) · [C#/.NET](../../../dotnet/guide/server/12-operations.ko.md) · [Java](../../../java/guide/server/12-operations.ko.md) · [Kotlin](../../../kotlin/guide/server/12-operations.ko.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
