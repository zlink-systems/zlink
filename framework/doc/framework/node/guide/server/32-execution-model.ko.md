...
다른 언어로 보기 — [C++](../../../cpp/guide/server/32-execution-model.ko.md) · [C#/.NET](../../../dotnet/guide/server/32-execution-model.ko.md) · [Java](../../../java/guide/server/32-execution-model.ko.md) · [Kotlin](../../../kotlin/guide/server/32-execution-model.ko.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->

이 장의 코드는 [`Bingo` 샘플 README](https://github.com/zlink-systems/zlink-node-examples/blob/main/samples/Bingo/README.ko.md)에서 가져왔다. [예제 저장소](https://github.com/zlink-systems/zlink-node-examples/blob/main/samples/Bingo/README.ko.md)를 내려받아 README의 「내려받기와 설치」·「빌드」·「실행」 절을 따라 실행하면 아래 실행 모델 예제를 재현할 수 있다.
...
`.yield()` 줄에서 room Spot turn을 반납한다.
