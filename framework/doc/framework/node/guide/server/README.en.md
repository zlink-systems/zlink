...
View in another language — [C++](../../../cpp/guide/server/README.en.md) · [C#/.NET](../../../dotnet/guide/server/README.en.md) · [Java](../../../java/guide/server/README.en.md) · [Kotlin](../../../kotlin/guide/server/README.en.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->

A Node.js application framework for building **server systems where real-time
messaging matters** out of several cooperating processes. It goes straight into
NestJS, so there is no separate runtime to move to.
...
The DI container, configuration, HTTP endpoints and logging are NestJS's own.
...
Chapters 01, 11, 13, and 16 are written separately for Node.js because the install steps
