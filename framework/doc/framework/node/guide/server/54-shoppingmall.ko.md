---
title: "ShoppingMall 따라 읽기 · Node/TypeScript"
---
...
다른 언어로 보기 — [C++](../../../cpp/guide/server/54-shoppingmall.ko.md) · [C#/.NET](../../../dotnet/guide/server/54-shoppingmall.ko.md) · [Java](../../../java/guide/server/54-shoppingmall.ko.md) · [Kotlin](../../../kotlin/guide/server/54-shoppingmall.ko.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
