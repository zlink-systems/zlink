---
title: "Response Rules · Node/TypeScript"
---
...
View in another language — [C++](../../../cpp/guide/http-client/10-response-rules.en.md) · [C#/.NET](../../../dotnet/guide/http-client/10-response-rules.en.md) · [Java](../../../java/guide/http-client/10-response-rules.en.md) · [Kotlin](../../../kotlin/guide/http-client/10-response-rules.en.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
