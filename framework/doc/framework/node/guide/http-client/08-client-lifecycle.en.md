---
title: "Client and Request Lifecycle · Node/TypeScript"
---
...
View in another language — [C++](../../../cpp/guide/http-client/08-client-lifecycle.en.md) · [C#/.NET](../../../dotnet/guide/http-client/08-client-lifecycle.en.md) · [Java](../../../java/guide/http-client/08-client-lifecycle.en.md) · [Kotlin](../../../kotlin/guide/http-client/08-client-lifecycle.en.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
