...
View in another language — [C++](../../../cpp/guide/http-client/11-error-handling.en.md) · [C#/.NET](../../../dotnet/guide/http-client/11-error-handling.en.md) · [Java](../../../java/guide/http-client/11-error-handling.en.md) · [Kotlin](../../../kotlin/guide/http-client/11-error-handling.en.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
