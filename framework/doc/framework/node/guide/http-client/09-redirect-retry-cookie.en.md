---
title: "Redirect, Retry, and Cookies · Node/TypeScript"
---
...
View in another language — [C++](../../../cpp/guide/http-client/09-redirect-retry-cookie.en.md) · [C#/.NET](../../../dotnet/guide/http-client/09-redirect-retry-cookie.en.md) · [Java](../../../java/guide/http-client/09-redirect-retry-cookie.en.md) · [Kotlin](../../../kotlin/guide/http-client/09-redirect-retry-cookie.en.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
...
```typescript
--8<-- "framework/languages/node/tutorial/HttpClient/main.ts:http-redirect"
```
