...
`@zlink-systems/http-client`의 사용자 가이드다. 서버 framework 안의 handler와 mesh 밖의 도구가 외부 HTTP API를 zlink
...
- Stream Connector 가이드: [Node/TypeScript Stream Connector](../stream-connector/README.ko.md)
