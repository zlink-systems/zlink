---
title: "인증·TLS·Proxy · Node/TypeScript"
---
...
다른 언어로 보기 — [C++](../../../cpp/guide/http-client/06-auth-tls-proxy.ko.md) · [C#/.NET](../../../dotnet/guide/http-client/06-auth-tls-proxy.ko.md) · [Java](../../../java/guide/http-client/06-auth-tls-proxy.ko.md) · [Kotlin](../../../kotlin/guide/http-client/06-auth-tls-proxy.ko.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
