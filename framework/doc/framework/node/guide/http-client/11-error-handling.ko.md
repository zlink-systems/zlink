...
[목차](README.ko.md) | [이전: 응답 처리 규칙](10-response-rules.ko.md)
<!-- framework-adapter-nav:end -->

<!-- language-switch:start -->
다른 언어로 보기 — [C++](../../../cpp/guide/http-client/11-error-handling.ko.md) · [C#/.NET](../../../dotnet/guide/http-client/11-error-handling.ko.md) · [Java](../../../java/guide/http-client/11-error-handling.ko.md) · [Kotlin](../../../kotlin/guide/http-client/11-error-handling.ko.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
