---
title: "Connection Lifecycle · Node/TypeScript"
---
...
View in another language — [C++](../../../cpp/guide/stream-connector/06-lifecycle.en.md) · [C#/.NET](../../../dotnet/guide/stream-connector/06-lifecycle.en.md) · [Java](../../../java/guide/stream-connector/06-lifecycle.en.md) · [Kotlin](../../../kotlin/guide/stream-connector/06-lifecycle.en.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
