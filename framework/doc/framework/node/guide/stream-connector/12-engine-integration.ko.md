---
title: "게임 엔진 통합 · Node/TypeScript"
---

<!-- generated:start -->
<!-- 이 파일은 `common/guide/stream-connector/12-engine-integration.ko.md`에서 생성한다. 직접 고치지 않는다.
...
[목차](README.ko.md) | [이전: Unity WebGL](09-unity-webgl.ko.md)
<!-- framework-adapter-nav:end -->

<!-- language-switch:start -->
다른 언어로 보기 — [C++](../../../cpp/guide/stream-connector/12-engine-integration.ko.md) · [C#/.NET](../../../dotnet/guide/stream-connector/12-engine-integration.ko.md) · [Java](../../../java/guide/stream-connector/12-engine-integration.ko.md) · [Kotlin](../../../kotlin/guide/stream-connector/12-engine-integration.ko.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
