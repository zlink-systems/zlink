---
title: "Installation and the First Connection · Node/TypeScript"
---
...
View in another language — [C++](../../../cpp/guide/stream-connector/02-getting-started.en.md) · [C#/.NET](../../../dotnet/guide/stream-connector/02-getting-started.en.md) · [Java](../../../java/guide/stream-connector/02-getting-started.en.md) · [Kotlin](../../../kotlin/guide/stream-connector/02-getting-started.en.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
...
!!! info "After reading this chapter"
    ...
    `framework/languages/node/tutorial/StreamClient`.
...
The command below runs the tutorial (`framework/languages/node/tutorial`) StreamClient with its Server started as described in the README's "Run" section; StreamClient connects to the Server's stream endpoint.
