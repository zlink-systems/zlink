---
title: "Sending Packets · Node/TypeScript"
---
...
View in another language — [C++](../../../cpp/guide/stream-connector/04-sending.en.md) · [C#/.NET](../../../dotnet/guide/stream-connector/04-sending.en.md) · [Java](../../../java/guide/stream-connector/04-sending.en.md) · [Kotlin](../../../kotlin/guide/stream-connector/04-sending.en.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
...
```typescript
await connector
  .send(new PositionUpdate(102.5, 0.0, -44.3))
...
```typescript
class OrderChanged {
  static readonly packetName = 'order.changed';
