...
[목차](README.ko.md) | [이전: 연결 생명주기](06-lifecycle.ko.md) | [다음: 브라우저](08-browser.ko.md)
<!-- framework-adapter-nav:end -->

<!-- language-switch:start -->
다른 언어로 보기 — [C++](../../../cpp/guide/stream-connector/07-error-handling.ko.md) · [C#/.NET](../../../dotnet/guide/stream-connector/07-error-handling.ko.md) · [Java](../../../java/guide/stream-connector/07-error-handling.ko.md) · [Kotlin](../../../kotlin/guide/stream-connector/07-error-handling.ko.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
