---
title: "Stream Connector 개요 · Node/TypeScript"
---

<!-- generated:start -->
<!-- 이 파일은 `common/guide/stream-connector/01-overview.ko.md`에서 생성한다. 직접 고치지 않는다.
...
다른 언어로 보기 — [C++](../../../cpp/guide/stream-connector/01-overview.ko.md) · [C#/.NET](../../../dotnet/guide/stream-connector/01-overview.ko.md) · [Java](../../../java/guide/stream-connector/01-overview.ko.md) · [Kotlin](../../../kotlin/guide/stream-connector/01-overview.ko.md) · **Node/TypeScript**
{ .zlink-langswitch }
<!-- language-switch:end -->
