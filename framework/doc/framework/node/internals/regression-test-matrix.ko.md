...
[문서 목록](../README.ko.md) | [이전: Runtime Lifecycle](../../common/spec/server/README.ko.md) | [다음: Backend Dependency Policy](backend-dependency-policy.ko.md)
<!-- framework-adapter-nav:end -->

[Node.js 묶음](../README.ko.md) | [Runtime Lifecycle](../../common/spec/server/README.ko.md) | [Backend Policy](backend-dependency-policy.ko.md) | [공통 E2E](../../common/e2e/README.ko.md)
...
| 플랫폼 ABI[^abi] | `win-x64`, `win-arm64`, `linux-x64`, `linux-arm64`, `darwin-arm64` |
...
| `npm run verify:abi-matrix` | `unit` | `framework-node` CI workflow, release 문서, package script 가 `win-x64`, `win-arm64`, `linux-x64`, `linux-arm64`, `darwin-arm64` 와 Node 20/22 gate 를 같은 목록으로 유지한다 |
