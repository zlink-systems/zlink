...
defined by §3.3 of `framework/doc/framework/common/spec/server/00-foundation/04-interaction-model.en.md` and
`framework/doc/framework/common/spec/server/02-channel-transport/01-channel-topology.en.md`, and on the fanout scenario of
...
`framework/doc/framework/common/spec/server/03-spot-actor/04-actor-model.en.md` and the
...
[Runtime Monitoring](../spec/server/06-observability/01-runtime-monitoring.en.md), and
[Runtime Metrics](../spec/server/06-observability/02-runtime-metrics.en.md). Perf fixtures verify those values and
