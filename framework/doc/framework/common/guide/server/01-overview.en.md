...
=== "C#/.NET"
    ...
    [internals/](../../../dotnet/internals/backend-dependency-policy.en.md).
...
=== "Node/TypeScript"
    ...
    service, handler, and location store model. Anyone reviewing the formal public API
    Anyone changing the runtime's internal structure should also read
    [internals/](../../../node/internals/backend-dependency-policy.en.md).
...
=== "C#/.NET"
    ...
    - [Quickstart](../../../dotnet/quickstart.en.md) — from installation to a first run
    ...
    **Operations and verification**
    ...
    - [16-options](../../../dotnet/guide/server/16-options.en.md) — the option list and defaults
...
=== "Java"
    ...
    - [Quickstart](../../../java/quickstart.en.md) — from installation to a first run
    - [Core concepts](03-concepts.en.md) — channels, roles, DI
    ...
    **Operations and verification**
    ...
    - [14-samples](14-samples.en.md) — Confirming with runnable samples
    - [15-e2e-testing](15-e2e-testing.en.md) — End-to-end testing
    - [16-options](../../../java/guide/server/16-options.en.md) — the option list and defaults
    - [Shared samples](../../../common/sample/README.en.md) — representative scenarios and their acceptance criteria
...
=== "Kotlin"
    ...
    - [Quickstart](../../../kotlin/quickstart.en.md) — from installation to a first run
    - [Core concepts](03-concepts.en.md) — channels, roles, DI
...
=== "Node/TypeScript"
    ...
    - [Quickstart](../../../node/quickstart.en.md) — from installation to a first run
    - [Core concepts](03-concepts.en.md) — channels, roles, DI
    ...
    **Operations and verification**
    ...
    - [14-samples](14-samples.en.md) — Confirming with runnable samples
    - [15-e2e-testing](15-e2e-testing.en.md) — End-to-end testing
    - [16-options](../../../node/guide/server/16-options.en.md) — the option list and defaults
    - [Shared samples](../../../common/sample/README.en.md) — representative scenarios and their acceptance criteria
