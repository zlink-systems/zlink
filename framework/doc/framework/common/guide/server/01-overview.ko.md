...
이 장의 코드는 [tutorial README](https://github.com/zlink-systems/zlink-<언어>-examples/blob/main/tutorial/README.ko.md)에서 가져왔다. [예제 저장소](https://github.com/zlink-systems/zlink-<언어>-examples/blob/main/tutorial/README.ko.md)를 내려받아 README의 「내려받기와 설치」·「빌드」·「실행」 절을 따라 실행하면 뒤의 장에서 설명하는 실행 결과를 재현할 수 있다.
...
| 어려움 | ZLink 기능 | 자세히 |
| --- | --- | --- |
| 장르별 토폴로지를 소켓부터 직접 만듦 | **channel 조합으로 토폴로지 선언** — 1:N 요청/응답, fan-out, 노드 지목 route mesh, room 단위 spot mesh를 등록 몇 줄로 조합, 연결은 location store가 자동 유지 | [계층 구조와 등록 지점](#33-계층-구조와-등록-지점) · [05](20-channel-messaging.ko.md)·[06](21-spot.ko.md)·[10](25-location.ko.md) |
...
> STREAM은 TCP/TLS/WS/WSS를 transport로 제공한다. **QUIC datagram과 WebTransport는
> STREAM transport가 아니다.** 다만 그런 게임에서도 매칭·로비·메타·
...
목록이다. 지원되는 언어가 같은 목록을 사용하므로 언어 탭으로 나누지 않는다.
...
=== "C++"
    ...
    | 축 | 사용자에게 보이는 것 | 가이드 챕터 |
    | --- | --- | --- |
    | channel messaging | request handler, send handler, `request_client_t`, handler filter | [05-channel-messaging](20-channel-messaging.ko.md) |
    | fanout | `AddFanoutChannel`, fanout handler | [05-channel-messaging](20-channel-messaging.ko.md) |
    | SPOT | typed spot factory, Spot context outbound, timer | [06-spot](21-spot.ko.md) |
    | actor / session | actor factory, Entry Spot, `bound_session_t`, session actor dispatch | [07-actor-spot](22-actor.ko.md) · [08-actor-session](24-actor-session.ko.md) |
    | STREAM | framework session packet, Stream Connector | [09-stream](23-stream.ko.md) |
    | 인프라 | Location 기반 자동 연결·운영 조회, runtime monitoring | [10-location](25-location.ko.md), [11-monitoring](26-monitoring.ko.md) |
...
=== "Java"
    ...
    <iframe class="zlink-diagram" src="/common/diagrams/01-lang-java.html" title="ZLink 계층 — Spring Boot" style="width:100%;border:0"></iframe>
...
=== "Kotlin"
    ...
    <iframe class="zlink-diagram" src="/common/diagrams/01-lang-kotlin.html" title="ZLink 계층 — Spring Boot" style="width:100%;border:0"></iframe>
...
=== "Node/TypeScript"
    ...
    <iframe class="zlink-diagram" src="/common/diagrams/01-lang-node.html" title="ZLink 계층 — NestJS" style="width:100%;border:0"></iframe>
...
=== "C#/.NET"
    ...
    [internals/](../../../dotnet/internals/backend-dependency-policy.ko.md)를 같이 봐야 한다.

=== "C++"

    코드에 노출하는 계층이 아니다. application 개발자는 DI, hosted service, handler와
    location store 모델로 공개 기능을 사용한다. runtime 내부 구조를 고치는 사람은
    [internals/](../../../cpp/internals/backend-dependency-policy.ko.md)를 같이 봐야 한다.
...
=== "Node/TypeScript"
    ...
    코드에 노출하는 계층이 아니다. application 개발자는 DI, hosted service, handler와
    location store 모델로 공개 기능을 사용한다. runtime 내부 구조를 고치는 사람은
    [internals/](../../../node/internals/backend-dependency-policy.ko.md)를 같이 봐야 한다.
...
=== "Kotlin"
    ...
    Java 표기를 그대로 쓴다. Kotlin 레이어가 추가하는 표면도 같은 규칙이다.
...
=== "C#/.NET"
    ...
    - [퀵스타트](../../../dotnet/quickstart.ko.md) — 설치부터 첫 동작 확인까지
    ...
    **운영과 확인**
    ...
    - [16-options](../../../dotnet/guide/server/16-options.ko.md) — 옵션 목록과 기본값
...
=== "C++"
    ...
    - [퀵스타트](../../../cpp/quickstart.ko.md) — 설치부터 첫 동작 확인까지
    - [핵심 개념](03-concepts.ko.md) — channel, 역할, DI
    ...
    **운영과 확인**
    ...
    - [14-samples](14-samples.ko.md) — 실행되는 샘플로 확인하기
    - [15-e2e-testing](15-e2e-testing.ko.md) — e2e 테스트
    - [16-options](../../../cpp/guide/server/16-options.ko.md) — 옵션 목록과 기본값
    - [공통 샘플](../../../common/sample/README.ko.md) — 대표 업무 시나리오와 검증 기준
...
=== "Kotlin"
    ...
    - [퀵스타트](../../../kotlin/quickstart.ko.md) — 설치부터 첫 동작 확인까지
    - [핵심 개념](03-concepts.ko.md) — channel, 역할, DI
...
=== "Node/TypeScript"
    ...
    - [퀵스타트](../../../node/quickstart.ko.md) — 설치부터 첫 동작 확인까지
    - [핵심 개념](03-concepts.ko.md) — channel, 역할, DI
    ...
    **운영과 확인**
    ...
    - [14-samples](14-samples.ko.md) — 실행되는 샘플로 확인하기
    - [15-e2e-testing](15-e2e-testing.ko.md) — e2e 테스트
    - [16-options](../../../node/guide/server/16-options.ko.md) — 옵션 목록과 기본값
    - [공통 샘플](../../../common/sample/README.ko.md) — 대표 업무 시나리오와 검증 기준
