...
!!! info "What you get from this chapter"
    ...
    receive answers. The code comes from the [tutorial README in the examples repository](https://github.com/zlink-systems/zlink-<language>-examples/blob/main/tutorial/README.md); follow its Download, Build, and Run sections to reproduce the results below.
...
=== "C#/.NET"
    ...
    ```csharp
    --8<-- "framework/languages/dotnet/tutorial/Server/Program.cs:relocation-store"
    ```
...
=== "Kotlin"
    ...
    ```kotlin
    --8<-- "framework/languages/java/tutorial/kotlin/Server/src/main/kotlin/systems/zlink/tutorial/server/ServerApplication.kt:relocation-store"
    ```
...
=== "C#/.NET"
    ...
    ```csharp
    --8<-- "framework/languages/dotnet/tutorial/Client/Program.cs:location-store-client"

    --8<-- "framework/languages/dotnet/tutorial/Client/Program.cs:spot-client-register"
    ```
...
=== "Kotlin"
    ...
    ```kotlin
    --8<-- "framework/languages/java/tutorial/kotlin/Client/src/main/kotlin/systems/zlink/tutorial/client/ClientApplication.kt:location-store-client"

    --8<-- "framework/languages/java/tutorial/kotlin/Client/src/main/kotlin/systems/zlink/tutorial/client/ClientApplication.kt:spot-client-register"
    ```
...
- A running version of this chapter's code — [the tutorial README in the examples repository](https://github.com/zlink-systems/zlink-<language>-examples/blob/main/tutorial/README.md)
