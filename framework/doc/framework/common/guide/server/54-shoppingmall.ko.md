...
!!! info "이 장을 읽고 나면"
    ...
    확정으로 진행되고 실패하면 보상되기까지 코드를 따라갈 수 있다. 이 장의 코드는 [언어별 예제 저장소의 ShoppingMall 샘플](https://github.com/zlink-systems/zlink-<언어>-examples/tree/main/samples/ShoppingMall)에서 가져온다.

[샘플 고르기](14-samples.ko.md#6-shoppingmall--주문-처리-시스템-구축)가 이 샘플이 무엇을 보여 주는지
...
=== "C#/.NET"
    ...
    `Server/OrderWorkflow/OrderWorkflowServerHostFactory.cs`

    ```csharp
    --8<-- "framework/languages/dotnet/samples/ShoppingMall/Server/OrderWorkflow/OrderWorkflowServerHostFactory.cs:doc-sm-workflow-register"
    ```
...
=== "Java"
    ...
    ```java
    --8<-- "framework/languages/java/samples/java/ShoppingMall/Server/OrderWorkflow/src/main/java/systems/zlink/samples/shoppingmall/server/orderworkflow/Program.java:doc-sm-workflow-register"
    ```
...
=== "Node/TypeScript"
    ...
    `Server/OrderWorkflow/shoppingmall-workflow-module.ts`

    ```typescript
    --8<-- "framework/languages/node/samples/ShoppingMall.Ts/Server/OrderWorkflow/shoppingmall-workflow-module.ts:doc-sm-workflow-register"
    ```
...
=== "C#/.NET"
    ...
    `Server/CommerceApi/Program.cs`

    ```csharp
    --8<-- "framework/languages/dotnet/samples/ShoppingMall/Server/CommerceApi/Program.cs:doc-sm-api-register"
    ```
...
=== "Java"
    ...
    `Server/CommerceApi/src/main/java/systems/zlink/samples/shoppingmall/server/commerceapi/Program.java`

    ```java
    --8<-- "framework/languages/java/samples/java/ShoppingMall/Server/CommerceApi/src/main/java/systems/zlink/samples/shoppingmall/server/commerceapi/Program.java:doc-sm-api-register"
    ```
...
=== "Node/TypeScript"
    ...
    `Server/CommerceApi/commerce-api-module.ts`

    ```typescript
    --8<-- "framework/languages/node/samples/ShoppingMall.Ts/Server/CommerceApi/commerce-api-module.ts:doc-sm-api-register"
    ```
...
=== "C#/.NET"
    ...
    `Server/CommerceApi/Application/OrderWorkflow/StartOrderUseCase.cs`

    ```csharp
    --8<-- "framework/languages/dotnet/samples/ShoppingMall/Server/CommerceApi/Application/OrderWorkflow/StartOrderUseCase.cs:doc-sm-api-start"
    ```
...
=== "Java"
    ...
    `Server/CommerceApi/src/main/java/systems/zlink/samples/shoppingmall/server/commerceapi/CommerceApiService.java`

    ```java
    --8<-- "framework/languages/java/samples/java/ShoppingMall/Server/CommerceApi/src/main/java/systems/zlink/samples/shoppingmall/server/commerceapi/CommerceApiService.java:doc-sm-api-start"
    ```
...
=== "Node/TypeScript"
    ...
    ```typescript
    --8<-- "framework/languages/node/samples/ShoppingMall.Ts/Server/Shared/Store/order-store.ts:doc-sm-api-start"
    ```
...
=== "C#/.NET"
    ...
    `Server/CommerceApi/Infrastructure/ZLink/ZLinkOrderWorkflowRouter.cs`
...
=== "C#/.NET"
    ...
    `Server/OrderWorkflow/Infrastructure/ZLink/Spots/OrderWorkflowSpot/Handlers/StartOrderWorkflowHandler.cs`

    ```csharp
    --8<-- "framework/languages/dotnet/samples/ShoppingMall/Server/OrderWorkflow/Infrastructure/ZLink/Spots/OrderWorkflowSpot/Handlers/StartOrderWorkflowHandler.cs:doc-sm-start-handler"
    ```
...
=== "Java"
    ...
    `Server/OrderWorkflow/src/main/java/systems/zlink/samples/shoppingmall/server/orderworkflow/spots/handlers/StartOrderWorkflowSpotHandler.java`

    ```java
    --8<-- "framework/languages/java/samples/java/ShoppingMall/Server/OrderWorkflow/src/main/java/systems/zlink/samples/shoppingmall/server/orderworkflow/spots/handlers/StartOrderWorkflowSpotHandler.java:doc-sm-start-handler"
    ```
...
=== "Node/TypeScript"
    ...
    ```typescript
    --8<-- "framework/languages/node/samples/ShoppingMall.Ts/Server/OrderWorkflow/Infrastructure/ZLink/Spots/OrderWorkflowSpot/Handlers/start-order-workflow-handler.ts:doc-sm-start-handler"
    ```
...
=== "C#/.NET"
    ...
    `Server/OrderWorkflow/Infrastructure/ZLink/Spots/OrderWorkflowSpot/OrderWorkflowSpot.cs`
...
=== "C#/.NET"
    ...
    `Server/OrderWorkflow/Application/OrderWorkflow/OrderWorkflowService.cs`

    ```csharp
    --8<-- "framework/languages/dotnet/samples/ShoppingMall/Server/OrderWorkflow/Application/OrderWorkflow/OrderWorkflowService.cs:doc-sm-background-continue"
    ```
...
=== "Java"
    ...
    `Server/OrderWorkflow/src/main/java/systems/zlink/samples/shoppingmall/server/orderworkflow/OrderWorkflowService.java`

    ```java
    --8<-- "framework/languages/java/samples/java/ShoppingMall/Server/OrderWorkflow/src/main/java/systems/zlink/samples/shoppingmall/server/orderworkflow/OrderWorkflowService.java:doc-sm-background-continue"
    ```
...
=== "Node/TypeScript"
    ...
    ```typescript
    --8<-- "framework/languages/node/samples/ShoppingMall.Ts/Server/OrderWorkflow/Infrastructure/ZLink/Spots/OrderWorkflowSpot/Handlers/start-order-workflow-handler.ts:doc-sm-background-continue"
    ```
...
=== "C#/.NET"
    ...
    ```csharp
    --8<-- "framework/languages/dotnet/samples/ShoppingMall/Server/OrderWorkflow/Application/OrderWorkflow/OrderWorkflowService.cs:doc-sm-replay"
    ```
...
=== "Java"
    ...
    ```java
    --8<-- "framework/languages/java/samples/java/ShoppingMall/Server/OrderWorkflow/src/main/java/systems/zlink/samples/shoppingmall/server/orderworkflow/OrderWorkflowService.java:doc-sm-replay"
    ```
...
=== "Node/TypeScript"
    ...
    ```typescript
    --8<-- "framework/languages/node/samples/ShoppingMall.Ts/Server/Shared/Store/order-store.ts:doc-sm-replay"
    ```
...
=== "C#/.NET"
    ...
    ```csharp
    --8<-- "framework/languages/dotnet/samples/ShoppingMall/Server/OrderWorkflow/Application/OrderWorkflow/OrderWorkflowService.cs:doc-sm-next-step"
    ```
...
=== "Java"
    ...
    ```java
    --8<-- "framework/languages/java/samples/java/ShoppingMall/Server/OrderWorkflow/src/main/java/systems/zlink/samples/shoppingmall/server/orderworkflow/OrderWorkflowService.java:doc-sm-next-step"
    ```
...
=== "Node/TypeScript"
    ...
    ```typescript
    --8<-- "framework/languages/node/samples/ShoppingMall.Ts/Server/Shared/Store/order-store.ts:doc-sm-next-step"
    ```
...
=== "C#/.NET"
    ...
    ```csharp
    --8<-- "framework/languages/dotnet/samples/ShoppingMall/Server/OrderWorkflow/Application/OrderWorkflow/OrderWorkflowService.cs:doc-sm-append"
    ```
...
=== "Java"
    ...
    ```java
    --8<-- "framework/languages/java/samples/java/ShoppingMall/Server/OrderWorkflow/src/main/java/systems/zlink/samples/shoppingmall/server/orderworkflow/OrderWorkflowService.java:doc-sm-append"
    ```
...
=== "Node/TypeScript"
    ...
    ```typescript
    --8<-- "framework/languages/node/samples/ShoppingMall.Ts/Server/Shared/Store/order-store.ts:doc-sm-append"
    ```
...
=== "C#/.NET"
    ...
    ```csharp
    --8<-- "framework/languages/dotnet/samples/ShoppingMall/Server/CommerceApi/Application/OrderWorkflow/StartOrderUseCase.cs:doc-sm-get-state"
    ```
...
=== "Java"
    ...
    ```java
    --8<-- "framework/languages/java/samples/java/ShoppingMall/Server/CommerceApi/src/main/java/systems/zlink/samples/shoppingmall/server/commerceapi/CommerceApiService.java:doc-sm-get-state"
    ```
...
=== "Node/TypeScript"
    ...
    ```typescript
    --8<-- "framework/languages/node/samples/ShoppingMall.Ts/Server/Shared/Store/order-store.ts:doc-sm-get-state"
    ```
...
=== "C#/.NET"
    ...
    ```csharp
    --8<-- "framework/languages/dotnet/samples/ShoppingMall/Server/OrderWorkflow/Application/OrderWorkflow/OrderWorkflowService.cs:doc-sm-rebuild"
    ```
...
=== "Java"
    ...
    `Server/Shared/src/main/java/systems/zlink/samples/shoppingmall/server/shared/store/RedisCommerceStore.java`

    ```java
    --8<-- "framework/languages/java/samples/java/ShoppingMall/Server/Shared/src/main/java/systems/zlink/samples/shoppingmall/server/shared/store/RedisCommerceStore.java:doc-sm-rebuild"
    ```
...
=== "Node/TypeScript"
    ...
    ```typescript
    --8<-- "framework/languages/node/samples/ShoppingMall.Ts/Server/Shared/Store/order-store.ts:doc-sm-rebuild"
    ```
...
=== "C#/.NET"
    ...
    ```csharp
    --8<-- "framework/languages/dotnet/samples/ShoppingMall/Server/OrderWorkflow/Infrastructure/ZLink/Spots/OrderWorkflowSpot/OrderWorkflowSpot.cs:doc-sm-close-terminal"
    ```
...
=== "Node/TypeScript"
    ...
    ```typescript
    --8<-- "framework/languages/node/samples/ShoppingMall.Ts/Server/OrderWorkflow/Infrastructure/ZLink/Spots/OrderWorkflowSpot/Handlers/continue-workflow-handler.ts:doc-sm-close-terminal"
    ```
...
=== "C#/.NET"
    ...
    ```bash
    framework/languages/dotnet/samples/ShoppingMall/run_sample.sh
    ```
