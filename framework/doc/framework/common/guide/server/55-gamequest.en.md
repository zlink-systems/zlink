...
!!! info "What you get from this chapter"
    ...
    pushes, and through the reconciliation of lost progress. The code in this chapter comes from the [GameQuest sample in the per-language example repositories](https://github.com/zlink-systems/zlink-<language>-examples/tree/main/samples/GameQuest).
...
=== "C#/.NET"
    ...
    `Server/GameApi/Program.cs`

    ```csharp
    --8<-- "framework/languages/dotnet/samples/GameQuest/Server/GameApi/Program.cs:doc-gq-api-register"
    ```

=== "C++"

    `Server/GameApi/main.cpp`

    ```cpp
    --8<-- "framework/languages/cpp/samples/GameQuest/Server/GameApi/main.cpp:doc-gq-api-register"
    ```

=== "Java"

    `Server/GameApi/src/main/java/systems/zlink/samples/gamequest/server/gameapi/Program.java`

    ```java
    --8<-- "framework/languages/java/samples/java/GameQuest/Server/GameApi/src/main/java/systems/zlink/samples/gamequest/server/gameapi/Program.java:doc-gq-api-register"
    ```
...
=== "C#/.NET"
    ...
    `Server/QuestMission/Program.cs`

    ```csharp
    --8<-- "framework/languages/dotnet/samples/GameQuest/Server/QuestMission/Program.cs:doc-gq-mission-register"
    ```

=== "C++"

    `Server/QuestMission/main.cpp`

    ```cpp
    --8<-- "framework/languages/cpp/samples/GameQuest/Server/QuestMission/main.cpp:doc-gq-mission-register"
    ```

=== "Java"

    `Server/QuestMission/src/main/java/systems/zlink/samples/gamequest/server/questmission/Program.java`

    ```java
    --8<-- "framework/languages/java/samples/java/GameQuest/Server/QuestMission/src/main/java/systems/zlink/samples/gamequest/server/questmission/Program.java:doc-gq-mission-register"
    ```
...
=== "C#/.NET"
    ...
    `Server/GameApi/Session/GameQuestSessionHandlers.cs`

    ```csharp
    --8<-- "framework/languages/dotnet/samples/GameQuest/Server/GameApi/Session/GameQuestSessionHandlers.cs:doc-gq-join-bind"
    ```
...
=== "C++"
    ...
    ```cpp
    --8<-- "framework/languages/cpp/samples/GameQuest/Server/GameApi/main.cpp:doc-gq-join-bind"
    ```

=== "Java"

    `Server/GameApi/src/main/java/systems/zlink/samples/gamequest/server/gameapi/sessions/GameQuestSession.java`

    ```java
    --8<-- "framework/languages/java/samples/java/GameQuest/Server/GameApi/src/main/java/systems/zlink/samples/gamequest/server/gameapi/sessions/GameQuestSession.java:doc-gq-join-bind"
    ```
...
=== "C#/.NET"
    ...
    ```csharp
    --8<-- "framework/languages/dotnet/samples/GameQuest/Server/GameApi/Session/GameQuestSessionHandlers.cs:doc-gq-action-handler"
    ```
...
=== "C++"
    ...
    ```cpp
    --8<-- "framework/languages/cpp/samples/GameQuest/Server/GameApi/main.cpp:doc-gq-action-handler"
    ```
...
=== "Java"
    ...
    ```java
    --8<-- "framework/languages/java/samples/java/GameQuest/Server/GameApi/src/main/java/systems/zlink/samples/gamequest/server/gameapi/sessions/GameQuestSession.java:doc-gq-action-handler"
    ```
...
=== "C#/.NET"
    ...
    `Server/GameApi/Application/GameplayActionService.cs`

    ```csharp
    --8<-- "framework/languages/dotnet/samples/GameQuest/Server/GameApi/Application/GameplayActionService.cs:doc-gq-store-dispatch"
    ```
...
=== "C++"
    ...
    ```cpp
    --8<-- "framework/languages/cpp/samples/GameQuest/Server/GameApi/main.cpp:doc-gq-store-dispatch"
    ```
...
=== "Java"
    ...
    ```java
    --8<-- "framework/languages/java/samples/java/GameQuest/Server/GameApi/src/main/java/systems/zlink/samples/gamequest/server/gameapi/sessions/GameQuestSession.java:doc-gq-store-dispatch"
    ```
...
=== "C#/.NET"
    ...
    `Server/GameApi/Infrastructure/ZLink/GameplayEventOwnerDispatcher.cs`

    ```csharp
    --8<-- "framework/languages/dotnet/samples/GameQuest/Server/GameApi/Infrastructure/ZLink/GameplayEventOwnerDispatcher.cs:doc-gq-owner-send"
    ```
...
=== "C++"
    ...
    ```cpp
    --8<-- "framework/languages/cpp/samples/GameQuest/Server/GameApi/main.cpp:doc-gq-owner-send"
    ```
...
=== "Java"
    ...
    ```java
    --8<-- "framework/languages/java/samples/java/GameQuest/Server/GameApi/src/main/java/systems/zlink/samples/gamequest/server/gameapi/sessions/GameQuestSession.java:doc-gq-owner-send"
    ```
...
=== "C#/.NET"
    ...
    `Server/QuestMission/Infrastructure/ZLink/Spots/PlayerQuestSpot/PlayerQuestSpot.cs`
...
=== "Java"
    ...
    `Server/QuestMission/src/main/java/systems/zlink/samples/gamequest/server/questmission/spots/PlayerQuestSpot.java`
...
=== "C#/.NET"
    ...
    ```csharp
    --8<-- "framework/languages/dotnet/samples/GameQuest/Server/QuestMission/Infrastructure/ZLink/Spots/PlayerQuestSpot/PlayerQuestSpot.cs:doc-gq-apply-handler"
    ```
...
=== "C++"
    ...
    ```cpp
    --8<-- "framework/languages/cpp/samples/GameQuest/Server/QuestMission/main.cpp:doc-gq-apply-handler"
    ```

=== "Java"

    `Server/QuestMission/src/main/java/systems/zlink/samples/gamequest/server/questmission/spots/handlers/ApplyGameplaySpotHandler.java`

    ```java
    --8<-- "framework/languages/java/samples/java/GameQuest/Server/QuestMission/src/main/java/systems/zlink/samples/gamequest/server/questmission/spots/handlers/ApplyGameplaySpotHandler.java:doc-gq-apply-handler"
    ```
...
=== "C#/.NET"
    ...
    `Server/QuestMission/Application/QuestEventProcessor.cs`

    ```csharp
    --8<-- "framework/languages/dotnet/samples/GameQuest/Server/QuestMission/Application/QuestEventProcessor.cs:doc-gq-process"
    ```
...
=== "C++"
    ...
    ```cpp
    --8<-- "framework/languages/cpp/samples/GameQuest/Server/QuestMission/main.cpp:doc-gq-process"
    ```

=== "Java"

    `Server/QuestMission/src/main/java/systems/zlink/samples/gamequest/server/questmission/store/QuestStore.java`

    ```java
    --8<-- "framework/languages/java/samples/java/GameQuest/Server/QuestMission/src/main/java/systems/zlink/samples/gamequest/server/questmission/store/QuestStore.java:doc-gq-process"
    ```
...
=== "C#/.NET"
    ...
    `Server/QuestMission/Infrastructure/ZLink/GameApiQuestClients.cs`

    ```csharp
    --8<-- "framework/languages/dotnet/samples/GameQuest/Server/QuestMission/Infrastructure/ZLink/GameApiQuestClients.cs:doc-gq-notify-actor"
    ```
...
=== "C++"
    ...
    ```cpp
    --8<-- "framework/languages/cpp/samples/GameQuest/Server/QuestMission/main.cpp:doc-gq-notify-actor"
    ```
...
=== "Java"
    ...
    ```java
    --8<-- "framework/languages/java/samples/java/GameQuest/Server/QuestMission/src/main/java/systems/zlink/samples/gamequest/server/questmission/spots/handlers/ApplyGameplaySpotHandler.java:doc-gq-notify-actor"
    ```
...
=== "C#/.NET"
    ...
    `Server/GameApi/Session/PlayerSessionActor.cs`

    ```csharp
    --8<-- "framework/languages/dotnet/samples/GameQuest/Server/GameApi/Session/PlayerSessionActor.cs:doc-gq-progress-push"
    ```
...
=== "C++"
    ...
    ```cpp
    --8<-- "framework/languages/cpp/samples/GameQuest/Server/GameApi/main.cpp:doc-gq-progress-push"
    ```

=== "Java"

    `Server/GameApi/src/main/java/systems/zlink/samples/gamequest/server/gameapi/spots/QuestProcessingActorHandler.java`

    ```java
    --8<-- "framework/languages/java/samples/java/GameQuest/Server/GameApi/src/main/java/systems/zlink/samples/gamequest/server/gameapi/spots/QuestProcessingActorHandler.java:doc-gq-progress-push"
    ```
...
=== "C#/.NET"
    ...
    ```csharp
    --8<-- "framework/languages/dotnet/samples/GameQuest/Server/QuestMission/Application/QuestEventProcessor.cs:doc-gq-sync"
    ```
...
=== "C++"
    ...
    ```cpp
    --8<-- "framework/languages/cpp/samples/GameQuest/Server/QuestMission/main.cpp:doc-gq-sync"
    ```
...
=== "Java"
    ...
    ```java
    --8<-- "framework/languages/java/samples/java/GameQuest/Server/QuestMission/src/main/java/systems/zlink/samples/gamequest/server/questmission/store/QuestStore.java:doc-gq-sync"
    ```
...
=== "C#/.NET"
    ...
    ```csharp
    --8<-- "framework/languages/dotnet/samples/GameQuest/Server/QuestMission/Infrastructure/ZLink/Spots/PlayerQuestSpot/PlayerQuestSpot.cs:doc-gq-close-handler"
    ```
...
=== "C++"
    ...
    ```cpp
    --8<-- "framework/languages/cpp/samples/GameQuest/Server/QuestMission/main.cpp:doc-gq-close-handler"
    ```

=== "Java"

    `Server/QuestMission/src/main/java/systems/zlink/samples/gamequest/server/questmission/spots/handlers/ClosePlayerQuestSpotHandler.java`

    ```java
    --8<-- "framework/languages/java/samples/java/GameQuest/Server/QuestMission/src/main/java/systems/zlink/samples/gamequest/server/questmission/spots/handlers/ClosePlayerQuestSpotHandler.java:doc-gq-close-handler"
    ```
...
=== "C#/.NET"
    ...
    ```bash
    framework/languages/dotnet/samples/GameQuest/run_sample.sh
    ```
