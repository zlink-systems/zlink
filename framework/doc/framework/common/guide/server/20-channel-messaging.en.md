...
This chapter quotes code from the tutorial's [`Shared`, `Server`, and `Client` directories and its Run section](https://github.com/zlink-systems/zlink-<language>-examples/blob/main/tutorial/README.md#run); bootstrapping and building that tree reproduces the results below.
...
=== "C++"
    ...
    ```cpp
    --8<-- "framework/languages/cpp/tutorial/Shared/contracts.hpp:channel-contracts"
    ```
...
=== "Kotlin"
    ...
    ```kotlin
    --8<-- "framework/languages/java/tutorial/kotlin/Shared/src/main/kotlin/systems/zlink/tutorial/shared/Contracts.kt:channel-contracts"
    ```

=== "Node/TypeScript"

    ```typescript
    --8<-- "framework/languages/node/tutorial/Shared/contracts.ts:channel-contracts"
    ```
...
=== "C++"
    ...
    ```cpp
    --8<-- "framework/languages/cpp/tutorial/Server/channel/record_login_handler.hpp:channel-send-handler"
    ```
...
=== "Kotlin"
    ...
    ```kotlin
    --8<-- "framework/languages/java/tutorial/kotlin/Server/src/main/kotlin/systems/zlink/tutorial/server/channel/RecordLoginHandler.kt:channel-send-handler"
    ```

=== "Node/TypeScript"

    ```typescript
    --8<-- "framework/languages/node/tutorial/Server/Channel/record-login-handler.ts:channel-send-handler"
    ```
...
=== "C++"
    ...
    ```cpp
    --8<-- "framework/languages/cpp/tutorial/Server/ops/node_status_handler.hpp:node-direct-handler"
    ```
...
=== "Kotlin"
    ...
    ```kotlin
    --8<-- "framework/languages/java/tutorial/kotlin/Server/src/main/kotlin/systems/zlink/tutorial/server/ops/NodeStatusHandler.kt:node-direct-handler"
    ```

=== "Node/TypeScript"

    ```typescript
    --8<-- "framework/languages/node/tutorial/Server/Ops/node-status-handler.ts:node-direct-handler"
    ```
...
=== "C++"
    ...
    ```cpp
    --8<-- "framework/languages/cpp/tutorial/Client/main.cpp:node-direct-call"
    ```
...
=== "Kotlin"
    ...
    ```kotlin
    --8<-- "framework/languages/java/tutorial/kotlin/Client/src/main/kotlin/systems/zlink/tutorial/client/OpsEndpoints.kt:node-direct-call"
    ```

=== "Node/TypeScript"

    ```typescript
    --8<-- "framework/languages/node/tutorial/Client/main.ts:node-direct-call"
    ```
...
=== "Kotlin"
    ...
    ```kotlin
    --8<-- "framework/languages/java/tutorial/kotlin/Client/src/main/kotlin/systems/zlink/tutorial/client/RoomEndpoints.kt:spot-send-call"
    ```
...
=== "C++"
    ...
    ```cpp
    --8<-- "framework/languages/cpp/tutorial/Server/main.cpp:clientserver-register"
    ```
...
=== "Kotlin"
    ...
    ```kotlin
    --8<-- "framework/languages/java/tutorial/kotlin/Server/src/main/kotlin/systems/zlink/tutorial/server/ServerApplication.kt:clientserver-register"
    ```

=== "Node/TypeScript"

    ```typescript
    --8<-- "framework/languages/node/tutorial/Server/main.ts:clientserver-register"
    ```
...
=== "C++"
    ...
    ```cpp
    --8<-- "framework/languages/cpp/tutorial/Client/main.cpp:clientserver-client-register"
    ```
...
=== "Kotlin"
    ...
    ```kotlin
    --8<-- "framework/languages/java/tutorial/kotlin/Client/src/main/kotlin/systems/zlink/tutorial/client/ClientApplication.kt:clientserver-client-register"
    ```

=== "Node/TypeScript"

    ```typescript
    --8<-- "framework/languages/node/tutorial/Client/main.ts:clientserver-client-register"
    ```
...
=== "C++"
    ...
    ```cpp
    --8<-- "framework/languages/cpp/tutorial/Server/channel/maintenance_notice_subscriber.hpp:fanout-handler"
    ```
...
=== "Kotlin"
    ...
    ```kotlin
    --8<-- "framework/languages/java/tutorial/kotlin/Server/src/main/kotlin/systems/zlink/tutorial/server/channel/MaintenanceNoticeSubscriber.kt:fanout-handler"
    ```

=== "Node/TypeScript"

    ```typescript
    --8<-- "framework/languages/node/tutorial/Server/Channel/maintenance-notice-subscriber.ts:fanout-handler"
    ```
