...
!!! info "What you get from this chapter"
    ...
    this chapter comes from the [TicTacToe sample in the per-language example repositories](https://github.com/zlink-systems/zlink-<language>-examples/tree/main/samples/TicTacToe).
