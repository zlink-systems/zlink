...
!!! info "What you get from this chapter"
    ...
    chapter comes from the [Bingo sample in the per-language example repositories](https://github.com/zlink-systems/zlink-<language>-examples/tree/main/samples/Bingo).
...
=== "C#/.NET"
    ...
    ```csharp
    --8<-- "framework/languages/dotnet/samples/Bingo/Server/Session/SessionServerHostFactory.cs:doc-bingo-session-register"
    ```
...
=== "Java"
    ...
    `Server/Session/src/main/java/systems/zlink/samples/bingo/server/session/SessionServerApplication.java`

    ```java
    --8<-- "framework/languages/java/samples/java/Bingo/Server/Session/src/main/java/systems/zlink/samples/bingo/server/session/SessionServerApplication.java:doc-bingo-session-register"
    ```

=== "Kotlin"

    `Server/Session/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/session/SessionServerApplication.kt`

    ```kotlin
    --8<-- "framework/languages/java/samples/kotlin/Bingo/Server/Session/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/session/SessionServerApplication.kt:doc-bingo-session-register"
    ```
...
=== "C#/.NET"
    ...
    `Server/Play/PlayServerHostFactory.cs`
...
=== "Java"
    ...
    `Server/Play/src/main/java/systems/zlink/samples/bingo/server/play/PlayServerApplication.java`
...
=== "Kotlin"
    ...
    `Server/Play/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/play/PlayServerApplication.kt`
...
=== "C#/.NET"
    ...
    `Server/Session/Sessions/Handlers/AuthenticateSessionHandler.cs`

    ```csharp
    --8<-- "framework/languages/dotnet/samples/Bingo/Server/Session/Sessions/Handlers/AuthenticateSessionHandler.cs:doc-bingo-session-auth"
    ```
...
=== "Java"
    ...
    `Server/Session/src/main/java/systems/zlink/samples/bingo/server/session/sessions/handlers/AuthenticateSessionHandler.java`

    ```java
    --8<-- "framework/languages/java/samples/java/Bingo/Server/Session/src/main/java/systems/zlink/samples/bingo/server/session/sessions/handlers/AuthenticateSessionHandler.java:doc-bingo-session-auth"
    ```

=== "Kotlin"

    `Server/Session/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/session/sessions/handlers/AuthenticateSessionHandler.kt`

    ```kotlin
    --8<-- "framework/languages/java/samples/kotlin/Bingo/Server/Session/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/session/sessions/handlers/AuthenticateSessionHandler.kt:doc-bingo-session-auth"
    ```
...
=== "C#/.NET"
    ...
    ```csharp
    --8<-- "framework/languages/dotnet/samples/Bingo/Server/Session/Sessions/Handlers/AuthenticateSessionHandler.cs:doc-bingo-session-bind"
    ```
...
=== "Java"
    ...
    ```java
    --8<-- "framework/languages/java/samples/java/Bingo/Server/Session/src/main/java/systems/zlink/samples/bingo/server/session/sessions/handlers/AuthenticateSessionHandler.java:doc-bingo-session-bind"
    ```
...
=== "Kotlin"
    ...
    ```kotlin
    --8<-- "framework/languages/java/samples/kotlin/Bingo/Server/Session/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/session/sessions/handlers/AuthenticateSessionHandler.kt:doc-bingo-session-bind"
    ```
...
=== "C#/.NET"
    ...
    ```csharp
    --8<-- "framework/languages/dotnet/samples/Bingo/Server/Session/Sessions/BingoSession.cs:doc-bingo-session-relay"
    ```
...
=== "Java"
    ...
    `Server/Session/src/main/java/systems/zlink/samples/bingo/server/session/sessions/BingoSession.java`

    ```java
    --8<-- "framework/languages/java/samples/java/Bingo/Server/Session/src/main/java/systems/zlink/samples/bingo/server/session/sessions/BingoSession.java:doc-bingo-session-relay"
    ```

=== "Kotlin"

    `Server/Session/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/session/sessions/BingoSession.kt`

    ```kotlin
    --8<-- "framework/languages/java/samples/kotlin/Bingo/Server/Session/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/session/sessions/BingoSession.kt:doc-bingo-session-relay"
    ```
...
=== "C#/.NET"
    ...
    ```csharp
    --8<-- "framework/languages/dotnet/samples/Bingo/Server/Play/Infrastructure/ZLink/Spots/EntrySpot/Handlers/MatchBingoActorHandler.cs:doc-bingo-match-actor"
    ```
...
=== "Java"
    ...
    `Server/Play/src/main/java/systems/zlink/samples/bingo/server/play/infrastructure/zlink/spots/entryspot/handlers/MatchBingoActorHandler.java`

    ```java
    --8<-- "framework/languages/java/samples/java/Bingo/Server/Play/src/main/java/systems/zlink/samples/bingo/server/play/infrastructure/zlink/spots/entryspot/handlers/MatchBingoActorHandler.java:doc-bingo-match-actor"
    ```

=== "Kotlin"

    `Server/Play/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/play/infrastructure/zlink/spots/entryspot/handlers/MatchBingoActorHandler.kt`

    ```kotlin
    --8<-- "framework/languages/java/samples/kotlin/Bingo/Server/Play/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/play/infrastructure/zlink/spots/entryspot/handlers/MatchBingoActorHandler.kt:doc-bingo-match-actor"
    ```
...
=== "C#/.NET"
    ...
    `Server/Api/Handlers/MatchBingoHandler.cs`

    ```csharp
    --8<-- "framework/languages/dotnet/samples/Bingo/Server/Api/Handlers/MatchBingoHandler.cs:doc-bingo-api-match"
    ```
...
=== "Java"
    ...
    `Server/Api/src/main/java/systems/zlink/samples/bingo/server/api/handlers/MatchBingoHandler.java`

    ```java
    --8<-- "framework/languages/java/samples/java/Bingo/Server/Api/src/main/java/systems/zlink/samples/bingo/server/api/handlers/MatchBingoHandler.java:doc-bingo-api-match"
    ```

=== "Kotlin"

    `Server/Api/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/api/handlers/MatchBingoHandler.kt`

    ```kotlin
    --8<-- "framework/languages/java/samples/kotlin/Bingo/Server/Api/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/api/handlers/MatchBingoHandler.kt:doc-bingo-api-match"
    ```
...
for the single creation, and the room's `GetOrCreate` follows the same rule — API does not decide
...
=== "C#/.NET"
    ...
    `Server/Matchmaking/Infrastructure/ZLink/BingoMatchmakerHandlers.cs`

    ```csharp
    --8<-- "framework/languages/dotnet/samples/Bingo/Server/Matchmaking/Infrastructure/ZLink/BingoMatchmakerHandlers.cs:doc-bingo-matchmaker-idle"
    ```
...
=== "Java"
    ...
    `Server/Matchmaking/src/main/java/systems/zlink/samples/bingo/server/matchmaking/BingoMatchmaker.java`

    ```java
    --8<-- "framework/languages/java/samples/java/Bingo/Server/Matchmaking/src/main/java/systems/zlink/samples/bingo/server/matchmaking/BingoMatchmaker.java:doc-bingo-matchmaker-idle"
    ```

=== "Kotlin"

    `Server/Matchmaking/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/matchmaking/BingoMatchmaker.kt`

    ```kotlin
    --8<-- "framework/languages/java/samples/kotlin/Bingo/Server/Matchmaking/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/matchmaking/BingoMatchmaker.kt:doc-bingo-matchmaker-idle"
    ```
...
=== "Java"
    ...
    `Server/Play/src/main/java/systems/zlink/samples/bingo/server/play/infrastructure/zlink/spots/bingoroomspot/BingoRoomSpot.java`
...
=== "Kotlin"
    ...
    `Server/Play/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/play/infrastructure/zlink/spots/bingoroomspot/BingoRoomSpot.kt`
...
=== "C#/.NET"
    ...
    `Server/Play/Infrastructure/ZLink/Spots/BingoRoomSpot/Handlers/BingoRoomDrawTimerHandler.cs`

    ```csharp
    --8<-- "framework/languages/dotnet/samples/Bingo/Server/Play/Infrastructure/ZLink/Spots/BingoRoomSpot/Handlers/BingoRoomDrawTimerHandler.cs:doc-bingo-draw-timer"
    ```
...
=== "Java"
    ...
    ```java
    --8<-- "framework/languages/java/samples/java/Bingo/Server/Play/src/main/java/systems/zlink/samples/bingo/server/play/infrastructure/zlink/spots/bingoroomspot/BingoRoomSpot.java:doc-bingo-draw-timer"
    ```
...
=== "Kotlin"
    ...
    ```kotlin
    --8<-- "framework/languages/java/samples/kotlin/Bingo/Server/Play/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/play/infrastructure/zlink/spots/bingoroomspot/BingoRoomSpot.kt:doc-bingo-draw-timer"
    ```
...
=== "C#/.NET"
    ...
    `Server/Play/Infrastructure/ZLink/Spots/Notifications/BingoNotificationPublisher.cs`

    ```csharp
    --8<-- "framework/languages/dotnet/samples/Bingo/Server/Play/Infrastructure/ZLink/Spots/Notifications/BingoNotificationPublisher.cs:doc-bingo-bound-push"
    ```
...
=== "Java"
    ...
    `Server/Play/src/main/java/systems/zlink/samples/bingo/server/play/infrastructure/zlink/actors/PlayerActor.java`

    ```java
    --8<-- "framework/languages/java/samples/java/Bingo/Server/Play/src/main/java/systems/zlink/samples/bingo/server/play/infrastructure/zlink/actors/PlayerActor.java:doc-bingo-bound-push"
    ```
...
=== "Kotlin"
    ...
    ```kotlin
    --8<-- "framework/languages/java/samples/kotlin/Bingo/Server/Play/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/play/infrastructure/zlink/spots/bingoroomspot/BingoRoomSpot.kt:doc-bingo-bound-push"
    ```
...
=== "C#/.NET"
    ...
    ```csharp
    --8<-- "framework/languages/dotnet/samples/Bingo/Server/Play/Infrastructure/ZLink/Spots/BingoRoomSpot/BingoRoom.cs:doc-bingo-reward-publish"
    ```
...
=== "Java"
    ...
    ```java
    --8<-- "framework/languages/java/samples/java/Bingo/Server/Play/src/main/java/systems/zlink/samples/bingo/server/play/infrastructure/zlink/spots/bingoroomspot/BingoRoomSpot.java:doc-bingo-reward-publish"
    ```
...
=== "Kotlin"
    ...
    ```kotlin
    --8<-- "framework/languages/java/samples/kotlin/Bingo/Server/Play/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/play/infrastructure/zlink/spots/bingoroomspot/BingoRoomSpot.kt:doc-bingo-reward-publish"
    ```
...
=== "C#/.NET"
    ...
    `Server/Play/Infrastructure/ZLink/Spots/BingoRoomSpot/Handlers/BingoRewardAcquiredEventHandler.cs`

    ```csharp
    --8<-- "framework/languages/dotnet/samples/Bingo/Server/Play/Infrastructure/ZLink/Spots/BingoRoomSpot/Handlers/BingoRewardAcquiredEventHandler.cs:doc-bingo-reward-subscribe"
    ```
...
=== "Java"
    ...
    `Server/Play/src/main/java/systems/zlink/samples/bingo/server/play/infrastructure/zlink/spots/bingoroomspot/handlers/BingoRewardAcquiredEventHandler.java`

    ```java
    --8<-- "framework/languages/java/samples/java/Bingo/Server/Play/src/main/java/systems/zlink/samples/bingo/server/play/infrastructure/zlink/spots/bingoroomspot/handlers/BingoRewardAcquiredEventHandler.java:doc-bingo-reward-subscribe"
    ```

=== "Kotlin"

    `Server/Play/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/play/infrastructure/zlink/spots/bingoroomspot/handlers/BingoRewardAcquiredEventHandler.kt`

    ```kotlin
    --8<-- "framework/languages/java/samples/kotlin/Bingo/Server/Play/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/play/infrastructure/zlink/spots/bingoroomspot/handlers/BingoRewardAcquiredEventHandler.kt:doc-bingo-reward-subscribe"
    ```
...
=== "C#/.NET"
    ...
    ```csharp
    --8<-- "framework/languages/dotnet/samples/Bingo/Server/Play/Infrastructure/ZLink/Spots/BingoRoomSpot/BingoRoom.cs:doc-bingo-room-cleanup"
    ```
...
=== "Java"
    ...
    ```java
    --8<-- "framework/languages/java/samples/java/Bingo/Server/Play/src/main/java/systems/zlink/samples/bingo/server/play/infrastructure/zlink/spots/bingoroomspot/BingoRoomSpot.java:doc-bingo-room-cleanup"
    ```
...
=== "Kotlin"
    ...
    ```kotlin
    --8<-- "framework/languages/java/samples/kotlin/Bingo/Server/Play/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/play/infrastructure/zlink/spots/bingoroomspot/BingoRoomSpot.kt:doc-bingo-room-cleanup"
    ```
...
=== "C#/.NET"
    ...
    ```csharp
    --8<-- "framework/languages/dotnet/samples/Bingo/Server/Play/Infrastructure/ZLink/Spots/EntrySpot/BingoEntrySpot.cs:doc-bingo-entry-destroy"
    ```
...
=== "Java"
    ...
    `Server/Play/src/main/java/systems/zlink/samples/bingo/server/play/infrastructure/zlink/spots/entryspot/BingoEntrySpot.java`

    ```java
    --8<-- "framework/languages/java/samples/java/Bingo/Server/Play/src/main/java/systems/zlink/samples/bingo/server/play/infrastructure/zlink/spots/entryspot/BingoEntrySpot.java:doc-bingo-entry-destroy"
    ```

=== "Kotlin"

    `Server/Play/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/play/infrastructure/zlink/spots/entryspot/BingoEntrySpot.kt`

    ```kotlin
    --8<-- "framework/languages/java/samples/kotlin/Bingo/Server/Play/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/play/infrastructure/zlink/spots/entryspot/BingoEntrySpot.kt:doc-bingo-entry-destroy"
    ```
...
=== "C#/.NET"
    ...
    ```csharp
    --8<-- "framework/languages/dotnet/samples/Bingo/Server/Session/Sessions/BingoSession.cs:doc-bingo-session-disconnect"
    ```
...
=== "Java"
    ...
    ```java
    --8<-- "framework/languages/java/samples/java/Bingo/Server/Session/src/main/java/systems/zlink/samples/bingo/server/session/sessions/BingoSession.java:doc-bingo-session-disconnect"
    ```
...
=== "Kotlin"
    ...
    ```kotlin
    --8<-- "framework/languages/java/samples/kotlin/Bingo/Server/Session/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/session/sessions/BingoSession.kt:doc-bingo-session-disconnect"
    ```
...
=== "C#/.NET"
    ...
    `Server/Play/Infrastructure/ZLink/Spots/BingoRoomSpot/BingoRoomRelocationAdapter.cs`

    ```csharp
    --8<-- "framework/languages/dotnet/samples/Bingo/Server/Play/Infrastructure/ZLink/Spots/BingoRoomSpot/BingoRoomRelocationAdapter.cs:doc-bingo-relocation-adapter"
    ```
...
=== "Java"
    ...
    `Server/Play/src/main/java/systems/zlink/samples/bingo/server/play/infrastructure/zlink/spots/bingoroomspot/BingoRoomRelocationAdapter.java`

    ```java
    --8<-- "framework/languages/java/samples/java/Bingo/Server/Play/src/main/java/systems/zlink/samples/bingo/server/play/infrastructure/zlink/spots/bingoroomspot/BingoRoomRelocationAdapter.java:doc-bingo-relocation-adapter"
    ```

=== "Kotlin"

    `Server/Play/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/play/infrastructure/zlink/spots/bingoroomspot/BingoRoomRelocationAdapter.kt`

    ```kotlin
    --8<-- "framework/languages/java/samples/kotlin/Bingo/Server/Play/src/main/kotlin/systems/zlink/samples/kotlin/bingo/server/play/infrastructure/zlink/spots/bingoroomspot/BingoRoomRelocationAdapter.kt:doc-bingo-relocation-adapter"
    ```
