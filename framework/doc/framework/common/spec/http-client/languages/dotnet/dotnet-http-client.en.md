...
package split; [01 Scope And Architecture §1.3](../../01-scope-and-architecture.en.md#13-relationship-with-framework--one-way-dependency) owns the common dependency direction.
