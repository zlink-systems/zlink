...
> [04 비동기 실행 정책 §1.1](../server/05-async-execution-policy.ko.md)이 소유한다. 아래
...
| 실행 방식 | 무엇을 기다리나 | [Spot](../server/01-glossary.ko.md#spot) 실행 줄 |
| --- | --- | --- |
...
([04 §2](../server/05-async-execution-policy.ko.md)).
