...
[Spec index](../README.en.md) · [Previous: Framework messaging glossary](01-glossary.en.md) · [Next: ZLink Framework interaction model](03-interaction-model.en.md)
...
the same `MeshName`. One [MeshNode](01-glossary.en.md#meshnode) has one
...
| [ChannelName](01-glossary.en.md#channelname) | A process-local logical address that selects a [RouteMesh](01-glossary.en.md#routemesh) or ClientServer send path |

One process can have multiple MeshNodes with different
[MeshName](01-glossary.en.md#meshname)s. Each mesh is independent and
...
- [Node direct](01-glossary.en.md#node-direct) designates one RID within the same MeshName.
...
- [Spot](01-glossary.en.md#spot) Logical Multicast targets the remote MeshNodes of a ChannelName and their node-local Spot subscriptions.
...
- Spot/Actor create and get-or-create are explicit manager operations. The Framework selects a target by object role, capacity, stable type, capacity, and node-wide weight, and returns an immutable ref after the [Ready](01-glossary.en.md#ready) barrier.
...
Spot [Logical Multicast](01-glossary.en.md#logical-multicast) delivers an
...
[subscriptions](01-glossary.en.md#subscription). When multiple Spots match
...
[Classic fanout](01-glossary.en.md#classic-fanout) is an independent
...
| [Owner](01-glossary.en.md#owner) | Responsibility |
|---|---|
| Node | RID direct and ChannelName handlers, node-initiated completions |
| Spot | Spot direct, Logical Multicast subscription, timers, and Spot state. An Instance Spot uses only direct and timer, not Actor [membership](01-glossary.en.md#membership) or Logical Multicast subscription |
...
Automatic discovery uses a [location store](01-glossary.en.md#location-store)'s
[descriptor](01-glossary.en.md#descriptor) and lease. RouteMesh looks up a
...
A [ClientServer Channel](01-glossary.en.md#clientserver-channel) is a
...
[12 ClientServer Channel](09-client-server-channel.en.md).
