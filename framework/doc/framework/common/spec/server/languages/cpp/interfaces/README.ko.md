...
[C++ 계약 목차](../README.ko.md) | [언어별 interface 목차](../../README.ko.md) | [이전: C++ 시스템 구조](../01-system-structure.ko.md) | [다음: C++ HTTP Hosting](../60-http-hosting.ko.md)
<!-- framework-adapter-nav:end -->
[C++ 계약 목차](../README.ko.md)

이 디렉토리는 ZLink Framework server의 C++ public interface를 기능별로 소유한다. 공통
...
| [Spots](04-spots.ko.md) | Global SpotId·SpotRef, relocation adapter와 callback, Instance Spot cold activation과 [User Spot](../../../00-foundation/02-glossary.ko.md#entry-spot-user-spot과-instance-spot) manager를 정의한다. |
| [Actors](05-actors.ko.md) | Global ActorId·ActorRef, relocation adapter, ID-only messaging, manager create와 mutation·bind를 정의한다. |
...
handle, claim, receive batch, reply token, service liveness command와 [authority](../../../00-foundation/02-glossary.ko.md#authority)/relocation 내부 transaction을
...
이 문서 집합에 선언한 Channel, [Spot](../../../00-foundation/02-glossary.ko.md#spot), Actor, STREAM, handler, builder, host, DI, maintenance와 state relocation
