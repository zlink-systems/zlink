...
[.NET 계약 목차](../README.ko.md) | [언어별 interface 목차](../../README.ko.md)
<!-- framework-adapter-nav:end -->
[.NET 계약 목차](../README.ko.md)

이 디렉토리는 ZLink Framework server의 C# public contract만 기능별로 소유한다. 공통
...
| [Spots](05-spots.ko.md) | Entry·User·Instance Spot lifecycle, relocation adapter, [Spot](../../../00-foundation/02-glossary.ko.md#spot) 전용 fluent call, [User Spot](../../../00-foundation/02-glossary.ko.md#entry-spot-user-spot과-instance-spot) manager와 timer를 정의한다. |
