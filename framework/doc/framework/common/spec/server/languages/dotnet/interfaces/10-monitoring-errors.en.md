...
[Common Framework API](../../../00-foundation/06-framework-api.en.md) ·
[Message Flow](../../../06-observability/03-message-flow-tracing.en.md)
...
[Message Flow](../../../06-observability/03-message-flow-tracing.en.md) and
