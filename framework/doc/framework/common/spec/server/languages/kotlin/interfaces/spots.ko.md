...
`preserveStateWith<SpotAdapter>()`를 사용하고 factory target과 adapter type은 socket bind
전에 검증한다.
...
Spot registry와 context의 등록은 [Kotlin 구성](configuration-host.ko.md)의 등록 규칙을 따른다.
