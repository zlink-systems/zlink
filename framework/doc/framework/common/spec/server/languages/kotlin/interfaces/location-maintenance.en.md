...
[Kotlin per-language interface list](README.en.md) ·
...
The query projection keeps the bounded page and Java result type. An
...
after commit. Spot direct lookup treats User Spot and Instance Spot under the same
