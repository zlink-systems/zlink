...
[authority](../../../00-foundation/02-glossary.en.md#authority) is not-found. If
...
[stable type](../../../00-foundation/02-glossary.en.md#stable-type) argument is
...
[owner](../../../00-foundation/02-glossary.en.md#owner). The wrapper keeps this
...
2. If authority is Missing and there's
 ...
 [Ready](../../../00-foundation/02-glossary.en.md#ready) CAS, and isn't
...
4. Only when there's no local Instance matching the requested SpotId
 ...
 reserved [snapshot](../../../00-foundation/02-glossary.en.md#snapshot) is
...
5. Only the target that wins the authority reservation race (CAS
 ...
 loser) doesn't start a [factory](../../../00-foundation/02-glossary.en.md#factory) —
