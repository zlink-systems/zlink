...
[인터페이스 목차](README.ko.md) · [Channel messaging](../../../02-channel-transport/02-channel-messaging.ko.md)
...
Channel 호출은 process-local [ChannelName](../../../00-foundation/02-glossary.ko.md#channelname) index만 사용한다. 호출자가 MeshName과 ChannelName을 함께 넘겨
...
public interface systems.zlink.framework.channels.ZLinkRequestCall {
 ...
 public abstract <TReply> TReply submit_sync(java.lang.Class<TReply>);   // blocking; runtime 문맥에서 InvalidOperation
...
public interface systems.zlink.framework.channels.ZLinkSendCall {
 ...
 public abstract java.util.concurrent.CompletionStage<java.lang.Void> submit();
 public abstract void submit_sync();   // blocking; runtime 문맥에서 InvalidOperation
}
