...
[Interface table of contents](README.en.md) · [Channel Messaging](../../../02-channel-transport/02-channel-messaging.en.md)
...
The framework public terminator does not expose backpressure (F1). Logical
...
[ChannelName](../../../00-foundation/02-glossary.en.md#channelname) index. An
...
public interface systems.zlink.framework.channels.ZLinkRequestCall {
 ...
 public abstract <TReply> TReply submit_sync(java.lang.Class<TReply>);   // blocking; InvalidOperation in a runtime context
...
public interface systems.zlink.framework.channels.ZLinkSendCall {
 ...
 public abstract java.util.concurrent.CompletionStage<java.lang.Void> submit();
 public abstract void submit_sync();   // blocking; InvalidOperation in a runtime context
}
