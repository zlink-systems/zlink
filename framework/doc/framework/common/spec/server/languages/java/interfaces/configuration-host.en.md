...
[Interface table of contents](README.en.md) · [Transport Liveness](../../../02-channel-transport/05-transport-liveness.en.md)
...
[Location Store](../../../00-foundation/02-glossary.en.md#location-store). The
Actor/User Spot/Instance Spot
[factory](../../../00-foundation/02-glossary.en.md#factory) must take a stable type
...
`relocationCoordinationMode`'s default is `FRAMEWORK_MANAGED`.
...
new UUID. [Common MeshNode §3.3](../../../03-spot-actor/03-mesh-node.en.md#33-fixed-rid) defines where a fixed RID can be used and how its restart conflicts are handled. Slot count, allocation group, and a public
...
[Spot](../../../00-foundation/02-glossary.en.md#spot) type and object capability
...
providers configured by the application. The diagnostics members of dispatch configuration only provide
