...
[Java contract table of contents](../README.en.md) | [Language interface table of contents](../../README.en.md)
<!-- framework-adapter-nav:end -->
[Java contract table of contents](../README.en.md)

This directory fixes the public signature of the Java server
...
- [Location Object Query Types](location-objects.en.md)
...
[authority](../../../00-foundation/02-glossary.en.md#authority), and mutation
and session bind take an `ActorRef` or `SpotRef`. A
[MeshNode](../../../00-foundation/02-glossary.en.md#meshnode)'s object role is
closed to `None`, `Client`, `Server`, and Client/Server require a
Location Store.

The type, constructor, method, record component, enum value, and
...
lifecycle adapters isn't included in the per-language public interface.
