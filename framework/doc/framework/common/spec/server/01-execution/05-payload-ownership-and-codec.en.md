...
for frequently used types already in the cache while bounding cache size.
...
The shared retained owner returns the Core lease exactly once after every child becomes
terminal and any required record-level reply attempt is terminal.
