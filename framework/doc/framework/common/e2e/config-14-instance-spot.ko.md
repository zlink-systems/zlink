...
- 계약 근거: [Spot 주소 메시징](../spec/server/03-spot-actor/06-spot-address-messaging.ko.md), [Location runtime](../spec/server/05-location-relocation/01-location-runtime.ko.md)
...
- 계약 근거: [비동기 실행 정책](../spec/server/01-execution/README.ko.md), [Spot messaging](../spec/server/03-spot-actor/02-spot-messaging.ko.md)
...
- 계약 근거: [Spot 주소 메시징](../spec/server/03-spot-actor/06-spot-address-messaging.ko.md)
...
- 계약 근거: [Spot messaging](../spec/server/03-spot-actor/02-spot-messaging.ko.md)
...
- 계약 근거: [Location runtime](../spec/server/05-location-relocation/01-location-runtime.ko.md)과
  [Failure와 failover](../spec/server/05-location-relocation/06-failure-failover-policy.ko.md)
...
- 계약 근거: [Location runtime](../spec/server/05-location-relocation/01-location-runtime.ko.md)과
  [Graceful drain과 handoff](../spec/server/05-location-relocation/05-host-relocation-flow.ko.md)
...
- 계약 근거: [Framework error model](../spec/server/00-foundation/07-framework-error-model.ko.md)
...
- 계약 근거: [비동기 실행 정책](../spec/server/01-execution/README.ko.md)
...
- 계약 근거: [Location runtime](../spec/server/05-location-relocation/01-location-runtime.ko.md), [Framework error model](../spec/server/00-foundation/07-framework-error-model.ko.md)
...
- 계약 근거: [Framework API의 RouteMesh activation admission](../spec/server/00-foundation/06-framework-api.ko.md#4-routemesh-등록)과
  [Object placement와 activation](../spec/server/01-execution/README.ko.md)
...
- 계약 근거: [Public contract governance](../spec/server/00-foundation/01-public-contract-governance.ko.md)
...
- 계약 근거: [Spot actor](../spec/server/03-spot-actor/05-spot-actor-membership.ko.md)
...
- 계약 근거: [Graceful drain — concurrent 호출과 cancellation](../spec/server/05-location-relocation/05-host-relocation-flow.ko.md#6-concurrent-호출과-cancellation)
