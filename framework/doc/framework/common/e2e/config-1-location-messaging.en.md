...
- Detailed behavior: verifies
  [RouteMesh Topology §6](../spec/server/02-channel-transport/01-channel-topology.en.md)
  and
...
- Detailed behavior: verifies the manual topology contract from
  [RouteMesh Topology §5.1](../spec/server/02-channel-transport/01-channel-topology.en.md#automatic-only-the-meshnode-with-the-smaller-rid-starts-the-connection)
  and
  [§6](../spec/server/02-channel-transport/01-channel-topology.en.md).
...
- Detailed behavior: verifies
  [RouteMesh Topology §4.2](../spec/server/02-channel-transport/01-channel-topology.en.md#4-when-a-call-can-start-without-a-local-server),
  [§5.1](../spec/server/02-channel-transport/01-channel-topology.en.md#automatic-only-the-meshnode-with-the-smaller-rid-starts-the-connection),
  and
  [Runtime Monitoring §2.2](../spec/server/06-observability/01-runtime-monitoring.en.md).
...
- Detailed behavior: verifies the MeshName isolation contract from
  [RouteMesh Topology §3](../spec/server/02-channel-transport/01-channel-topology.en.md#2-meshname-and-meshnode).
...
- Detailed behavior: verifies
  [Location Runtime](../spec/server/05-location-relocation/01-location-runtime.en.md) and
  [Spot Address Messaging](../spec/server/03-spot-actor/06-spot-address-messaging.en.md).
...
- Detailed behavior: verifies ready-target selection from
  [RouteMesh Topology §7](../spec/server/02-channel-transport/01-channel-topology.en.md#10-ready-state-and-channel-target-selection).
...
- Detailed behavior: verifies
  [MeshNode §8](../spec/server/03-spot-actor/03-mesh-node.en.md#8-drain-and-shutdown)
  and
  [Transport Liveness §7](../spec/server/02-channel-transport/05-transport-liveness.en.md#7-location-store-and-host-termination).
...
- Detailed behavior: verifies
  [Failure Response §3](../spec/server/05-location-relocation/06-failure-failover-policy.en.md#3-channel-target-and-connection-failure),
  [Transport Liveness §6](../spec/server/02-channel-transport/05-transport-liveness.en.md#6-connection-loss-and-reconnect),
  and
...
- Verification: The first request is recorded exactly once, only in
  ...
  handler.
- Detailed behavior: verifies
  [Channel Messaging §3.1](../spec/server/02-channel-transport/02-channel-messaging.en.md)
  and
  [Error Model §5](../spec/server/00-foundation/07-framework-error-model.en.md#5-request-completion-and-failure).
...
- Verification: The unknown request ends exactly once in `NotFound`,
  ...
  reply.
- Detailed behavior: verifies
  [Channel Messaging §5](../spec/server/02-channel-transport/02-channel-messaging.en.md),
  [Error Model §4](../spec/server/00-foundation/07-framework-error-model.en.md#4-send-completion-and-failure),
  and
  [Message Flow Tracing §3.1](../spec/server/06-observability/03-message-flow-tracing.en.md#31-closed-values-shared-by-every-language).
...
- Detailed behavior: verifies the SS boundary in
  [RouteMesh Topology §8](../spec/server/02-channel-transport/01-channel-topology.en.md#11-routemesh-ss-message-size-and-mailbox-ceiling),
  where Framework doesn't provide a message-size setting. The StreamNode
  ceiling is defined separately in
  [STREAM Session — internal recv loop and application surface](../spec/server/04-session/01-stream-session.en.md).
...
- Detailed behavior: verifies
  [Framework API §2.1](../spec/server/00-foundation/06-framework-api.en.md),
  [Runtime Monitoring §2.1](../spec/server/06-observability/01-runtime-monitoring.en.md),
  and
  [Error Model §4](../spec/server/00-foundation/07-framework-error-model.en.md#4-send-completion-and-failure).
