...
- 계약 근거: [Spot actor](../spec/server/03-spot-actor/05-spot-actor-membership.ko.md), [Spot messaging](../spec/server/03-spot-actor/02-spot-messaging.ko.md)
...
- 계약 근거: [Spot actor](../spec/server/03-spot-actor/05-spot-actor-membership.ko.md)와
  [Framework error model](../spec/server/00-foundation/07-framework-error-model.ko.md)
...
- 계약 근거: [Session Actor dispatch](../spec/server/04-session/02-session-actor-binding.ko.md)
...
- 검증: Compatible variant는 relocation 전용 capacity blocker 없이 Spot과 모든 Actor의 owner를 target으로
  ...
  검사하지 않는다.
- 계약 근거: [Framework API](../spec/server/00-foundation/06-framework-api.ko.md)와
  [Host relocation flow](../spec/server/05-location-relocation/05-host-relocation-flow.ko.md)
...
- 계약 근거: [SpotWide User Spot handoff](../spec/server/05-location-relocation/05-host-relocation-flow.ko.md#103-spotwide-user-spot)과
  [대기 중인 message 이전](../spec/server/05-location-relocation/05-host-relocation-flow.ko.md#12-대기-중인-message-timer와-session을-옮긴다)
...
- 계약 근거: [Runtime metrics](../spec/server/06-observability/02-runtime-metrics.ko.md)
...
- 계약 근거: [SpotWide User Spot handoff](../spec/server/05-location-relocation/05-host-relocation-flow.ko.md#103-spotwide-user-spot)
...
- 계약 근거: [비동기 실행 정책](../spec/server/01-execution/README.ko.md)과
  [Spot actor](../spec/server/03-spot-actor/05-spot-actor-membership.ko.md)
