...
- 계약 근거: [Spot actor](../spec/server/15-spot-actor.ko.md), [Spot messaging](../spec/server/12-spot-messaging.ko.md)
...
- 계약 근거: [Session Actor dispatch](../spec/server/20-session-actor-dispatch.ko.md)
...
- 검증: Compatible variant는 relocation 전용 capacity blocker 없이 Spot과 모든 Actor의 owner를 target으로
  ...
  검사하지 않는다.
- 계약 근거: [Framework API](../spec/server/06-framework-api.ko.md)와
  [Host relocation flow](../spec/server/30-host-relocation-flow.ko.md)
...
- 계약 근거: [SpotWide User Spot handoff](../spec/server/30-host-relocation-flow.ko.md#85-spotwide-user-spot)과
  [대기 중인 message 이전](../spec/server/30-host-relocation-flow.ko.md#9-대기-중인-message-timer와-session을-옮긴다)
...
- 계약 근거: [SpotWide User Spot handoff](../spec/server/30-host-relocation-flow.ko.md#85-spotwide-user-spot)
...
- 계약 근거: [비동기 실행 정책](../spec/server/05-async-execution-policy.ko.md)과
  [Spot actor](../spec/server/15-spot-actor.ko.md)
