...
- 세부 동작: [Actor model §5](../spec/server/03-spot-actor/04-actor-model.ko.md)와
  [Actor model §2.3](../spec/server/03-spot-actor/04-actor-model.ko.md),
  [Session Actor dispatch §4](../spec/server/04-session/02-session-actor-binding.ko.md)의 binding 독립성을 검증한다.
...
- 세부 동작: [Session Actor dispatch §2](../spec/server/04-session/02-session-actor-binding.ko.md)의
...
- 세부 동작: [Connection disconnect를 Actor에 알리는 방법](../spec/server/04-session/02-session-actor-binding.ko.md)과
  [Session의 Actor route 보관](../spec/server/04-session/02-session-actor-binding.ko.md)을 검증한다.
...
- 세부 동작: [오류 모델 §2](../spec/server/00-foundation/07-framework-error-model.ko.md)의 target 부재
  분류를 검증한다.
...
- 세부 동작: [Failover policy §4.1](../spec/server/05-location-relocation/06-failure-failover-policy.ko.md)의
...
- 세부 동작: [Failover policy §2](../spec/server/05-location-relocation/06-failure-failover-policy.ko.md)와
  [오류 모델 §4](../spec/server/00-foundation/07-framework-error-model.ko.md)의 route 실패를 검증한다.
