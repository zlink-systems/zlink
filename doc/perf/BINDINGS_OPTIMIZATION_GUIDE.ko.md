...
| Java | — | relay는 이미 `submit_sync()`(C 모델) | 미작성. 65536 B만 무너지는 **크기 의존형**: DD 53.7%, DR REQREP 10.9%·RR REQREP 11.2%(latency 14.5~15.6x; 64~4096 B는 52~59%로 평탄). PUBSUB 65536 B는 138%이므로 수신 경로가 아니라 **client 송신 쪽 64 KB 경로**(JNI 복사·direct buffer 재할당 후보) — Java pass 1의 첫 지도 대상 | PUBSUB 통과 93.2; DD 72.0·DR SS 78.7·DR REQREP 46.3·RR REQREP 47.6 미달(REQREP 둘 다 65536 B 10.9~11.2%, 64~4096 B 52~59%); RR SS 측정 중 |
