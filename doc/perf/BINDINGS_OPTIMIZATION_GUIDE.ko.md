...
| Rust | — | relay 결합(`fb3f37191d`) | 미작성. **4096 B만** latency가 초 단위(DR SS 2,226x·RR SS 1,154x; 64~1024 B는 0.6~1.8x, 65536 B 1.6~5x) → 크기 하나에 걸린 client 대기 구조 후보(위 교차 현상). 65536 B 처리량 21~38%도 별도 | PUBSUB 89.0(목표 95, 경계 아님)·DR SS 73.5·RR SS 63.8·DR REQREP 54.3 미달; DD·RR REQREP 측정 중 |
