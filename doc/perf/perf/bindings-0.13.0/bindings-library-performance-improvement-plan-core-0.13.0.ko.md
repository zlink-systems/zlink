...
| `tcp` | `DEALER_DEALER` | 보류(77.39%) | 보류(98.24%) | 보류(95.90%) | 보류(70.89%) | 보류(81.95%) | 보류(85.40%) | aggregate throughput 84.96%, latency 1.126x; 자체 public-path no-go; `cpp-dealer-dealer-tcp-core0130-before-{c,cpp}-20260825`; [log](log/2026-08-25-cpp-dealer-dealer-tcp.md) |
| `tcp` | `DEALER_ROUTER` | 통과(83.45%) | 통과(102.55%) | 통과(101.24%) | 통과(78.20%; 개별 최소 미달) | 통과(82.54%) | 통과(91.71%) | routed one-way 목표 85%; aggregate throughput 89.95%, latency 1.080x; `cpp-dealer-router-tcp-core0130-final5-{c,cpp}-20260825`; [log](log/2026-08-25-cpp-dealer-router-tcp.md) |
| `tcp` | `DEALER_ROUTER_REQREP` | 보류(57.70%) | 보류(55.65%) | 보류(34.61%) | 보류(69.12%) | 보류(83.44%) | 보류(83.99%) | request/reply 목표 85%; aggregate throughput 64.09%, latency 1.789x; public completion path no-go; `cpp-dealer-router-reqrep-tcp-core0130-before-{c,cpp}-20260825`; [log](log/2026-08-25-cpp-dealer-router-reqrep-tcp.md) |
...
| `wss` | `PUBSUB` | 통과(86.48%) | 통과(89.33%) | 통과(89.35%) | 통과(89.08%) | 통과(99.83%) | 통과(95.33%) | 완화 목표 90% 선택; aggregate throughput 91.57%, latency 1.156x; `cpp-pubsub-wss-core0130-final5-{c,cpp}-20260825`; [log](log/2026-08-25-cpp-pubsub-wss.md) |
| `wss` | `DEALER_DEALER` | 통과(110.87%) | 통과(101.77%) | 통과(109.02%) | 통과(106.30%) | 통과(112.03%) | 통과(103.34%) | 기본 목표 95%; aggregate throughput 107.22%, latency 0.925x; `cpp-dealer-dealer-wss-core0130-final5-{c,cpp}-20260825`; [log](log/2026-08-25-cpp-dealer-dealer-wss.md) |
| `wss` | `DEALER_ROUTER` | 통과(96.28%) | 통과(98.39%) | 통과(97.69%) | 통과(97.25%) | 통과(88.92%) | 통과(94.17%) | routed one-way 목표 85%; aggregate throughput 95.45%, latency 1.083x; `cpp-dealer-router-wss-core0130-final5-{c,cpp}-20260825`; [log](log/2026-08-25-cpp-dealer-router-wss.md) |
| `wss` | `DEALER_ROUTER_REQREP` | 보류(40.01%) | 보류(36.34%) | 보류(37.74%) | 보류(94.40%) | 보류(89.15%) | 보류(89.56%) | request/reply 목표 85%; aggregate throughput 64.37%, latency 1.954x; secure final5; [log](log/2026-08-25-cpp-dealer-router-reqrep-wss.md) |
| `wss` | `ROUTER_ROUTER` | 미측정 | 미측정 | 미측정 | 미측정 | 미측정 | 미측정 |  |
| `wss` | `ROUTER_ROUTER_REQREP` | 미측정 | 미측정 | 미측정 | 미측정 | 미측정 | 미측정 |  |
| `tls` | `PAIR` | 보류(83.71%) | 보류(85.09%) | 보류(85.41%) | 보류(92.56%) | 보류(86.62%) | 보류(78.38%) | aggregate throughput 85.29%, latency 1.008x; 자체/Sol no-go; `cpp-pair-tls-core0130-final5-{c,cpp}-20260825`; [log](log/2026-08-25-cpp-pair-tls.md) |
...
| 2026-08-25 | C++ | Single `PAIR / wss` | `cpp-pair-wss-core0130-final5-{c,cpp}-20260825` | 6 sizes, 5초, 5회 중앙값, Core 0.13.0 release, 자체/Sol pass 완료 | 완화 목표 90% 선택; 처리량 평균 93.85%, latency 1.103x로 통과 | C: `bindings/c/perf/results/single/report/perf_c_single_linux_20260825_093700_cpp-pair-wss-core0130-final5-c-20260825.txt`; C++: `bindings/cpp/perf/results/single/report/perf_cpp_single_linux_20260825_093945_cpp-pair-wss-core0130-final5-cpp-20260825.txt`; [log](log/2026-08-25-cpp-pair-wss.md) |
| 2026-08-25 | C++ | Single `PAIR / tls` | `cpp-pair-tls-core0130-final5-{c,cpp}-20260825` | 6 sizes, 5초, 5회 중앙값, Core 0.13.0 release, 자체/Sol pass와 contract regression gate 완료 | 처리량 평균 85.29%로 보류, latency 1.008x 통과 | C: `bindings/c/perf/results/single/report/perf_c_single_linux_20260825_095114_cpp-pair-tls-core0130-final5-c-20260825.txt`; C++: `bindings/cpp/perf/results/single/report/perf_cpp_single_linux_20260825_095401_cpp-pair-tls-core0130-final5-cpp-20260825.txt`; [log](log/2026-08-25-cpp-pair-tls.md) |
| 2026-08-25 | C++ | Single `PAIR / inproc` | `cpp-pair-inproc-core0130-before-{c,cpp}-20260825` | 6 sizes, 5초, 3회 중앙값, Core 0.13.0 release, 자체/Sol pass와 dead-pool cleanup A/B 완료 | 처리량 평균 72.51%로 보류, latency 1.485x 통과; cleanup은 회귀 gate로 기각 | C: `bindings/c/perf/results/single/report/perf_c_single_linux_20260825_100014_cpp-pair-inproc-core0130-before-c-20260825.txt`; C++: `bindings/cpp/perf/results/single/report/perf_cpp_single_linux_20260825_100200_cpp-pair-inproc-core0130-before-cpp-20260825.txt`; [log](log/2026-08-25-cpp-pair-inproc.md) |
| 2026-08-25 | C++ | Single `PAIR / ipc` | `cpp-pair-ipc-core0130-final5-{c,cpp}-20260825` | 6 sizes, 5초, 경계 셀 규칙에 따른 5회 중앙값, Core 0.13.0 release, 자체/Sol pass 완료 | 처리량 평균 84.77%로 보류, latency 1.167x 통과 | C: `bindings/c/perf/results/single/report/perf_c_single_linux_20260825_102314_cpp-pair-ipc-core0130-final5-c-20260825.txt`; C++: `bindings/cpp/perf/results/single/report/perf_cpp_single_linux_20260825_102619_cpp-pair-ipc-core0130-final5-cpp-20260825.txt`; [log](log/2026-08-25-cpp-pair-ipc.md) |
...
| 2026-08-25 | C++ | Single `PUBSUB / ipc` | `cpp-pubsub-ipc-core0130-final5-{c,cpp}-20260825` | 6 sizes, 5초, 목표 경계 규칙에 따른 5회 중앙값, Core 0.13.0 release, 자체/Sol pass 완료 | 기본 목표 95%; 처리량 평균 95.60%, latency 1.025x로 통과 | C: `bindings/c/perf/results/single/report/perf_c_single_linux_20260825_112404_cpp-pubsub-ipc-core0130-final5-c-20260825.txt`; C++: `bindings/cpp/perf/results/single/report/perf_cpp_single_linux_20260825_112715_cpp-pubsub-ipc-core0130-final5-cpp-20260825.txt`; [log](log/2026-08-25-cpp-pubsub-ipc.md) |
| 2026-08-25 | C++ | Single `DEALER_DEALER / tcp` | `cpp-dealer-dealer-tcp-core0130-before-{c,cpp}-20260825` | 6 sizes, 5초, 3회 중앙값, Core 0.13.0 release, 공개 경로 자체 pass 완료 | 처리량 평균 84.96%로 보류, latency 1.126x 통과; terminal ownership/close/serialization 계약을 유지하는 후보 없음 | C: `bindings/c/perf/results/single/report/perf_c_single_linux_20260825_113312_cpp-dealer-dealer-tcp-core0130-before-c-20260825.txt`; C++: `bindings/cpp/perf/results/single/report/perf_cpp_single_linux_20260825_113312_cpp-dealer-dealer-tcp-core0130-before-cpp-20260825.txt`; [log](log/2026-08-25-cpp-dealer-dealer-tcp.md) |
| 2026-08-25 | C++ | Single `DEALER_DEALER / ws` | `cpp-dealer-dealer-ws-core0130-final5-{c,cpp}-20260825` | 6 sizes, 5초, 목표 경계 규칙에 따른 C→C++ 5회 중앙값, Core 0.13.0 release, 공개 경로 자체 pass 완료 | 완화 목표 90% 선택; 처리량 평균 93.80%, latency 1.024x로 통과 | C: `bindings/c/perf/results/single/report/perf_c_single_linux_20260825_114053_cpp-dealer-dealer-ws-core0130-final5-c-20260825.txt`; C++: `bindings/cpp/perf/results/single/report/perf_cpp_single_linux_20260825_114334_cpp-dealer-dealer-ws-core0130-final5-cpp-20260825.txt`; [log](log/2026-08-25-cpp-dealer-dealer-ws.md) |
| 2026-08-25 | C++ | Single `DEALER_DEALER / wss` | `cpp-dealer-dealer-wss-core0130-final5-{c,cpp}-20260825` | 6 sizes, 5초, secure transport 규칙에 따른 C→C++ 5회 중앙값, Core 0.13.0 release | 기본 목표 95%; 처리량 평균 107.22%, latency 0.925x로 통과 | C: `bindings/c/perf/results/single/report/perf_c_single_linux_20260825_114948_cpp-dealer-dealer-wss-core0130-final5-c-20260825.txt`; C++: `bindings/cpp/perf/results/single/report/perf_cpp_single_linux_20260825_115227_cpp-dealer-dealer-wss-core0130-final5-cpp-20260825.txt`; [log](log/2026-08-25-cpp-dealer-dealer-wss.md) |
| 2026-08-25 | C++ | Single `DEALER_DEALER / tls` | `cpp-dealer-dealer-tls-core0130-final5-{c,cpp}-20260825` | 6 sizes, 5초, secure transport 규칙에 따른 C→C++ 5회 중앙값, Core 0.13.0 release, 공개 경로 자체 pass 완료 | 처리량 평균 86.06%로 보류, latency 1.043x 통과; Core TLS 분기 외 채택 후보 없음 | C: `bindings/c/perf/results/single/report/perf_c_single_linux_20260825_115834_cpp-dealer-dealer-tls-core0130-final5-c-20260825.txt`; C++: `bindings/cpp/perf/results/single/report/perf_cpp_single_linux_20260825_120113_cpp-dealer-dealer-tls-core0130-final5-cpp-20260825.txt`; [log](log/2026-08-25-cpp-dealer-dealer-tls.md) |
...
| 2026-08-25 | C++ | Single `DEALER_ROUTER / wss` | `cpp-dealer-router-wss-core0130-final5-{c,cpp}-20260825` | 6 sizes, 5초, secure transport 규칙에 따른 C→C++ 5회 중앙값, Core 0.13.0 release, 공개 경로 자체 pass 완료 | routed one-way 목표 85%; 처리량 평균 95.45%, latency 1.083x로 통과 | C: `bindings/c/perf/results/single/report/perf_c_single_linux_20260825_122817_cpp-dealer-router-wss-core0130-final5-c-20260825.txt`; C++: `bindings/cpp/perf/results/single/report/perf_cpp_single_linux_20260825_123055_cpp-dealer-router-wss-core0130-final5-cpp-20260825.txt`; [log](log/2026-08-25-cpp-dealer-router-wss.md) |
| 2026-08-25 | C++ | Single `DEALER_ROUTER / tls` | `cpp-dealer-router-tls-core0130-final5-{c,cpp}-20260825` | 6 sizes, 5초, secure transport 규칙에 따른 C→C++ 5회 중앙값, Core 0.13.0 release, 공개 경로 자체 pass 완료 | routed one-way 목표 85%; 처리량 평균 89.56%, latency 0.992x로 통과 | C: `bindings/c/perf/results/single/report/perf_c_single_linux_20260825_123528_cpp-dealer-router-tls-core0130-final5-c-20260825.txt`; C++: `bindings/cpp/perf/results/single/report/perf_cpp_single_linux_20260825_123806_cpp-dealer-router-tls-core0130-final5-cpp-20260825.txt`; [log](log/2026-08-25-cpp-dealer-router-tls.md) |
| 2026-08-25 | C++ | Single `DEALER_ROUTER / inproc` | `cpp-dealer-router-inproc-core0130-before-{c,cpp}-20260825` | 6 sizes, 5초, 3회 중앙값, Core 0.13.0 release, 공개 경로 자체 pass 완료 | 처리량 평균 65.82%로 보류, latency 1.886x 통과; 64/128KiB cliff는 Core/native 별도 진단 | C: `bindings/c/perf/results/single/report/perf_c_single_linux_20260825_124230_cpp-dealer-router-inproc-core0130-before-c-20260825.txt`; C++: `bindings/cpp/perf/results/single/report/perf_cpp_single_linux_20260825_124407_cpp-dealer-router-inproc-core0130-before-cpp-20260825.txt`; [log](log/2026-08-25-cpp-dealer-router-inproc.md) |
