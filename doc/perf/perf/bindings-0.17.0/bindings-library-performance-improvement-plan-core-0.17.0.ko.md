...
| `tcp` | `MULTI_DEALER_ROUTER_SENDSEND` | 통과(79.5%) | 통과(85.4%) | 통과(74.2%) | 통과(64.0%) | 통과(59.5%) | 미측정 | **`통과(72.50%)`** — 1-run(D-BP32), 고정 Core **0.17.2**(`r12java`, C `complete`·java `complete`); latency 853.94x **latency 853.94x > 3.0x**. relay 수정(611b022b37) 뒤 같은 조건 재측정(이전 r3java 1-run 78.7%). 처리량 java·C 372.4/468.7, 374.5/438.7, 334.4/450.7, 248.3/388.2, 46.2/77.7 Kops/s; C `perf_c_multi_linux_20260908_122408_r12java.txt`, java `perf_java_multi_linux_20260908_122435_r12java.txt` |
