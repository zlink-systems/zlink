...
| `tcp` | `MULTI_PUBSUB` | 통과(89.2%) | 통과(89.2%) | 통과(89.1%) | 통과(88.6%) | 통과(100.6%) | 미측정 | **`미달(91.33%)`** — 1-run(D-BP32), 고정 Core **0.17.3**(`m173b`, C `complete`·rust `complete`); latency 1.00x. 조용한 창 재측정(m173b; 동시 빌드에 오염된 m173 값 폐기). 목표 95% ±5%p 경계 → §7.2 3-run(m173b3) 예정. 처리량 rust·C 1,967.1/2,205.7, 2,084.9/2,338.1, 2,114.4/2,373.5, 1,440.2/1,625.1, 110.9/110.2 Kops/s; C `perf_c_multi_linux_20260908_170416_m173b.txt`, rust `perf_rust_multi_linux_20260908_171507_m173b.txt` |
