...
| `tcp` | `MULTI_DEALER_ROUTER_REQREP` | 통과(52.5%) | 통과(54.7%) | 통과(54.6%) | 통과(58.6%) | 미달(10.9%) | 미측정 | **`미달(46.28%)`** — 1-run(D-BP32), 고정 Core **0.17.2**(`r3java`, C `complete`·java `complete`); latency 3.83x **latency 3.83x > 3.0x**. relay 정합 뒤 첫 유효 측정. 처리량 java·C 205.7/391.6, 200.4/366.1, 191.5/350.4, 185.6/316.8, 6.4/58.5 Kops/s; C `perf_c_multi_linux_20260908_113555_r3java.txt`, java `perf_java_multi_linux_20260908_113830_r3java.txt` |
