...
| `tcp` | `DEALER_ROUTER_REQREP` | 미측정 | 1.7% | 2.0% | 90.8% | 93.4% | 93.5% | **참고 56.3%**(D-BP2: Single은 판정 대상 아님) — 1-run, 고정 Core 0.17.2(`sg1`, C `partial`·cpp `complete`); latency 0.36x. Core 0.17.3-alpha prefix, C·C++ 같은 시각 짝지음(D-BP39). 처리량 cpp·C 14.3/834.1, 14.6/740.4, 10.4/11.4, 8.6/9.2, 6.8/7.3 Kops/s; C `perf_c_single_linux_20260908_130119_sg1.txt`, cpp `perf_cpp_single_linux_20260908_131617_sg1.txt` |
...
| `tcp` | `ROUTER_ROUTER_REQREP` | 1.7% | 1.7% | 2.0% | 93.4% | 94.9% | 90.8% | **참고 47.4%**(D-BP2: Single은 판정 대상 아님) — 1-run, 고정 Core 0.17.2(`sg1`, C `partial`·cpp `complete`); latency 0.41x. Core 0.17.3-alpha prefix, C·C++ 같은 시각 짝지음(D-BP39). 처리량 cpp·C 14.6/881.8, 14.0/837.2, 14.6/724.5, 10.5/11.3, 8.7/9.2, 6.4/7.0 Kops/s; C `perf_c_single_linux_20260908_130119_sg1.txt`, cpp `perf_cpp_single_linux_20260908_131617_sg1.txt` |
