...
| `tcp` | `MULTI_DEALER_ROUTER_SENDSEND` | 미달(85.8%) | 미달(88.1%) | 미달(83.3%) | 미달(70.3%) | 미달(66.1%) | 미측정 | **`미달(78.72%)`** — §7.2 5-run, 고정 Core **0.17.2**(`r3java`, C·Java 모두 `status: complete`); latency 432.256x. Java relay는 `submit_sync()`로 이미 C 모델(D-BP24 대상 아님). 0.17.1 참고값 없음(routed 미측정). 처리량 Java·C 412.0/480.2, 385.7/437.6, 362.5/435.4, 274.4/390.5, 49.2/74.4 Kmsg/s; C `perf_c_multi_linux_20260908_100243_r3java.txt`, Java `perf_java_multi_linux_20260908_102147_r3java.txt` |
