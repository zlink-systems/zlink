...
| 6c | 잔여 정합 — `reqrep_max_outstanding` 8개 러너 노출, .NET `completed` anchor 위치, one-way 5건(active deadline 필터·wire 길이 검증·1 ms transient 재시도·RESULT 정밀도·latency 표본 0개) 7개 binding 이식, anchor 6종 대조표 | 진행 중(D-BP13) |
