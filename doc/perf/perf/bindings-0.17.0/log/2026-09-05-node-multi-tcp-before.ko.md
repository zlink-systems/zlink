...
## quiet paired 3-run(4 pattern) — Core `a40cb46335` + pass 1c(`8ec82c4be7`), 21:54~22:10 KST (`p1node-r3q2`)

| pattern | 64 | 256 | 1024 | 4096 | 65536 | aggregate | latency | 상태(목표) |
|---|---|---|---|---|---|---|---|---|
| `MULTI_DEALER_DEALER` | 25.2% (250.0/991.7) | 24.3% (226.8/933.9) | 24.3% (210.6/866.7) | 40.3% (132.8/330.0) | 65.3% (37.4/57.2) | **35.9%** | 큐 | `미달`(60, 최소 35 충족) — before 27.6 |
| `MULTI_DEALER_ROUTER_REQREP` | 9.2% (19.3/210.5) | 15.1% (26.4/174.4) | 10.3% (17.6/171.5) | 18.7% (24.7/132.1) | 68.0% (15.5/22.8) | **24.3%** | 52x | `미달`(60) — before 18.7 |
| `MULTI_ROUTER_ROUTER_REQREP` | 11.3% (20.3/179.5) | 14.3% (20.5/144.1) | 15.1% (19.9/131.9) | 22.7% (26.4/116.2) | 60.8% (13.2/21.7) | **24.8%** | 55x | `미달`(60) — before 17.9 |
| `MULTI_PUBSUB` | 22.2% (150.3/677.5) | 21.7% (162.5/749.1) | 20.6% (172.4/836.4) | 21.4% (140.5/655.0) | 65.0% (40.7/62.7) | **30.2%** | 0.72x | `미달`(60) — before 28.6 |

REQREP는 작은 크기에서 ~50 ms 고정 지연·timeout이 그대로(64 KiB는 Core 수정으로 회복). 요청 수명 계측(D-B114)상 서버 수신 backlog 128 ms → 서버 측 경로 정리(1c) 뒤에도 남는 원인은 client completion 대기 구조 — Node pass 1d(제어점 단일화) 필요.
