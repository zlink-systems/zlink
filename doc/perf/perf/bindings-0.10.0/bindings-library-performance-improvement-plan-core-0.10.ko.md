...
|------|------|------------------|
| 현재 언어 | .NET |  |
| 현재 pattern | 완료·통과 | `ROUTER_ROUTER_REQREP / ipc` throughput ratio는 51.040%/57.706%/54.210%/96.299%/100.286%/97.124%, 산술평균 76.111%이며 평균 latency ratio는 1.733x/1.491x/1.375x/1.024x/0.985x/1.015x, 산술평균 1.271x다. request/reply aggregate 기준을 충족해 통과하고 다음 대상은 아직 미측정인 `Single ROUTER_ROUTER / inproc`이다. |
| paired C | 완료 | C throughput은 256353/226815/231747/21861/14709/9040 Kops/s, 평균 latency는 0.150/0.173/0.192/0.544/0.404/0.328 ms다. report는 `/home/hep7hep7/project/zlink/bindings/c/perf/results/single/report/perf_c_single_linux_20260810_172657_dotnet-router-router-reqrep-ipc-paired-c1.txt`다. |
| binding paired 결과 | 완료·통과 | .NET throughput은 130843/130885/125631/21052/14751/8780 Kops/s, 평균 latency는 0.260/0.258/0.264/0.557/0.398/0.333 ms다. C 대비 throughput 산술평균은 76.111%, 평균 latency ratio는 1.271x다. report는 `/home/hep7hep7/project/zlink/bindings/dotnet/perf/results/single/report/perf_dotnet_single_linux_20260810_172710_dotnet-router-router-reqrep-ipc-paired-before.txt`다. |
| 개선 결과 | 통과·추가 변경 없음 | aggregate throughput과 latency가 request/reply 기준을 충족했다. 현재 적용된 single-part 내부 경로와 public contract를 유지하며, 이 대상에는 별도 hotpath 또는 POSDDD 구조 변경을 추가하지 않는다. |
...
| 2 | .NET | 완료·통과 23 / 보류 12 | 미측정 | 다음 대상은 아직 미측정인 `Single ROUTER_ROUTER / inproc`; C → .NET 순서로 한 대상씩 측정 |
