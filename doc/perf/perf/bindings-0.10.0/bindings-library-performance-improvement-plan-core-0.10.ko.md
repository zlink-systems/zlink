...
|------|------|------------------|
| 현재 언어 | .NET |  |
| 현재 pattern | 완료·통과 | `ROUTER_ROUTER / ipc` throughput ratio는 60.032%/71.008%/78.735%/91.036%/90.126%/90.287%, 산술평균 80.204%이며 평균 latency ratio는 1.078x다. 개별 최소 기준 미달 셀은 결과로 기록하고 aggregate 기준으로 통과한다. 다음 대상은 아직 미측정인 `Single PAIR / ipc`다. |
| paired C | 완료 | C throughput은 2224080/1323355/833920/41366/27163/16195 Kops/s, 평균 latency는 0.100/0.514/0.286/4.936/7.610/12.882 ms다. report는 `/home/hep7hep7/project/zlink/bindings/c/perf/results/single/report/perf_c_single_linux_20260810_175017_dotnet-router-router-ipc-paired-c1.txt`다. |
| binding paired 결과 | 완료·통과 | .NET throughput은 1335168/939693/656589/37658/24481/14622 Kops/s, 평균 latency는 0.156/0.298/0.299/5.395/8.357/14.039 ms다. throughput ratio 산술평균은 80.204%, 평균 latency ratio는 1.078x다. report는 `/home/hep7hep7/project/zlink/bindings/dotnet/perf/results/single/report/perf_dotnet_single_linux_20260810_175032_dotnet-router-router-ipc-paired-before.txt`다. |
...
| 2 | .NET | 완료·통과 24 / 보류 13 | 미측정 | 다음 대상은 아직 미측정인 `Single PAIR / ipc`; C → .NET 순서로 한 대상씩 측정 |
