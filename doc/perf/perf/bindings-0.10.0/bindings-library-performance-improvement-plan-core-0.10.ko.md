...
|------|------|------------------|
| 현재 언어 | .NET |  |
| 현재 pattern | 완료·통과 | `PAIR / inproc`의 최종 before throughput ratio는 62.037%/63.274%/60.016%/22.223%/84.666%/74.587%, 산술평균 61.134%이며 평균 latency ratio는 2.937x다. .NET inproc 단순 one-way aggregate 기준을 충족해 통과하고 다음 대상은 `Single PUBSUB / inproc`이다. |
| paired C | 완료 | C throughput은 2737466/1860478/1980629/475404/181373/85715 Kmsg/s, 평균 latency는 0.013/0.166/0.172/0.006/0.012/0.019 ms다. report는 `perf_c_single_linux_20260810_164153_dotnet-pair-inproc-paired-c1.txt`다. |
| binding paired 결과 | 완료·통과 | .NET before throughput은 1698244/1177207/1188690/105648/153561/63932 Kmsg/s, 평균 latency는 0.103/0.210/0.232/0.026/0.016/0.027 ms다. throughput ratio 산술평균은 61.134%, latency ratio 산술평균은 2.937x다. |
| 개선 결과 | 통과·자체 후보 제거 후 Sol no-go | Epoch nanosecond fast path 후보 후 throughput aggregate는 61.134%에서 52.871%로 악화되어 제거했다. Sol high 리뷰에서 public Message snapshot copy·public builder 재사용·private direct-send는 ownership·builder 독립성 contract 위험으로 no-go 판정했다. 최종 before 측정값으로 통과 처리한다. |
...
| 2 | .NET | 완료·통과 19 / 보류 10 | 미측정 | 다음 대상은 `Single PUBSUB / inproc`; C → .NET 순서로 한 대상씩 측정 |
