...
| Java | `MULTI_DEALER_DEALER` | tcp | 67.56 / 83.33 / 81.92 / 74.75 / 84.15 / 96.18% | 81.32% | 90% | 미달 |
| Java | `MULTI_DEALER_ROUTER_REQREP` | tcp | 68.20 / 62.14 / 49.81 / 53.55 / 101.99 / 107.66% | 73.89% | 50% | 통과 |
| Java | `MULTI_DEALER_ROUTER_SENDSEND` | tcp | 76.71 / 60.33 / 61.58 / 60.66 / 105.08 / 96.73% | 76.85% | 70% | 통과 |
