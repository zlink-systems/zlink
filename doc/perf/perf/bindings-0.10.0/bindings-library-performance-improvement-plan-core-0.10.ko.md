...
| C++ | `MULTI_DEALER_ROUTER_REQREP` | tls | 92.48 / 194.09 / 95.98 / 24.27 / 91.51 / 96.35% | 99.11% | 75% / 85% | 중앙값 통과 |
| C++ | `MULTI_DEALER_ROUTER_REQREP` | ws | 91.63 / 95.82 / 104.52 / 96.97 / 97.28 / 261.10% | 124.55% | 75% / 85% | 중앙값 통과 |
| C++ | `MULTI_DEALER_ROUTER_REQREP` | wss | 96.73 / 92.18 / 90.55 / 94.56 / 96.61 / 98.49% | 94.85% | 75% / 85% | 중앙값 통과 |
| C++ | `MULTI_ROUTER_ROUTER_SENDSEND` | tcp | 101.23 / 98.71 / 101.15 / 104.87 / 98.59 / 99.16% | 100.62% | 80% / 85% | 중앙값 통과 |
| C++ | `MULTI_ROUTER_ROUTER_SENDSEND` | tls | 101.60 / 106.66 / 101.53 / 101.65 / 100.70 / 106.75% | 103.15% | 80% / 85% | 중앙값 통과 |
| C++ | `MULTI_ROUTER_ROUTER_SENDSEND` | ws | 99.71 / 98.04 / 100.63 / 96.58 / 103.23 / 91.92% | 98.35% | 80% / 85% | 중앙값 통과 |
| C++ | `MULTI_ROUTER_ROUTER_SENDSEND` | wss | 104.32 / 104.30 / 111.14 / 107.60 / 103.47 / 107.54% | 106.39% | 80% / 85% | 중앙값 통과 |
| C++ | `MULTI_ROUTER_ROUTER_REQREP` | tcp | 94.88 / 88.96 / 98.76 / 95.35 / 99.90 / 100.49% | 96.39% | 75% / 85% | 중앙값 통과 |
| C++ | `MULTI_ROUTER_ROUTER_REQREP` | tls | 91.47 / 89.59 / 87.74 / 93.83 / 96.38 / 105.16% | 94.03% | 75% / 85% | 중앙값 통과 |
| C++ | `MULTI_ROUTER_ROUTER_REQREP` | ws | 94.81 / 28.74 / 93.76 / 91.81 / 104.79 / 96.37% | 85.05% | 75% / 85% | 중앙값 통과 |
| C++ | `MULTI_ROUTER_ROUTER_REQREP` | wss | 92.18 / 94.71 / 93.71 / 96.11 / 95.10 / 97.71% | 94.92% | 75% / 85% | 중앙값 통과 |
| C++ | `MULTI_PUBSUB` | tcp | 106.66 / 91.72 / 100.34 / 82.24 / 93.89 / 91.80% | 94.49% | 85% / 90% | 중앙값 통과 |
| C++ | `MULTI_PUBSUB` | tls | 95.67 / 90.10 / 91.47 / 94.82 / 98.72 / 93.24% | 94.00% | 85% / 90% | 중앙값 통과 |
| C++ | `MULTI_PUBSUB` | ws | 98.00 / 96.52 / 100.45 / 96.64 / 104.91 / 107.77% | 100.72% | 85% / 90% | 중앙값 통과 |
| C++ | `MULTI_PUBSUB` | wss | 91.83 / 85.17 / 81.72 / 92.96 / 99.66 / 100.59% | 91.99% | 85% / 90% | 중앙값 통과 |
| C++ | `MULTI_STREAM` | tcp | 99.50 / 99.83 / 96.60 / 99.53% | 98.85% | 80% / 85% | 중앙값 통과 |
| C++ | `MULTI_STREAM` | tls | 100.66 / 97.56 / 97.86 / 98.46% | 98.63% | 80% / 85% | 중앙값 통과 |
| C++ | `MULTI_STREAM` | ws | 94.93 / 96.66 / 95.77 / 97.80% | 96.29% | 80% / 85% | 중앙값 통과 |
| C++ | `MULTI_STREAM` | wss | 98.96 / 98.56 / 98.11 / 100.42% | 99.01% | 80% / 85% | 중앙값 통과 |
| .NET | 전체 | 전체 | 재측정 대기 | - | - | 진행 중 |
| .NET | `MULTI_DEALER_DEALER` | tcp | 33.59 / 58.56 / 148.39 / 78.57 / 137.74 / 91.77% | 91.44% | 64% / 85% | 중앙값 통과 |
| .NET | `MULTI_DEALER_DEALER` | tls | 33.54 / 58.39 / 89.03 / 91.63 / 89.80 / 99.15% | 76.92% | 64% / 85% | 최소 통과, 중앙값 미달 |
| .NET | `MULTI_DEALER_DEALER` | ws | 36.70 / 64.50 / 86.90 / 88.92 / 105.02 / 126.21% | 84.71% | 64% / 85% | 최소 통과, 중앙값 미달 |
| .NET | `MULTI_DEALER_DEALER` | wss | 34.89 / 55.51 / 84.56 / 97.48 / 106.45 / 101.90% | 80.13% | 64% / 85% | 최소 통과, 중앙값 미달 |
| .NET | `MULTI_PUBSUB` | tcp | 63.80 / 67.83 / 58.64 / 82.80 / 106.24 / 112.02% | 81.89% | 64% / 85% | 최소 통과, 중앙값 미달 |
| .NET | `MULTI_PUBSUB` | tls | 67.04 / 67.25 / 84.47 / 93.29 / 96.11 / 98.17% | 84.39% | 64% / 85% | 최소 통과, 중앙값 미달 |
| .NET | `MULTI_PUBSUB` | ws | 72.92 / 71.01 / 73.54 / 87.32 / 94.71 / 92.90% | 82.07% | 64% / 85% | 최소 통과, 중앙값 미달 |
| .NET | `MULTI_PUBSUB` | wss | 72.71 / 73.06 / 76.12 / 125.01 / 106.48 / 126.13% | 96.58% | 64% / 85% | 중앙값 통과 |
| .NET | `MULTI_DEALER_ROUTER_SENDSEND` | tcp | 87.15 / 89.27 / 90.84 / 98.80 / 136.43 / 144.74% | 107.87% | 75% / 80% | 중앙값 통과 |
| .NET | `MULTI_DEALER_ROUTER_SENDSEND` | tls | 86.91 / 90.25 / 87.24 / 99.34 / 122.42 / 117.82% | 100.67% | 75% / 80% | 중앙값 통과 |
| .NET | `MULTI_DEALER_ROUTER_SENDSEND` | ws | 86.11 / 85.48 / 85.89 / 90.58 / 106.83 / 107.15% | 93.67% | 75% / 80% | 중앙값 통과 |
| .NET | `MULTI_DEALER_ROUTER_SENDSEND` | wss | 85.95 / 87.52 / 90.24 / 94.33 / 106.55 / 104.70% | 94.88% | 75% / 80% | 중앙값 통과 |
| .NET | `MULTI_DEALER_ROUTER_REQREP` | tcp | 66.64 / 61.97 / 73.83 / 82.80 / 128.78 / 121.84% | 89.31% | 50% / 70% | 중앙값 통과 |
| .NET | `MULTI_DEALER_ROUTER_REQREP` | tls | 66.04 / 63.91 / 79.80 / 73.77 / 95.15 / 78.13% | 76.13% | 50% / 70% | 중앙값 통과 |
| .NET | `MULTI_DEALER_ROUTER_REQREP` | ws | 73.84 / 71.97 / 71.37 / 73.03 / 112.11 / 102.70% | 84.17% | 50% / 70% | 중앙값 통과 |
| .NET | `MULTI_DEALER_ROUTER_REQREP` | wss | 66.45 / 69.83 / 70.44 / 77.51 / 101.89 / 100.18% | 81.05% | 50% / 70% | 중앙값 통과 |
| .NET | `MULTI_ROUTER_ROUTER_SENDSEND` | tcp | 77.97 / 81.97 / 92.59 / 97.65 / 134.55 / 141.92% | 104.44% | 50% / 70% | 중앙값 통과 |
| .NET | `MULTI_ROUTER_ROUTER_SENDSEND` | tls | 86.25 / 89.03 / 85.67 / 86.08 / 109.41 / 107.39% | 93.97% | 50% / 70% | 중앙값 통과 |
| .NET | `MULTI_ROUTER_ROUTER_SENDSEND` | ws | 85.91 / 82.24 / 86.68 / 89.33 / 114.23 / 111.36% | 94.96% | 50% / 70% | 중앙값 통과 |
| .NET | `MULTI_ROUTER_ROUTER_SENDSEND` | wss | 88.90 / 93.13 / 87.19 / 87.77 / 101.07 / 102.73% | 93.47% | 50% / 70% | 중앙값 통과 |
| .NET | `MULTI_ROUTER_ROUTER_REQREP` | tcp | 70.67 / 67.18 / 77.63 / 81.99 / 114.60 / 318.01% | 121.68% | 50% / 70% | 중앙값 통과 |
| .NET | `MULTI_ROUTER_ROUTER_REQREP` | tls | 66.46 / 61.53 / 64.11 / 69.78 / 95.43 / 80.05% | 72.89% | 50% / 70% | 중앙값 통과 |
| .NET | `MULTI_ROUTER_ROUTER_REQREP` | ws | 64.48 / 68.62 / 75.11 / 70.51 / 107.05 / 101.27% | 81.17% | 50% / 70% | 중앙값 통과 |
| .NET | `MULTI_ROUTER_ROUTER_REQREP` | wss | 70.09 / 60.04 / 66.95 / 77.76 / 100.75 / 241.03% | 102.77% | 50% / 70% | 중앙값 통과 |
| .NET | `MULTI_STREAM` | tcp | 82.50 / 71.84 / 87.08 / 87.99% | 82.35% | 50% / 70% | 중앙값 통과 |
| .NET | `MULTI_STREAM` | tls | 85.49 / 87.59 / 89.80 / 98.82% | 90.43% | 50% / 70% | 중앙값 통과 |
| .NET | `MULTI_STREAM` | ws | 89.04 / 89.79 / 91.84 / 97.40% | 92.02% | 50% / 70% | 중앙값 통과 |
| .NET | `MULTI_STREAM` | wss | 91.68 / 93.60 / 94.71 / 97.15% | 94.29% | 50% / 70% | 중앙값 통과 |
| Java | `MULTI_DEALER_DEALER` | tcp | 57.89 / 82.00 / 85.54 / 70.81 / 90.54 / 90.94% | 79.62% | 70% / 90% | 최소 통과, 중앙값 미달 |
...
| Java | `MULTI_ROUTER_ROUTER_REQREP` | tls | 61.17 / 59.43 / 61.67 / 67.68 / 81.29 / 80.48% | 68.62% | 50% / 70% | 최소 통과, 중앙값 미달 |
| Java | `MULTI_ROUTER_ROUTER_REQREP` | ws | 48.31 / 42.82 / 49.80 / 46.21 / 118.38 / 97.67% | 67.20% | 50% / 70% | 최소 통과, 중앙값 미달 |
| Java | `MULTI_ROUTER_ROUTER_REQREP` | wss | 61.15 / 62.79 / 62.07 / 65.10 / 82.83 / 61.90% | 65.97% | 50% / 70% | 최소 통과, 중앙값 미달 |
...
| Node | `MULTI_ROUTER_ROUTER_SENDSEND` | tcp | 50.25 / 43.55 / 45.54 / 49.27 / 70.76 / 67.06% | 54.41% | 30% / 60% | 최소 통과, 중앙값 미달 |
| Node | `MULTI_ROUTER_ROUTER_SENDSEND` | tls | 56.91 / 53.92 / 56.70 / 57.61 / 90.23 / 94.32% | 68.28% | 30% / 60% | 중앙값 통과 |
| Node | `MULTI_ROUTER_ROUTER_SENDSEND` | ws | 55.39 / 48.30 / 47.89 / 51.73 / 73.68 / 72.97% | 58.33% | 30% / 60% | 최소 통과, 중앙값 미달 |
...
아래 평균은 위 표에서 완료된 transport·pattern 평균을 같은 가중치로 계산한 값이다. 아직
