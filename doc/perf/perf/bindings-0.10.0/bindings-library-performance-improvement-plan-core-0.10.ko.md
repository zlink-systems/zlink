...
- Multi 상태: `부분 완료·안정성 blocker` — `MULTI_DEALER_DEALER / tcp`에서 64B만 안정 셀로 확인했고, 256B·1024B·4096B·65536B·131072B는 stability gate를 넘었다.
