...
|------|------|------------------|
| 현재 언어 | .NET |  |
| 현재 pattern | 완료·통과 | `PUBSUB / inproc`의 throughput ratio는 89.870%/71.609%/65.889%/68.071%/79.430%/75.978%, 산술평균 75.141%이며 평균 latency ratio는 1.845x다. .NET inproc 단순 one-way aggregate 기준을 충족해 통과하고 다음 대상은 `Single DEALER_DEALER / inproc`이다. |
| paired C | 완료 | C throughput은 1346308/1198314/1201421/433968/183320/83774 Kmsg/s, 평균 latency는 0.018/0.047/0.107/0.007/0.012/0.021 ms다. report는 `perf_c_single_linux_20260810_164932_dotnet-pubsub-inproc-paired-c1.txt`다. |
| binding paired 결과 | 완료·통과 | .NET throughput은 1209927/858100/791610/295406/145611/63650 Kmsg/s, 평균 latency는 0.034/0.176/0.133/0.011/0.016/0.027 ms다. throughput ratio 산술평균은 75.141%, latency ratio 산술평균은 1.845x다. |
...
| 2 | .NET | 완료·통과 20 / 보류 10 | 미측정 | 다음 대상은 `Single DEALER_DEALER / inproc`; C → .NET 순서로 한 대상씩 측정 |
