...
|------|------|------------------|
| 현재 언어 | .NET |  |
| 현재 pattern | 완료·통과 | `PAIR / ipc` throughput ratio는 60.254%/78.516%/88.827%/94.210%/93.188%/100.756%, 산술평균 85.958%이며 평균 latency ratio는 1.087x다. 64B 개별 최소 기준 미달은 결과로 기록하고 aggregate 기준으로 통과한다. 다음 대상은 아직 미측정인 `Single PUBSUB / ipc`다. |
| paired C | 완료 | C throughput은 2825899/1287412/790957/41608/26907/15344 Kops/s, 평균 latency는 0.080/0.208/0.264/4.876/7.626/13.420 ms다. report는 `/home/hep7hep7/project/zlink/bindings/c/perf/results/single/report/perf_c_single_linux_20260810_175801_dotnet-pair-ipc-paired-c1.txt`다. |
| binding paired 결과 | 완료·통과 | .NET throughput은 1702707/1010821/702584/39199/25074/15460 Kops/s, 평균 latency는 0.115/0.197/0.271/5.191/8.134/13.171 ms다. throughput ratio 산술평균은 85.958%, 평균 latency ratio는 1.087x다. report는 `/home/hep7hep7/project/zlink/bindings/dotnet/perf/results/single/report/perf_dotnet_single_linux_20260810_175814_dotnet-pair-ipc-paired-before.txt`다. |
| 개선 결과 | 통과·추가 변경 없음 | throughput aggregate와 latency aggregate가 기준을 충족했다. 개별 size 미달은 결과로 남기며 hotpath 또는 POSDDD 구조 변경은 채택하지 않는다. public contract·ownership·error semantics는 변경하지 않았다. |
...
| 2 | .NET | 완료·통과 25 / 보류 13 | 미측정 | 다음 대상은 아직 미측정인 `Single PUBSUB / ipc`; C → .NET 순서로 한 대상씩 측정 |
