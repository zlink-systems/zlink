...
|------|------|------------------|
| 현재 언어 | .NET |  |
| 현재 pattern | 완료·보류 | `PUBSUB / ipc` baseline throughput ratio는 65.757%/72.288%/80.603%/97.045%/99.225%/93.177%, 산술평균 84.683%이며 평균 latency ratio는 0.921x다. 자체 개선 후 aggregate throughput 81.785%로 악화되어 후보를 제거했고, Sol no-go 후 throughput 목표 85% 미달로 보류한다. 다음 대상은 아직 미측정인 `Single DEALER_DEALER / ipc`다. |
| paired C | 완료 | C throughput은 1491433/1052025/717917/40986/26200/15742 Kops/s, 평균 latency는 0.107/0.328/0.284/4.953/7.841/13.041 ms다. report는 `/home/hep7hep7/project/zlink/bindings/c/perf/results/single/report/perf_c_single_linux_20260810_180020_dotnet-pubsub-ipc-paired-c1.txt`다. |
| binding paired 결과 | 완료·미달 | .NET baseline throughput은 980723/760483/578662/39775/25997/14668 Kops/s, 평균 latency는 0.095/0.154/0.300/5.136/7.913/13.928 ms다. baseline ratio 산술평균은 84.683%, 평균 latency ratio는 0.921x다. 자체 inlining after throughput ratio는 65.680%/72.373%/76.267%/92.268%/90.149%/93.972%, 산술평균 81.785%, 평균 latency ratio 0.957x로 악화되어 제거했다. |
| 개선 결과 | 보류·Sol no-go | 현재 topic cache hit·단일 `SubmitGate`·allocation 없는 native submitter가 적용되어 있다. Sol은 추가 inlining과 builder pooling/reuse가 의미 있는 개선 근거가 없거나 독립 builder·stale reference 계약을 훼손할 수 있어 no-go 판정했다. public contract·ownership·error semantics는 변경하지 않았다. |
...
| 2 | .NET | 완료·통과 25 / 보류 14 | 미측정 | 다음 대상은 아직 미측정인 `Single DEALER_DEALER / ipc`; C → .NET 순서로 한 대상씩 측정 |
