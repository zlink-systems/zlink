...
| 커밋과 푸시 | 완료 | PUBSUB checkpoint는 `f07fb41553`, DEALER receiver parity checkpoint는 `e8873d9733`으로 commit하고 `origin/core-0.10.0-bindings-performance`에 push했다. PUBSUB와 `DEALER_DEALER / tcp`는 미달 근거를 기록했으며 pattern·전체 언어 완료로 판정하지 않는다. |
