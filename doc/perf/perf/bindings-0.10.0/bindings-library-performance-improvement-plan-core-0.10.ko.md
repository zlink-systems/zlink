...
|------|------|------------------|
| 현재 언어 | .NET |  |
| 현재 pattern | 완료·통과 | `DEALER_DEALER / inproc`의 throughput ratio는 59.456%/59.274%/54.638%/30.368%/95.998%/81.637%, 산술평균 63.562%이며 평균 latency ratio는 1.623x다. .NET inproc 단순 one-way aggregate 기준을 충족해 통과하고 다음 대상은 `Single DEALER_ROUTER / inproc`이다. |
| paired C | 완료 | C throughput은 2356980/1795347/1893613/489617/186321/84383 Kmsg/s, 평균 latency는 0.075/0.164/0.180/0.009/0.012/0.020 ms다. report는 `perf_c_single_linux_20260810_165225_dotnet-dealer-dealer-inproc-paired-c1.txt`다. |
| binding paired 결과 | 완료·통과 | .NET throughput은 1401362/1064182/1034631/148685/178865/68888 Kmsg/s, 평균 latency는 0.125/0.282/0.323/0.020/0.013/0.025 ms다. throughput ratio 산술평균은 63.562%, latency ratio 산술평균은 1.623x다. |
| 개선 결과 | 통과·추가 변경 없음 | 측정값이 .NET inproc 단순 one-way aggregate 기준을 충족했다. public interface·ownership·error contract를 변경하지 않고 추가 hotpath 변경 없이 통과 처리한다. |
...
| 2 | .NET | 완료·통과 21 / 보류 10 | 미측정 | 다음 대상은 `Single DEALER_ROUTER / inproc`; C → .NET 순서로 한 대상씩 측정 |
