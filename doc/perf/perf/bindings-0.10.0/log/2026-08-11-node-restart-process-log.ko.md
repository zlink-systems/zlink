...
| `inproc` | `PAIR` | 7.865% | 측정값 | 보류 | `191949_node-restart-pair-inproc-c` / `192009_node-restart-pair-inproc-current` |
| `inproc` | `PUBSUB` | 11.097% | 측정값 | 보류 | `192017_node-restart-pubsub-inproc-c` / `192043_node-restart-pubsub-inproc-current` |
| `inproc` | `DEALER_DEALER` | 7.699% | 측정값 | 보류 | `192051_node-restart-dealer-dealer-inproc-c` / `192122_node-restart-dealer-dealer-inproc-current` |
| `inproc` | `DEALER_ROUTER` | 6.093% | 측정값 | 보류 | `192126_node-restart-dealer-router-inproc-c` / `192147_node-restart-dealer-router-inproc-current` |
| `inproc` | `DEALER_ROUTER_REQREP` | 14.659% | 측정값 | 보류 | `192151_node-restart-dealer-router-reqrep-inproc-c` / `192214_node-restart-dealer-router-reqrep-current` |
| `inproc` | `ROUTER_ROUTER` | 6.077% | 측정값 | 보류 | `192218_node-restart-router-router-inproc-c` / `192238_node-restart-router-router-inproc-current` |
| `inproc` | `ROUTER_ROUTER_REQREP` | 14.952% | 측정값 | 보류 | `192243_node-restart-router-router-reqrep-inproc-c` / `192302_node-restart-router-router-reqrep-current` |
| `ipc` | `PAIR` | 57.645% | 측정값 | 통과 | `192522_node-restart-pair-ipc-c` / `192548_node-restart-pair-ipc-current` |
| `ipc` | `PUBSUB` | 62.017% | 측정값 | 통과 | `192555_node-restart-pubsub-ipc-c` / `192637_node-restart-pubsub-ipc-current` |
| `ipc` | `DEALER_DEALER` | 57.921% | 측정값 | 통과 | `192643_node-restart-dealer-dealer-ipc-c` / `192709_node-restart-dealer-dealer-ipc-current` |
| `ipc` | `DEALER_ROUTER` | 28.512% | 측정값 | 보류 | `192715_node-restart-dealer-router-ipc-c` / `192742_node-restart-dealer-router-ipc-current` |
