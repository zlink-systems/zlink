...
| Go (§9.5) | 64.2% | 12 / 18 / 0 / 0 | 미측정 | 0 / 0 / 0 / 16 | **Single one-way 측정 완료(2026-09-12)** — 5 one-way 패턴 30셀 평균 64.2%(통과 12·보류 18, gpfull 1run). reqrep은 §9.5 회귀 수정 별도. Multi·reqrep행 미측정 |

| Rust (§9.6) | 128.7% | 19 / 23 / 0 / 0 | 92.5% | 15 / 13 / 0 / 0 | **완료** — 미달·미측정 0(통과/보류만). 하네스 버그 수정 후 전 셀 측정 |
| Python (§9.7) | 34.6% | 3 / 27 / 0 / 0 | 미측정 | 0 / 0 / 0 / 27 | **Single one-way 측정 완료(2026-09-12)** — 5 one-way 패턴 30셀 평균 34.6%(통과 3·보류 27, Python 소형 per-op 바닥, gpfull 1run). reqrep은 §9.7 회귀 수정 별도. Multi·reqrep행 미측정 |
