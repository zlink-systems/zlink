...
| Java (§9.3) | 88.6% | 23 / 19 / 0 / 0 | 85.5% | 18 / 10 / 0 / 0 | **완료** — 실패·미측정·미달 0. **single reqrep은 하네스 회귀(G3 810983b674가 요청-스레드 완결 drain 제거) 복원 재측정으로 18~66%→41~127% 회복(§9.3 상세표 우선, jmeas 3run)** |
