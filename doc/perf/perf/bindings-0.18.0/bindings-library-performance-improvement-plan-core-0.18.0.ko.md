...
| .NET (§9.2) | 78.1% | 24 / 18 / 0 / 0 | 73.8% | 14 / 14 / 0 / 0 | **완료** — 실패·미측정·미달 0. SENDSEND 하네스 fix. **reqrep은 하네스 회귀(G4가 요청-스레드 완결 drain 제거) 복원 재측정으로 소형 2~7%→40~44%·aggregate 34~128% 회복(§9.2, single/multi 상세표 우선)** |
