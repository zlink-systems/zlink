[English](./framework-dotnet-0.24.0.md) | [한국어](./framework-dotnet-0.24.0.ko.md)

# ZLink .NET Framework 0.24.0 릴리스 노트
...
- `Zlink.Stream.Connector`가 `net8.0`과 함께 `netstandard2.1`을 대상으로 해 Unity(Mono)에서 컴파일됩니다. (#1037, #1064)
...
릴리스 태그는 [`framework-dotnet/v0.24.0`](https://github.com/zlink-systems/zlink/releases/tag/framework-dotnet%2Fv0.24.0)입니다.
