...
# ZLink .NET binding 1.5.0 릴리스 노트

이 릴리스는 NuGet 패키지 버전을 Core 1.5.0에 맞춥니다.

## 변경

- NuGet 패키지 버전을 Core 1.5.0 릴리스에 맞춰 1.5.0으로 올립니다.
...
- .NET binding의 동작은 변경되지 않았습니다. 이 릴리스는 binding 버전을 Core 1.5.0에 맞춥니다.

## 검증

- 릴리스 사전 검사는 .NET binding 버전, 릴리스 노트, NuGet 패키지 메타데이터를 확인합니다.

릴리스 태그는 `dotnet/v1.5.0`입니다.
