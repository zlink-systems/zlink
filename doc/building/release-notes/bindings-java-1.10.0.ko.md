...
# ZLink Java binding 1.10.0 릴리스 노트

이 릴리스는 Maven 패키지 버전을 1.10.0으로 올리고 Core 1.10.0을 요구합니다.
...
- 릴리스 사전 검사는 Java binding 버전, 릴리스 노트, Maven 메타데이터를 확인합니다.

릴리스 태그는 `java/v1.10.0`입니다.
