[English](./framework-java-0.26.0.md) | [한국어](./framework-java-0.26.0.ko.md)

# ZLink Java·Kotlin Framework 0.26.0 릴리스 노트

Framework 0.26.0은 Java·Kotlin binding 1.10.0과 Core 1.10.0을 사용합니다.
...
릴리스 태그는 [`framework-java/v0.26.0`](https://github.com/zlink-systems/zlink/releases/tag/framework-java%2Fv0.26.0)입니다.
