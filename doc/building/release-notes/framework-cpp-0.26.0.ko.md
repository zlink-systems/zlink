[English](./framework-cpp-0.26.0.md) | [한국어](./framework-cpp-0.26.0.ko.md)

# ZLink C++ Framework 0.26.0 릴리스 노트

Framework 0.26.0은 C++ binding 1.10.0과 Core 1.10.0을 사용합니다.
...
[`framework-cpp/v0.26.0` GitHub Release](https://github.com/zlink-systems/zlink/releases/tag/framework-cpp%2Fv0.26.0)의 플랫폼별 framework archive를 선택하거나 `bootstrap.cmake`로 내려받습니다. 서버 framework는 C++ binding 1.10.0과 Core 1.10.0이 필요합니다. Stream Connector만 사용하는 client는 Core와 binding이 필요하지 않습니다.

릴리스 태그는 [`framework-cpp/v0.26.0`](https://github.com/zlink-systems/zlink/releases/tag/framework-cpp%2Fv0.26.0)입니다.
