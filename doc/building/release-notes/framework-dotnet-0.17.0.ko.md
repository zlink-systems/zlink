...
# ZLink .NET Framework 0.17.0 릴리스 노트
...
릴리스 태그는 [`framework-dotnet/v0.17.0`](https://github.com/zlink-systems/zlink/releases/tag/framework-dotnet%2Fv0.17.0)입니다.
