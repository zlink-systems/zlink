...
# ZLink .NET Framework 0.22.0 릴리스 노트

Framework 0.22.0은 binding 1.2.2과 Core 1.2.0을 사용합니다. Framework 언어별 릴리스는 독립적으로 버전이 지정됩니다.
...
릴리스 태그는 [`framework-dotnet/v0.22.0`](https://github.com/zlink-systems/zlink/releases/tag/framework-dotnet%2Fv0.22.0)입니다.
