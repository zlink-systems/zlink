[English](./bindings-java-1.10.0.md) | [한국어](./bindings-java-1.10.0.ko.md)

# ZLink Java binding 1.10.0 release notes

This release updates the Maven package to version 1.10.0 and requires Core 1.10.0.
...
- The release preflight checks the Java binding version, release notes, and Maven metadata.

The release tag is `java/v1.10.0`.
