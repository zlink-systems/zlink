...
# ZLink Node.js Framework 0.22.0 릴리스 노트
...
- #783 뒤 남아 있던 `runtimePredicates` 호출자를 제거해 workspace가 다시 type-check됩니다. (#872)
...
릴리스 태그는 [`framework-node/v0.22.0`](https://github.com/zlink-systems/zlink/releases/tag/framework-node%2Fv0.22.0)입니다.
