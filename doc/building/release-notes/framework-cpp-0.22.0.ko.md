...
# ZLink C++ Framework 0.22.0 릴리스 노트
...
[`framework-cpp/v0.22.0` GitHub Release](https://github.com/zlink-systems/zlink/releases/tag/framework-cpp%2Fv0.22.0)에서 `zlink-framework-cpp-0.22.0.tar.gz`를 내려받고 `find_package(zlink_framework CONFIG REQUIRED)`를 사용합니다. vcpkg overlay port와 Conan recipe로도 설치할 수 있습니다. C++ binding 1.2.1과 Core 1.2.0이 필요합니다.

릴리스 태그는 [`framework-cpp/v0.22.0`](https://github.com/zlink-systems/zlink/releases/tag/framework-cpp%2Fv0.22.0)입니다.
