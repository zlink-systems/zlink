...
# ZLink Java/Kotlin Framework 0.22.0 Release Notes
...
- The channel, route and mesh dispatchers record a reply-write failure as `reply_path_missing`/`drop` on all four paths. (#860)
...
The release tag is [`framework-java/v0.22.0`](https://github.com/zlink-systems/zlink/releases/tag/framework-java%2Fv0.22.0).
