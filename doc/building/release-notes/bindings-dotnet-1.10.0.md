[English](./bindings-dotnet-1.10.0.md) | [한국어](./bindings-dotnet-1.10.0.ko.md)

# ZLink .NET binding 1.10.0 release notes

This release updates the NuGet package to version 1.10.0 and requires Core 1.10.0.
...
- The release preflight checks the .NET binding version, release notes, and NuGet metadata.

The release tag is `dotnet/v1.10.0`.
