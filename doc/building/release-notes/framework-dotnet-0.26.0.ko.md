[English](./framework-dotnet-0.26.0.md) | [한국어](./framework-dotnet-0.26.0.ko.md)

# ZLink .NET Framework 0.26.0 릴리스 노트

Framework 0.26.0은 .NET binding 1.10.0과 Core 1.10.0을 사용합니다.
...
릴리스 태그는 [`framework-dotnet/v0.26.0`](https://github.com/zlink-systems/zlink/releases/tag/framework-dotnet%2Fv0.26.0)입니다.
