[English](./framework-dotnet-0.22.0.md) | [한국어](./framework-dotnet-0.22.0.ko.md)

# ZLink .NET Framework 0.22.0 Release Notes

Framework 0.22.0 uses binding 1.2.2 and Core 1.2.0. Each Framework language release is versioned independently.
...
```xml
<PackageReference Include="Zlink.Framework" Version="0.22.0" />
<PackageReference Include="Zlink.HttpClient" Version="0.22.0" />
```

The release tag is [`framework-dotnet/v0.22.0`](https://github.com/zlink-systems/zlink/releases/tag/framework-dotnet%2Fv0.22.0).
