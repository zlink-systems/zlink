...
registers a [Client or Server role](../00-foundation/02-glossary.en.md#channel-client-server-role) per [ChannelName](../00-foundation/02-glossary.en.md#channelname)
