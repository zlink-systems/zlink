...
channel messaging, [Spot](02-glossary.en.md#spot), [Actor](02-glossary.en.md#actor) with per-ID state and a mailbox, connection sessions, PUB/SUB-style
...
The execution objects below are distinct from the MeshNode [Owner](02-glossary.en.md#owner)
in Location Store authority. [Handler turn and execution gate §7](../01-execution/02-handler-turn-and-execution-gate.en.md#execution-lanes)
owns the per-execution-object FIFO scope.
