...
Loss information also passes through as Java `ZLinkObservationLoss`.
[Runtime monitoring §7.2](../../../06-observability/01-runtime-monitoring.en.md#72-coalescing) owns the semantics, range, and saturation of its two `long` counters.
...
[snapshot](../../../00-foundation/02-glossary.en.md#snapshot) that registered
...
[ready](../../../00-foundation/02-glossary.en.md#ready) — the first valid
...
[RouteMesh](../../../00-foundation/02-glossary.en.md#routemesh) placement status
