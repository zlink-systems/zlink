...
The Framework contract dependency is transitive through the Java deliverable and is
owned by [01 Scope And Architecture §1.3](../../01-scope-and-architecture.en.md#13-relationship-with-framework--one-way-dependency).
...
- A handler/actor/[spot](../../../server/00-foundation/02-glossary.en.md#spot) path calls it
