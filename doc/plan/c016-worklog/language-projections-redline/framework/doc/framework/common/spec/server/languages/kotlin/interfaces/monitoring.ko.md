...
유실 정보도 Java `ZLinkObservationLoss`를 그대로 전달한다. 두 `long` counter의
의미·범위·포화는 [Runtime monitoring §7.2](../../../06-observability/01-runtime-monitoring.ko.md#72-합치기)가 소유한다.
