...
This document fixes the TypeScript declarations related to the
...
`configureInboundDispatch(): ZLinkInboundDispatchOptions` exposes the base Framework
[inbound configuration projection](01-foundation-configuration.en.md#3-handler-decorator-and-dispatch-option).
[Application Job Queue And Backpressure §2](../../../01-execution/04-application-job-queue-and-backpressure.en.md#2-configuration-and-profile-boundary) owns the HWM and application job queue semantics, defaults, and ranges.
The application
...
[factory](../../../00-foundation/02-glossary.en.md#factory), must call
