...
"skipped while catching up" from "never seen at all." Both counters start at
`0` per subscription, increase monotonically and independently, and saturate at
`9223372036854775807` (`2^63 - 1`). A language's integer representation does not
change this observable range.
