...
`configureInboundDispatch(): ZLinkInboundDispatchOptions`는 기본 Framework의
[inbound 설정 투영](01-foundation-configuration.ko.md#3-handler-decorator와-dispatch-option)을 제공한다.
HWM과 Application job queue의 의미·기본값·범위는
[Application job queue와 backpressure §2](../../../01-execution/04-application-job-queue-and-backpressure.ko.md#2-설정과-profile-경계)가 소유한다.
