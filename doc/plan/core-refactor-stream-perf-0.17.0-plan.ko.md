...
- [ ] Phase 2G: G-0 idle 재기준(D-B158·159), G-A(D-B166), G-5(`7549a128b1`), **G-2(`749145fded`, 5셀 −1.5~−7.1 %)**, **G-1+G-3(`99f0294377`, 5셀 0.956~0.992)** 착지. **G-11 잠금 출처 분석 채택(D-B178·179)** → 진행 G-11a(step 1: 명령 드레인 항상 turn) → 2a·2b·2c·2d → step 3, 각 게이트. 진행 S-14(단일 lane 회계 분류 경합, 기존 결함 D-B182). 대기 G-10(clock_gettime)·G-7(eventfd)·R10-B 게이트. 폐기 G-6·G-R1(정책). 재기준: G-11 시리즈 착지 후 idle runs 3(A의 새 러너 + G-5)
