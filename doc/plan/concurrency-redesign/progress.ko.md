...
| **L2** 클래스 전환 (§2 상세) | **완료** (대형 10 + 소형 22배치, 제외 6·보류·재분류는 §2) | **진행 중** — 순서 1~10 완료 · 11·12 마일스톤 보류(참조 반환 구조) · 13 진행 중 | **진행 중** — 순서 1~12 완료 (12클래스, kotlin 승계) | **진행 중** — 순서 1~14 완료 (후보 소진 시 보고 예정) |
