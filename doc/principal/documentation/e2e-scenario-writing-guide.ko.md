...
- 세부 동작: [Transport liveness §6](../../../framework/doc/framework/common/spec/server/02-channel-transport/05-transport-liveness.ko.md)의
...
> 세부 동작: [Host Relocate와 Shutdown §12](../../../framework/doc/framework/common/spec/server/05-location-relocation/05-host-relocation-flow.ko.md#15-state별-admission)의
