    ...
    while (true) {
        ...
        if (failure_errno == EAGAIN) {
            ...
            try {
                ...
                //  A failed bookkeeping allocation must not escape through a
                //  public C entry point or strand the admission gate. The
                //  writable edge will retry this still-pending record.
