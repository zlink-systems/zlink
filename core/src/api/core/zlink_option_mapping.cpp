...
const option_descriptor_t common_option_table[] = {
  ...
  {ZLINK_OPT_PENDING_MAX_MSGS, ZLINK_INTERNAL_OPT_PENDING_MAX_MSGS, false},
  {ZLINK_OPT_PENDING_MAX_BYTES, ZLINK_INTERNAL_OPT_PENDING_MAX_BYTES, false},
...
const option_descriptor_t stream_option_table[] = {
  ...
  {ZLINK_STREAM_OPT_RECV_MODE, ZLINK_INTERNAL_OPT_STREAM_RECV_MODE, false},
};
