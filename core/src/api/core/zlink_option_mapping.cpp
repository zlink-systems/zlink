...
const option_descriptor_t common_option_table[] = {
  ...
  {ZLINK_OPT_SEND_PENDING_MAX_MSGS, ZLINK_INTERNAL_OPT_SEND_PENDING_MAX_MSGS, false},
  {ZLINK_OPT_SEND_PENDING_MAX_BYTES, ZLINK_INTERNAL_OPT_SEND_PENDING_MAX_BYTES, false},
