...
> 분배되는가. 고수준 thread 종류는 [Threading model](02-threading-model.ko.md)이 다룬다.
...
[Threading Model](02-threading-model.ko.md)을 참고.
...
---
[← Threading Model](02-threading-model.ko.md)
