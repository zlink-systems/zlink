...
<!-- zlink-nav:start -->
[Core 스펙 목차](../README.ko.md) | [이전: Runtime Boundary](../08-runtime-boundary.ko.md) | [다음: PAIR](01-pair.ko.md)
<!-- zlink-nav:end -->
...
자세한 계약은 [stream.ko.md](08-stream.ko.md)를 참조하세요.
...
> [소켓 옵션 가이드](../../../guide/12-socket-options.ko.md)가 다룬다. 이 절은 내부 기본값과
> 저장 구조를 설명한다.
