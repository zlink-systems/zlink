...
PUB has no paired DEALER/ROUTER completion lane, so it has no receive-flow
...
described above stay in effect unchanged, and a monitor for a PUB socket never
