...
statement — see [Core internals](../spec/core/systems/01-architecture.en.md) instead if you need the
capability boundary). [Events](../spec/core/04-events.en.md) is a catalog that relates the three
