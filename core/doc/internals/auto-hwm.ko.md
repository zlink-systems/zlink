...
[English](auto-hwm.en.md)

<!-- zlink-nav:start -->
[가이드 목차](../guide/README.ko.md) | [이전: Connection별 memory](connection-memory.ko.md) | [다음: Multipart atomicity](multipart-atomicity.ko.md)
<!-- zlink-nav:end -->
...
적용 범위와 오류는 [Context 스펙](../spec/core/01-context.ko.md#auto-hwm-memory-budget-계산)과
[Socket 스펙](../spec/core/socket/README.ko.md#transportbuffer)가 소유한다.
...
[Socket 스펙의 HWM 설명](../spec/core/socket/README.ko.md#transportbuffer)을 따른다.
