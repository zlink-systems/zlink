...
[Context specification](../spec/core/01-context.en.md#auto-hwm-memory-budget-calculation)
and the [Socket specification](../spec/core/socket/README.en.md#transportbuffer)
...
[Socket specification](../spec/core/socket/README.en.md#transportbuffer) owns
the public rule.
