...
macro(zlink_check_sock_cloexec)
...
"
    ZLINK_HAVE_SOCK_CLOEXEC)
endmacro()

macro(zlink_check_efd_cloexec)
...
"
    ZLINK_HAVE_SO_BINDTODEVICE)
endmacro()

# TCP keep-alives Checks.

macro(zlink_check_so_keepalive)
...
"
    ZLINK_HAVE_SO_KEEPALIVE)
endmacro()

macro(zlink_check_tcp_keepcnt)
...
"
    ZLINK_HAVE_TCP_KEEPCNT)
endmacro()

macro(zlink_check_tcp_keepidle)
...
"
    ZLINK_HAVE_TCP_KEEPIDLE)
endmacro()


macro(zlink_check_tcp_keepintvl)
...
"
    ZLINK_HAVE_TCP_KEEPINTVL)
endmacro()


macro(zlink_check_tcp_keepalive)
...
"
    ZLINK_HAVE_GETRANDOM)
endmacro()

macro(zlink_check_noexcept)
