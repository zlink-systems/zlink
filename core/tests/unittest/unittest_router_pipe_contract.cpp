...
int main ()
{
    ...
    UNITY_BEGIN ();
    RUN_TEST (test_peer_control_does_not_complete_open_application_multipart);
    ...
    RUN_TEST (test_prefetched_batch_tail_does_not_wake_blocked_writer_before_lwm);
    ...
    RUN_TEST (test_routed_target_selection_commits_once_before_exact_submit);
    ...
    RUN_TEST (test_dist_message_preflight_consumes_published_credit_before_owner_wake);
