...
{
    paired_fixture_t () : dealer (NULL), router (NULL), monitor (NULL) {}
...
void test_network_peer_weight_replays_after_reconnection ()
{
    ...
    fixture.monitor = open_test_monitor_probe (
      fixture.dealer, ZLINK_EVENT_PEER_WEIGHT_CHANGED, &fixture.probe);
    ...
    wait_for_peer_weight (&fixture, &router_probe, dealer_weight, 0);
    ...
    wait_for_peer_weight (&fixture, &router_probe, dealer_weight, router_baseline);
