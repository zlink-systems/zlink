...
| 모델 | 등급 | 단가(입력/출력 per 1M) | 쓰는 일 |
|------|------|------------------------|---------|
| `astra` | GPT-6 최상위 | $10 / $50 | 가장 어려운 end-to-end 작업. 원인 가설이 없는 진단, 계약·사양 충돌 해석 |
| `sol` | GPT-5.6 flagship | $5 / $30 | 모호하거나 중대한 작업. 계약·수명·에러 경로가 걸린 구현 |
| `terra` | GPT-5.6 balanced | $2.50 / $15 | 일상 작업. 변경 지점이 정해진 구현, 전수 조사 |
| `luna` | GPT-5.6 fast | $1 / $6 | 잘 정의된 고volume 작업. 단일 파일 수정, 정해진 패턴 적용 |
