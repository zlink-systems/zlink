...
//! Generic multipart operation storage for the raw Core 0.13.1 socket surface.
//!
...
pub(crate) use send_ops::{
    ...
    socket_send_op, stream_send_to_op, submit_publish, submit_routed_send, submit_send,
};
