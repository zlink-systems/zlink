...
void test_completion_capture_before_submit_publish_joins_once ()
{
    auto result = std::make_shared<zlink::detail::async_operation_state_t<void>> ();
...
int main ()
{
    ...
    test_completion_capture_before_submit_publish_joins_once ();
