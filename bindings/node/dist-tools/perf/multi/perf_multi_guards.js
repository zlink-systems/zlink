...
const { positiveIntegerEnv, defaultClientsForPattern } = require('./perf_multi_policy');
...
function resolveTransportClients(patternName, transport, clients) {
    ...
    const nonTcpMax = positiveIntegerEnv('PERF_STREAM_NON_TCP_CLIENTS_MAX', 'PERF_MULTI_STREAM_NON_TCP_CLIENTS_MAX') ?? 1000;
