...
const MULTI_PATTERN_RUNNERS = {
    ...
    DEALER_ROUTER: DEALER_ROUTER_SENDSEND_RUNNER,
    DEALER_ROUTER_SENDSEND: DEALER_ROUTER_SENDSEND_RUNNER,
    DEALER_ROUTER_REQREP: DEALER_ROUTER_REQREP_RUNNER,
    ROUTER_ROUTER: ROUTER_ROUTER_SENDSEND_RUNNER,
    ROUTER_ROUTER_SENDSEND: ROUTER_ROUTER_SENDSEND_RUNNER,
    ROUTER_ROUTER_REQREP: ROUTER_ROUTER_REQREP_RUNNER,
    PUBSUB: {
...
const POLICY_TRANSPORTS = {
    ...
    DEALER_ROUTER_SENDSEND: ['tcp', 'tls', 'ws', 'wss'],
    DEALER_ROUTER_REQREP: ['tcp', 'tls', 'ws', 'wss'],
    ROUTER_ROUTER: ['tcp', 'tls', 'ws', 'wss', 'ipc'],
    ROUTER_ROUTER_SENDSEND: ['tcp', 'tls', 'ws', 'wss', 'ipc'],
    ROUTER_ROUTER_REQREP: ['tcp', 'tls', 'ws', 'wss', 'ipc'],
    PUBSUB: ['tcp', 'tls', 'ws', 'wss'],
    STREAM: ['tcp', 'tls', 'ws', 'wss']
};
function patternMsgSizes(patternName, requestedSizes) {
    const allowed = patternName === 'STREAM'
        ? [64, 256, 1024, 65536]
