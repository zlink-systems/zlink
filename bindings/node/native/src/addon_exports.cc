...
void define_core_exports (napi_env env, napi_value exports)
{
    napi_property_descriptor descs[] = {
      ...
      ZLINK_METHOD ("socketSendCompletionHandler", socket_send_completion_handler),
      ...
      ZLINK_METHOD ("socketSendAsync", socket_send_async),
      ZLINK_METHOD ("dealerRequest", dealer_request),
      ZLINK_METHOD ("dealerRequestSync", dealer_request_sync),
      ZLINK_METHOD ("dealerReply", dealer_reply),
      ZLINK_METHOD ("dealerRecvMessage", dealer_recv_message),
      ZLINK_METHOD ("dealerRecvMessageNoWait", dealer_try_recv_message),
      ZLINK_METHOD ("routerRequest", router_request),
      ZLINK_METHOD ("routerRequestSync", router_request_sync),
