...
void define_core_exports (napi_env env, napi_value exports)
{
    napi_property_descriptor descs[] = {
      ...
      ZLINK_METHOD ("socketRecvMessageRetained", socket_recv_message_retained),
      ZLINK_METHOD ("socketRecvMessageRetainedNoWait", socket_try_recv_message_retained),
      ZLINK_METHOD ("dealerRecvMessageRetained", dealer_recv_message_retained),
      ZLINK_METHOD ("dealerRecvMessageRetainedNoWait", dealer_try_recv_message_retained),
      ...
      ZLINK_METHOD ("socketSubscribeMessageRetained", socket_subscribe_message_retained),
      ZLINK_METHOD ("socketTrySubscribeMessageRetained", socket_try_subscribe_message_retained),
      ZLINK_METHOD ("hwmBudgetLeaseRelease", hwm_budget_lease_release),
      ZLINK_METHOD ("socketSendReadyHandler", socket_send_ready_handler),
      ZLINK_METHOD ("socketRoutedSendReadyHandler", socket_routed_send_ready_handler),
      ZLINK_METHOD ("socketRoutedAdmissionBeginClose", socket_routed_admission_begin_close),
      ZLINK_METHOD ("socketRoutedAdmissionClose", socket_routed_admission_close),
      ZLINK_METHOD ("socketSelectRoutedSubmitTarget", socket_select_routed_submit_target),
      ...
      ZLINK_METHOD ("dealerRoutedSendAttempt", dealer_routed_send_attempt),
      ZLINK_METHOD ("dealerRoutedRequestAttempt", dealer_routed_request_attempt),
      ZLINK_METHOD ("socketRequestCompletionHandler", socket_request_completion_handler),
      ZLINK_METHOD ("routerRoutedSendAttempt", router_routed_send_attempt),
      ZLINK_METHOD ("routerRoutedRequestAttempt", router_routed_request_attempt),
      ZLINK_METHOD ("streamRoutedSendAttempt", stream_routed_send_attempt),
      ...
      ZLINK_METHOD ("routerRecvMessageRetained", router_recv_message_retained),
      ZLINK_METHOD ("routerRecvMessageRetainedNoWait", router_try_recv_message_retained),
