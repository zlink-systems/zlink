...
void define_core_exports (napi_env env, napi_value exports)
{
    napi_property_descriptor descs[] = {
      ...
      ZLINK_METHOD ("messageFrameCopy", message_frame_copy),
      ZLINK_METHOD ("messageFrameMove", message_frame_move),
      ZLINK_METHOD ("messageFrameRefCount", message_frame_ref_count),
