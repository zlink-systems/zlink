...
napi_value socket_try_recv_message_retained (napi_env env, napi_callback_info info);
napi_value dealer_recv_message_retained (napi_env env, napi_callback_info info);
napi_value dealer_try_recv_message_retained (napi_env env, napi_callback_info info);
...
napi_value socket_subscribe_message_retained (napi_env env, napi_callback_info info);
napi_value socket_try_subscribe_message_retained (napi_env env, napi_callback_info info);
...
napi_value socket_routed_send_ready_handler (napi_env env, napi_callback_info info);
napi_value socket_routed_admission_begin_close (napi_env env, napi_callback_info info);
napi_value socket_routed_admission_close (napi_env env, napi_callback_info info);
napi_value socket_select_routed_submit_target (napi_env env, napi_callback_info info);
...
napi_value dealer_routed_send_attempt (napi_env env, napi_callback_info info);
napi_value dealer_routed_request_attempt (napi_env env, napi_callback_info info);
napi_value router_routed_send_attempt (napi_env env, napi_callback_info info);
napi_value router_routed_request_attempt (napi_env env, napi_callback_info info);
napi_value stream_routed_send_attempt (napi_env env, napi_callback_info info);
...
napi_value router_recv_message_retained (napi_env env, napi_callback_info info);
napi_value router_try_recv_message_retained (napi_env env, napi_callback_info info);
