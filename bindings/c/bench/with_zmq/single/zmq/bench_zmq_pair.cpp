...
void run_pair (const std::string &transport, size_t msg_size, const std::string &lib_name)
{
    ...
    int nodelay = 1;
    set_sockopt_int (s_bind.get (), ZLINK_TCP_NODELAY, nodelay, "ZLINK_TCP_NODELAY");
    set_sockopt_int (s_conn.get (), ZLINK_TCP_NODELAY, nodelay, "ZLINK_TCP_NODELAY");
    ...
    set_sockopt_int (s_bind.get (), ZLINK_RCVTIMEO, recv_timeout_ms, "ZLINK_RCVTIMEO");
    set_sockopt_int (s_conn.get (), ZLINK_RCVTIMEO, recv_timeout_ms, "ZLINK_RCVTIMEO");
