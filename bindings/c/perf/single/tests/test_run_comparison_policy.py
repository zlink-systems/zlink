...
class RunComparisonPolicyTests(unittest.TestCase):
    ...
    def test_single_collect_data_omits_legacy_queue_metrics(self):
        ...
        try:
            ...
            self.assertIn("RESULT,current,PAIR,tcp,64,latency,1.000000", output)
            self.assertIn("RESULT,current,PAIR,tcp,64,latency_p95,1.000000", output)
            self.assertIn("RESULT,current,PAIR,tcp,64,latency_p99,1.000000", output)
