                ...
                while not stop.is_set():
                    ...
                    for offset in range(ready_count):
                        ...
                        while True:
                            ...
                            # A continuously readable receive queue must not starve
                            # the reply coroutines.  Start each submit before draining
                            # the next request so its route is still connected.
