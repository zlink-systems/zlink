...
The Python surface is the Core 0.11.1 raw messaging contract with typed Python
...
loads the native payload bundled in that wheel. The current Core 0.11.1 package
