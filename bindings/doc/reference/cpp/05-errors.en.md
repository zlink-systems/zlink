[한국어](https://zlink-systems.github.io/zlink/ko/bindings/reference/cpp/05-errors/) | English
...
handle or a closed receive/connection state. `handler_result_t` remains in the result model, but
