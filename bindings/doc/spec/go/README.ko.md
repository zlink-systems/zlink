...
# Go binding Core 0.11.1 공개 계약

> **이 장이 정의하는 것** — 현재 구현된 Go binding이 Core 0.11.1 raw C API 위에
...
| 절 | 다루는 내용 |
|---|---|
| [Module과 공개 package](#module과-공개-package) | import path, internal 경계, Core 0.11.1 raw 범위 |
...
- 현재 package 계약은 Core 0.11.1 raw C API만 투영한다.
...
Core 0.11.1의 각 monitor event mask와 delivered event value는 대응하는 typed constant로
