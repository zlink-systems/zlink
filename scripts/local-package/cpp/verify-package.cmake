...
if(NOT ZLINK_CORE_VERSION MATCHES "^([0-9]+)\\.([0-9]+)\\.([0-9]+)$")
  message(FATAL_ERROR "Core package version must be MAJOR.MINOR.PATCH")
endif()
...
set(exact_dependency
  "find_dependency(zlink ${ZLINK_CORE_VERSION} EXACT CONFIG)")
string(FIND "${package_config_text}" "${exact_dependency}" exact_dependency_pos)
if(exact_dependency_pos EQUAL -1)
  message(FATAL_ERROR
    "C++ package config does not require exact Core ${ZLINK_CORE_VERSION}")
endif()

message(STATUS
  "C++ package ${ZLINK_CPP_VERSION} verified with Core ${ZLINK_CORE_VERSION}; "
