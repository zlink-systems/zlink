...
echo "[$(ts)] rebuild done"; ls -l --time-style=+%T .artifacts/wsl/nuget/Zlink.0.17.0.nupkg .artifacts/wsl/npm/zlink-systems-zlink-0.17.0.tgz core/build-dev/lib/libzlink.so.0.17.0 | awk '{print $6,$7}'
