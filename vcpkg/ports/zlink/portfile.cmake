...
set(ZLINK_RELEASE_TAG "core/v1.5.0")
set(ZLINK_RELEASE_VERSION "1.5.0")
...
elseif(VCPKG_TARGET_IS_LINUX)
    if(VCPKG_TARGET_ARCHITECTURE STREQUAL "x64")
        ...
        set(ZLINK_ARCHIVE_SHA512 "507b700c3fe8f5e008f277f5010fb310299ad175652276443e9b9c5a9a976c7fa0b81fc5de1143adc854fbda34443f15f7ca56e57a9b66b22a0c120c8e42e60e")
    elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64")
        set(ZLINK_ARCHIVE_PLATFORM "linux-arm64")
        set(ZLINK_ARCHIVE_SHA512 "6732e6344fe6ac03b1d4d4da042e19e6e083ef392aefb08376eb7144532a8722863a1230d00c3bb4de403db2d2f172dcf256059087c8bdc5a417d5e31360d5d4")
    endif()
elseif(VCPKG_TARGET_IS_OSX)
    if(VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64")
        set(ZLINK_ARCHIVE_PLATFORM "macos-arm64")
        set(ZLINK_ARCHIVE_SHA512 "28552edeac1896261c18b6aca7737ba02be5b3e8e91f06b61b7bdafd3590d601bc3adfe203ebd4b2f0a6ff089aee2795d4350ceff9719215faff9329cfd98dd0")
    endif()
elseif(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW AND NOT VCPKG_TARGET_IS_UWP)
    ...
    if(VCPKG_TARGET_ARCHITECTURE STREQUAL "x64" AND VCPKG_CRT_LINKAGE STREQUAL "dynamic")
        ...
        set(ZLINK_ARCHIVE_SHA512 "789372e972cc7b954ba5ecae523845a6f85c1b6ea33d62a48010900908143aeda3f981c0d10b53f54a49438666bf15f4b1fffb829f80014fb058835b772f632b")
...
if(ZLINK_ARCHIVE_PLATFORM)
    ...
    vcpkg_from_github(
        ...
        SHA512 e6c2e35c56e9ec9c87fa7244a82f03a84c4bec7043e4eb5a4f278f184e87595bca49bad15ff64a2263cf02cf2d2d2b30d55b3adce7018a6975ad98d44626a8fe
        HEAD_REF main
    )
